...
int main(void)
{
    ...
    OS_Task__uxCreate(&xTask2_Heartbeat, "Hertbeat Task", 2000UL, (void*) 5000UL, 3UL, &TaskHandeler[1UL]);
    OS_Task__uxCreate(&xTask1_WS2812, "PWM Task", 2000UL, (void*) 100UL, 2UL, &TaskHandeler[1UL]);
