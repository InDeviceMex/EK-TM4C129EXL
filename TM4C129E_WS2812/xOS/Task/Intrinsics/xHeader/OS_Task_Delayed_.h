...
#ifndef XOS_TASK_INTRINSICS_XHEADER_OS_TASK_DELAYED__H_
#define XOS_TASK_INTRINSICS_XHEADER_OS_TASK_DELAYED__H_
...
#endif /* XOS_TASK_INTRINSICS_XHEADER_OS_TASK_DELAYED__H_ */
