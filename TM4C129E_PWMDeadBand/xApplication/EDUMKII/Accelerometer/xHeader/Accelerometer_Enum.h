...
#define EDUMKII_ACCEL_AXIS_X_INPUT (ADC_enINPUT_3)

#define EDUMKII_ACCEL_AXIS_Y (GPIO_enAIN2)
#define EDUMKII_ACCEL_AXIS_Y_INPUT (ADC_enINPUT_2)

#define EDUMKII_ACCEL_AXIS_Z (GPIO_enAIN1)
#define EDUMKII_ACCEL_AXIS_Z_INPUT (ADC_enINPUT_1)
#else
#define EDUMKII_ACCEL_AXIS_X (GPIO_enAIN10)
#define EDUMKII_ACCEL_AXIS_X_INPUT (ADC_enINPUT_10)

#define EDUMKII_ACCEL_AXIS_Y (GPIO_enAIN11)
#define EDUMKII_ACCEL_AXIS_Y_INPUT (ADC_enINPUT_11)

#define EDUMKII_ACCEL_AXIS_Z (GPIO_enAIN16)
#define EDUMKII_ACCEL_AXIS_Z_INPUT (ADC_enINPUT_16)
#endif
