...
#ifndef XOS_TASK_INTRINSICS_XHEADER_OS_Task_TCB_t_H_
#define XOS_TASK_INTRINSICS_XHEADER_OS_Task_TCB_t_H_
...
#endif /* XOS_TASK_INTRINSICS_XHEADER_OS_Task_TCB_t_H_ */
