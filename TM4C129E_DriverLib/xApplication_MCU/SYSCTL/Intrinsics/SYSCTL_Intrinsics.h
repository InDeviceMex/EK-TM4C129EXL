...
#ifndef XAPPLICATION_MCU_SYSCTL_INTRINSICS_SYSCTL_INTRINSICS_H_
#define XAPPLICATION_MCU_SYSCTL_INTRINSICS_SYSCTL_INTRINSICS_H_
...
#endif /* XAPPLICATION_MCU_SYSCTL_INTRINSICS_SYSCTL_INTRINSICS_H_ */
