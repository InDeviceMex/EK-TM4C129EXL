...
void GPIOF__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRGPIO_R_GPIOF_NOREADY == (SYSCTL_PRGPIO_R_GPIOF_MASK & uxReady))
    {
    ...
    else
    {
        ...
        else
        {
            if((UBase_t) GPIO_MIS_R_DMAMIS_ACTIVE & uxReg)
            {
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_1;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_2;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_3;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_4;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_5;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_6;
                ...
                {
                    GPIOF_ICR_R = (UBase_t) GPIO_enPINMASK_7;
