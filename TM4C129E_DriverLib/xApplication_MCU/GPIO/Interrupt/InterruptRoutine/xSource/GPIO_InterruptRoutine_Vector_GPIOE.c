...
void GPIOE__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRGPIO_R_GPIOE_NOREADY == (SYSCTL_PRGPIO_R_GPIOE_MASK & u32Ready))
    {
        ...
        pvfCallback(GPIOE_BASE, (void*) 0UL);
    }
    else
    {
        u32Reg = GPIOE_MIS_R;
        ...
        else
        {
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_0;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_1;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_2;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_3;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_4;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_5;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_6;
            ...
            {
                GPIOE_ICR_R = (uint32_t) GPIO_enPINMASK_7;
