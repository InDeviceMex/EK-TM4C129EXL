...
void GPIOA__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRGPIO_R_GPIOA_NOREADY == (SYSCTL_PRGPIO_R_GPIOA_MASK & u32Ready))
    {
        ...
        pvfCallback(GPIOA_BASE, (void*) 0UL);
    }
    else
    {
        u32Reg = GPIOA_MIS_R;
        ...
        else
        {
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_0;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_1;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_2;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_3;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_4;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_5;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_6;
            ...
            {
                GPIOA_ICR_R = (uint32_t) GPIO_enPINMASK_7;
