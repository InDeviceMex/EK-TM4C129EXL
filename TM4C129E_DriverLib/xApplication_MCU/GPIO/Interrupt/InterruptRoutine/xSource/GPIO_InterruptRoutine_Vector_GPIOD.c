...
void GPIOD__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRGPIO_R_GPIOD_NOREADY == (SYSCTL_PRGPIO_R_GPIOD_MASK & u32Ready))
    {
        ...
        pvfCallback(GPIOD_BASE, (void*) 0UL);
    }
    else
    {
        u32Reg = GPIOD_MIS_R;
        ...
        else
        {
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_0;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_1;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_2;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_3;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_4;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_5;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_6;
            ...
            {
                GPIOD_ICR_R = (uint32_t) GPIO_enPINMASK_7;
