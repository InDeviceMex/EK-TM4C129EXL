...
void GPIOB__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRGPIO_R_GPIOB_NOREADY == (SYSCTL_PRGPIO_R_GPIOB_MASK & u32Ready))
    {
        ...
        pvfCallback(GPIOB_BASE, (void*) 0UL);
    }
    else
    {
        u32Reg = GPIOB_MIS_R;
        ...
        else
        {
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_0;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_1;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_2;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_3;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_4;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_5;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_6;
            ...
            {
                GPIOB_ICR_R = (uint32_t) GPIO_enPINMASK_7;
