...
void UART6__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_RCGCUART_R_UART6_DIS == (SYSCTL_RCGCUART_R_UART6_MASK & u32Enable))
    {
        pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_6,
                                                   UART_enINTERRUPT_SW);
        pfvCallback();
    }
    else
    {
        ...
        else
        {
            ...
            {
                UART6_ICR_R = (uint32_t) UART_enINT_SOURCE_RING_INDICATOR;
                pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_6,
            ...
            {
                UART6_ICR_R = (uint32_t) UART_enINT_SOURCE_CLEAR_TO_SEND;
                pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_6,
            ...
            {
                UART6_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_CARRIER_DETECT;
                pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_6,
            ...
            {
                UART6_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_SET_READY;
                pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_6,
