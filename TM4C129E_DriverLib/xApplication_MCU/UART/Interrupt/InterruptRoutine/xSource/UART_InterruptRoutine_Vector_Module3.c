...
void UART3__vIRQVectorHandler(void)
{
    ...
    {
        pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
                                                   UART_enINTERRUPT_SW);
        pvfCallback();
    }
    else
    {
        ...
        else
        {
            ...
            {
                UART3_ICR_R = (uint32_t) UART_enINT_SOURCE_RING_INDICATOR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_CARRIER_DETECT;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_SET_READY;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
