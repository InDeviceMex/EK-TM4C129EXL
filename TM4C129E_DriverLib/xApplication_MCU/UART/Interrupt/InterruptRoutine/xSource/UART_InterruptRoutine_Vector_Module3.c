...
void UART3__vIRQVectorHandler(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_RING_INDICATOR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_CLEAR_TO_SEND;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_DATA_CARRIER_DETECT;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_DATA_SET_READY;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_RECEIVE;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_TRANSMIT;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_RECEIVE_TIMEOUT;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                uxErrorFlag = 1UL;
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_FRAME_ERROR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                uxErrorFlag = 1UL;
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_PARITY_ERROR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                uxErrorFlag = 1UL;
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_BREAK_ERROR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                uxErrorFlag = 1UL;
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_OVERRUN_ERROR;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_END_OF_TRANSMISSION;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_BIT9_MODE;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_DMA_RECEIVE;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
            ...
            {
                UART3_ICR_R = (UBase_t) UART_enINT_SOURCE_DMA_TRANSMIT;
                pvfCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_3,
