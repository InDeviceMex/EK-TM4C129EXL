...
void UART4__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_RCGCUART_R_UART4_DIS == (SYSCTL_RCGCUART_R_UART4_MASK & u32Enable))
    {
        pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_4,
                                                   UART_enINTERRUPT_SW);
        pfvCallback();
    }
    else
    {
        ...
        {
            UART4_ICR_R = (uint32_t) UART_enINT_SOURCE_RING_INDICATOR;
            pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_4,
        ...
        {
            UART4_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_CARRIER_DETECT;
            pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_4,
        ...
        {
            UART4_ICR_R = (uint32_t) UART_enINT_SOURCE_DATA_SET_READY;
            pfvCallback = UART__pvfGetIRQSourceHandler(UART_enMODULE_4,
