...
void SYSEXC__vIRQVectorHandlerCustom(uintptr_t uptrModuleArg, void* pvArgument)
{
    ...
    {
        UART__uxCustomPrintf(UART_enMODULE_0, "SYSEXC FAULT Exception triggered by Software \n\r");
    ...
    else
    {
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_DENORMAL & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0, "SYSEXC FAULT on De-normal Operation \n\r"
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_DIV0 & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0,"SYSEXC FAULT on a Div by 0\n\r"
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_INVALID & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0,"SYSEXC FAULT on execution of an invalid operation\n\r"
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_UNDERFLOW & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0,"SYSEXC FAULT, underflow exception\n\r"
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_OVERFLOW & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0,"SYSEXC FAULT, overflow exception\n\r"
        ...
        if(0UL != ((UBase_t) SYSEXC_enINTMASK_INEXACT & uxSystemException))
        {
            ...
            UART__uxCustomPrintf(UART_enMODULE_0,"SYSEXC FAULT, Inexact operation exception\n\r"
