...
#ifndef XAPPLICATION_MCU_CRC_INTRINSICS_CRC_INTRINSICS_H_
#define XAPPLICATION_MCU_CRC_INTRINSICS_CRC_INTRINSICS_H_
...
#endif /* XAPPLICATION_MCU_CRC_INTRINSICS_CRC_INTRINSICS_H_ */
