...
#ifndef XAPPLICATION_MCU_QEI_INTRINSICS_XHEADER_QEI_DEPENDENCIES_H_
#define XAPPLICATION_MCU_QEI_INTRINSICS_XHEADER_QEI_DEPENDENCIES_H_
...
#endif /* XAPPLICATION_MCU_QEI_INTRINSICS_XHEADER_QEI_DEPENDENCIES_H_ */
