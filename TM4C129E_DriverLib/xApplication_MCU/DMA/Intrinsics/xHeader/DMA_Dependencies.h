...
#ifndef XAPPLICATION_MCU_DMA_INTRINSICS_XHEADER_DMA_DEPENDENCIES_H_
#define XAPPLICATION_MCU_DMA_INTRINSICS_XHEADER_DMA_DEPENDENCIES_H_
...
#endif /* XAPPLICATION_MCU_DMA_INTRINSICS_XHEADER_DMA_DEPENDENCIES_H_ */
