...
#ifndef XAPPLICATION_MCU_WDT_INTRINSICS_XHEADER_WDT_DEPENDENCIES_H_
#define XAPPLICATION_MCU_WDT_INTRINSICS_XHEADER_WDT_DEPENDENCIES_H_
...
#endif /* XAPPLICATION_MCU_WDT_INTRINSICS_XHEADER_WDT_DEPENDENCIES_H_ */
