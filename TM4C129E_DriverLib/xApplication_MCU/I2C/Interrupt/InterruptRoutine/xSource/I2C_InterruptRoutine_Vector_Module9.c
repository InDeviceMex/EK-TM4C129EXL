...
void I2C9__vIRQVectorHandler(void)
{
    ...
    {
        u32RegMaster = (uint32_t) I2C9_MASTER_MIS_R;
        u32RegSlave = (uint32_t) I2C9_SLAVE_MIS_R;
        ...
        else
        {
            if(0UL != u32RegMaster)
            {
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_MASTER;
                ...
                if((uint32_t) I2C_enMASTER_INTMASK_CLOCK_TIMEOUT & u32RegMaster)
                {
                    ...
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_CLOCK_TIMEOUT;
                }
                if((uint32_t) I2C_enMASTER_INTMASK_RECEIVE_DMA & u32RegMaster)
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_RECEIVE_DMA;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_TRANSMIT_DMA;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_ADDR_DATA_NACK;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_START_DETECTION;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_STOP_DETECTION;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_ARBITRATION_LOST;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_TRANSMIT_FIFO_REQ;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_RECEIVE_FIFO_REQ;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_TRANSMIT_FIFO_EMPTY;
                ...
                {
                    I2C9_MASTER_ICR_R = (uint32_t) I2C_enMASTER_INTMASK_RECEIVE_FIFO_FULL;
            ...
            if(0UL != u32RegSlave)
            {
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_DATA;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_START_CONDITION;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_STOP_CONDITION;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_RECEIVE_DMA;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_TRANSMIT_DMA;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_TRANSMIT_FIFO_REQ;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_RECEIVE_FIFO_REQ;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_TRANSMIT_FIFO_EMPTY;
                ...
                {
                    I2C9_SLAVE_ICR_R = (uint32_t) I2C_enSLAVE_INTMASK_RECEIVE_FIFO_FULL;
