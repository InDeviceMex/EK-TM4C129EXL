...
void I2C6__vIRQVectorHandler(void)
{
    ...
    {
        pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                                                   I2C_enMASTER_INTERRUPT_SW);
        pvfCallback();
        pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                                                   I2C_enSLAVE_INTERRUPT_SW);
        pvfCallback();
    }
    else
    {
        u32RegMaster = (uint32_t) I2C6_MMIS_R;
        u32RegSlave = (uint32_t) I2C6_SMIS_R;
        ...
        else
        {
            if(0UL != u32RegMaster)
            {
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_MASTER;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                if((uint32_t) I2C_enMASTER_INT_SOURCE_CLOCK_TIMEOUT & u32RegMaster)
                {
                    ...
                    pvfCallback();
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_CLOCK_TIMEOUT;
                }
                if((uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_DMA & u32RegMaster)
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_DMA;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_DMA;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_ADDR_DATA_NACK;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_START_DETECTION;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_STOP_DETECTION;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_ARBITRATION_LOST;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_FIFO_REQ;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_FIFO_REQ;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_FIFO_EMPTY;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_FIFO_FULL;
                    pvfCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_6,
            ...
            if(0UL != u32RegSlave)
            {
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_DATA;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_START_CONDITION;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_STOP_CONDITION;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_DMA;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_DMA;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_FIFO_REQ;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_FIFO_REQ;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_FIFO_EMPTY;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
                ...
                {
                    I2C6_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_FIFO_FULL;
                    pvfCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_6,
