...
void I2C5__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRI2C_R_I2C5_NOREADY == (SYSCTL_PRI2C_R_I2C5_MASK & uxReady))
    {
    ...
    {
        uxRegMaster = (UBase_t) I2C5_MASTER_MIS_R;
        uxRegSlave = (UBase_t) I2C5_SLAVE_MIS_R;
        ...
        else
        {
            if(0UL != uxRegMaster)
            {
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_MASTER;
                ...
                if((UBase_t) I2C_enMASTER_INTMASK_CLOCK_TIMEOUT & uxRegMaster)
                {
                    ...
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_CLOCK_TIMEOUT;
                }
                if((UBase_t) I2C_enMASTER_INTMASK_RECEIVE_DMA & uxRegMaster)
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_RECEIVE_DMA;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_TRANSMIT_DMA;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_ADDR_DATA_NACK;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_START_DETECTION;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_STOP_DETECTION;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_ARBITRATION_LOST;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_TRANSMIT_FIFO_REQ;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_RECEIVE_FIFO_REQ;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_TRANSMIT_FIFO_EMPTY;
                ...
                {
                    I2C5_MASTER_ICR_R = (UBase_t) I2C_enMASTER_INTMASK_RECEIVE_FIFO_FULL;
            ...
            if(0UL != uxRegSlave)
            {
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_DATA;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_START_CONDITION;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_STOP_CONDITION;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_RECEIVE_DMA;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_TRANSMIT_DMA;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_TRANSMIT_FIFO_REQ;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_RECEIVE_FIFO_REQ;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_TRANSMIT_FIFO_EMPTY;
                ...
                {
                    I2C5_SLAVE_ICR_R = (UBase_t) I2C_enSLAVE_INTMASK_RECEIVE_FIFO_FULL;
