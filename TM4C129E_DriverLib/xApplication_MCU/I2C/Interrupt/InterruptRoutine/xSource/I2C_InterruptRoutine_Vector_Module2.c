...
void I2C2__vIRQVectorHandler(void)
{
    ...
    {
        pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                                                   I2C_enMASTER_INTERRUPT_SW);
        pfvCallback();
        pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
    ...
    else
    {
        ...
        else
        {
            if(0UL != u32RegMaster)
            {
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_DMA;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_DMA;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_ADDR_DATA_NACK;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_START_DETECTION;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_STOP_DETECTION;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_ARBITRATION_LOST;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_FIFO_REQ;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_FIFO_REQ;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_TRANSMIT_FIFO_EMPTY;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_MICR_R = (uint32_t) I2C_enMASTER_INT_SOURCE_RECEIVE_FIFO_FULL;
                    pfvCallback = I2C_Master__pvfGetIRQSourceHandler(I2C_enMODULE_2,
            ...
            if(0UL != u32RegSlave)
            {
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_START_CONDITION;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_STOP_CONDITION;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_DMA;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_DMA;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_FIFO_REQ;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_FIFO_REQ;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_TRANSMIT_FIFO_EMPTY;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
                ...
                {
                    I2C2_SICR_R = (uint32_t) I2C_enSLAVE_INT_SOURCE_RECEIVE_FIFO_FULL;
                    pfvCallback = I2C_Slave__pvfGetIRQSourceHandler(I2C_enMODULE_2,
