                                 ...
                                 uint32_t u32SlaveAddressArg, uint8_t *pu8Data, uint32_t u32DataSize)
{
    ...
    I2C_Master__vSetSlaveAddressOperation(enModule, u32SlaveAddressArg, I2C_enOPERATION_RECEIVE);
    ...
    I2C_Master__vSetControl(enModule, I2C_enMASTER_CONTROL_RUN_START_ACK);
