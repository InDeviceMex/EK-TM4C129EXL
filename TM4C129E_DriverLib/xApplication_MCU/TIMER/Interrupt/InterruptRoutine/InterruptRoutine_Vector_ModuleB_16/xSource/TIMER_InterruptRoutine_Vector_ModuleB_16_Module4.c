...
void GPTM4B__vIRQVectorHandler(void)
{
    ...
    {
        uxReg = (UBase_t) GPTM4_TB_TnMIS_R;
        ...
        else
        {
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_TIMEOUT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_CAPTURE_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_CAPTURE_EVENT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TW_RTC;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
            ...
            {
                GPTM4_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_DMA;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_4,
