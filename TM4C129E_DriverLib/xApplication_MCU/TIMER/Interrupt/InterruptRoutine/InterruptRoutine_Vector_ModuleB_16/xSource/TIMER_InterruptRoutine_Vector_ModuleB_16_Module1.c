...
void GPTM1B__vIRQVectorHandler(void)
{
    ...
    if(SYSCTL_PRTIMER_R_TIMER1_NOREADY == (SYSCTL_PRTIMER_R_TIMER1_MASK & uxReady))
    {
    ...
    {
        uxReg = (UBase_t) GPTM1_TB_TnMIS_R;
        ...
        else
        {
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_TIMEOUT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_CAPTURE_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_CAPTURE_EVENT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TW_RTC;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TB_TnICR_R = (UBase_t) TIMER_enINT_TB_DMA;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B,
                                                            TIMER_enMODULE_NUM_1,
