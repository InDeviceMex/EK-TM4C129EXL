...
void GPTM1A__vIRQVectorHandler(void)
{
    ...
    {
        uxReg = (UBase_t) GPTM1_TA_TnMIS_R;
        ...
        else
        {
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_TIMEOUT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_CAPTURE_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_CAPTURE_EVENT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TW_RTC;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
            ...
            {
                GPTM1_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_DMA;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_1,
