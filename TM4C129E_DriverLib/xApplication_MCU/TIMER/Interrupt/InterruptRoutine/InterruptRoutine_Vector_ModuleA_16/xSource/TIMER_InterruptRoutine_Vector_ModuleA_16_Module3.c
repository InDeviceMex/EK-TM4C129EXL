...
void GPTM3A__vIRQVectorHandler(void)
{
    ...
    {
        uxReg = (UBase_t) GPTM3_TA_TnMIS_R;
        ...
        else
        {
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_TIMEOUT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_CAPTURE_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_CAPTURE_EVENT;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TW_RTC;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_MATCH;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
            ...
            {
                GPTM3_TA_TnICR_R = (UBase_t) TIMER_enINT_TA_DMA;
                pvfCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_A,
                                                            TIMER_enMODULE_NUM_3,
