    ...
    else
    {
        ...
        else
        {
            ...
            if(u32Reg & ADC_ISC_R_DCINSS1_MASK)
            {
                ...
                u32RegCompMux = ADC1_SS1_DC_R;
                u32RegCompSelect = ADC1_SS1_OP_R;
                u32ShiftReg = 0x1UL;
                    ...
                    if(u32RegCompSelect & u32ShiftReg)
                    {
                        ...
                        if(u32RegCompInterrupt & u32RegCompMuxBit)
                        {
                            ...
                            if(u32RegCompEnable & ADC_DC_CTL_R_CIE_MASK)
                            {
                                ...
                                pvfCallback = ADC_Comparator__pvfGetIRQSourceHandler(ADC_enMODULE_1, ADC_enSEQ_1, (ADC_nCOMPARATOR) u32TempReg);
