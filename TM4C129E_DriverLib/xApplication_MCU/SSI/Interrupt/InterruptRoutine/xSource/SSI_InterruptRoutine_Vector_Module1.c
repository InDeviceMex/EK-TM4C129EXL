...
void SSI1__vIRQVectorHandler(void)
{
    ...
    {
        pvfCallback = SSI__pvfGetIRQSourceHandler(SSI_enMODULE_1,
                                                  SSI_enINTERRUPT_SW);
        pvfCallback();
    }
    else
    {
        ...
        else
        {
            ...
            {
                SSI1_ICR_R = (UBase_t) SSI_enINT_SOURCE_RECEIVE_OVERRUN;
                pvfCallback = SSI__pvfGetIRQSourceHandler(SSI_enMODULE_1,
            ...
            if((UBase_t) SSI_enINT_SOURCE_RECEIVE_TIMEOUT & uxReg)
            {
                ...
                pvfCallback();
                SSI1_ICR_R = (UBase_t) SSI_enINT_SOURCE_RECEIVE_TIMEOUT;
            }
            ...
            {
                SSI1_ICR_R = (UBase_t) SSI_enINT_SOURCE_RECEIVE_DMA;
                pvfCallback = SSI__pvfGetIRQSourceHandler(SSI_enMODULE_1,
            ...
            if((UBase_t) SSI_enINT_SOURCE_TRANSMIT_DMA & uxReg)
            {
                ...
                SSI1_ICR_R = (UBase_t) SSI_enINT_SOURCE_TRANSMIT_DMA;
                pvfCallback = SSI__pvfGetIRQSourceHandler(SSI_enMODULE_1,
            ...
            {
                SSI1_ICR_R = (UBase_t) SSI_enINT_SOURCE_END_OF_TRANSMIT;
                pvfCallback = SSI__pvfGetIRQSourceHandler(SSI_enMODULE_1,
