...
#ifndef XAPPLICATION_MCU_ACMP_INTRINSICS_XHEADER_ACMP_DEPENDENCIES_H_
#define XAPPLICATION_MCU_ACMP_INTRINSICS_XHEADER_ACMP_DEPENDENCIES_H_
...
#endif /* XAPPLICATION_MCU_ACMP_INTRINSICS_XHEADER_ACMP_DEPENDENCIES_H_ */
