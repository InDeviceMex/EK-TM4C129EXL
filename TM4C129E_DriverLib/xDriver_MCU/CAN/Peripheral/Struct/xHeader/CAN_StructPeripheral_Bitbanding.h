...
typedef volatile struct
{
    ...
    union
    {
      volatile UBase_t TXRQ1 [32UL];
      volatile UBase_t TXRQ_LOW [32UL];
      CAN_BITBANDING_TXRQn_t TXRQ1_Bit;
      CAN_BITBANDING_TXRQn_t TXRQ_LOW_Bit;
    };
    union
    {
      volatile UBase_t TXRQ2 [32UL];
      volatile UBase_t TXRQ_HIGH [32UL];
      CAN_BITBANDING_TXRQn_t TXRQ2_Bit;
      CAN_BITBANDING_TXRQn_t TXRQ_HIGH_Bit;
    };
    const UBase_t reserved [6UL * 32UL];
    union
    {
      volatile const UBase_t NWDA1 [32UL];
      volatile const UBase_t NWDA_LOW [32UL];
      CAN_BITBANDING_NWDAn_t NWDA1_Bit;
      CAN_BITBANDING_NWDAn_t NWDA_LOW_Bit;
    };
    union
    {
      volatile const UBase_t NWDA2 [32UL];
      volatile const UBase_t NWDA_HIGH [32UL];
      CAN_BITBANDING_NWDAn_t NWDA2_Bit;
      CAN_BITBANDING_NWDAn_t NWDA_HIGH_Bit;
    };
    const UBase_t reserved1 [6UL * 32UL];
    union
    {
      volatile UBase_t MSG1_INT [32UL];
      volatile UBase_t MSG_INT_LOW [32UL];
      CAN_BITBANDING_MSGn_INT_t MSG1_INT_Bit;
      CAN_BITBANDING_MSGn_INT_t MSG_INT_LOW_Bit;
    };
    union
    {
      volatile UBase_t MSG2_INT [32UL];
      volatile UBase_t MSG_INT_HIGH [32UL];
    ...
    union
    {
      volatile UBase_t MSG1_VAL [32UL];
      volatile UBase_t MSG_VAL_LOW [32UL];
      CAN_BITBANDING_MSGn_VAL_t MSG1_VAL_Bit;
      CAN_BITBANDING_MSGn_VAL_t MSG_VAL_LOW_Bit;
    };
    union
    {
      volatile UBase_t MSG2_VAL [32UL];
      volatile UBase_t MSG_VAL_HIGH [32UL];
...
typedef volatile struct
{
    ...
    union
    {
      volatile const UBase_t ERR [32UL];
      CAN_BITBANDING_ERR_t ERR_Bit;
    };
    union
    {
      volatile UBase_t BIT [32UL];
      CAN_BITBANDING_BIT_t BIT_Bit;
    };
    union
    {
      volatile const UBase_t INT [32UL];
      CAN_BITBANDING_INT_t INT_Bit;
    };
    union
    {
      volatile UBase_t TST [32UL];
      CAN_BITBANDING_TST_t TST_Bit;
    };
    union
    {
      volatile UBase_t BRPE [32UL];
    ...
    const UBase_t reserved1 [8UL * 32UL];

    BITBANDING_CANMESSAGE_t MSG [32UL];

    const UBase_t reserved2 [934UL * 32UL];
}CAN_BITBANDING_t;


typedef volatile struct
{
    CAN_BITBANDING_t MODULE [(UBase_t) CAN_enMODULE_MAX];
}CANS_BITBANDING_t;
