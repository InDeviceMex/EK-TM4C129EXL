...
typedef volatile struct
{
    union
    {
      ...
      BITBANDING_CAN_IFn_CRQ_t CRQ_Bit;
    };
    union
    {
      volatile uint32_t CMSK [32UL];
      BITBANDING_CAN_IFn_CMSK_t CMSK_Bit;
    };
    union
    {
      volatile const uint32_t MSK1 [32UL];
      BITBANDING_CAN_IFn_MSK1_t MSK1_Bit;
    };
    union
    {
      volatile const uint32_t MSK2 [32UL];
      BITBANDING_CAN_IFn_MSK2_t MSK2_Bit;
    };
    union
    {
      volatile uint32_t ARB1 [32UL];
      BITBANDING_CAN_IFn_ARB1_t ARB1_Bit;
    };
    union
    {
      volatile uint32_t ARB2 [32UL];
      BITBANDING_CAN_IFn_ARB2_t ARB2_Bit;
    };
    union
    {
      volatile uint32_t MCTL [32UL];
      BITBANDING_CAN_IFn_MCTL_t MCTL_Bit;
    };
    union
    {
      volatile uint32_t DA1 [32UL];
      BITBANDING_CAN_IFn_DA1_t DA1_Bit;
    };
    union
    {
      volatile uint32_t DA2 [32UL];
      BITBANDING_CAN_IFn_DA2_t DA2_Bit;
    };
    union
    {
      volatile uint32_t DB1 [32UL];
      BITBANDING_CAN_IFn_DB1_t DB1_Bit;
    };
    union
    {
      volatile uint32_t DB2 [32UL];
      BITBANDING_CAN_IFn_DB2_t DB2_Bit;
    };
    const uint32_t reserved [13UL * 32UL];
}BITBANDING_CAN_INTERFACE_t;
...
typedef volatile struct
{
    ...
    union
    {
      ...
      BITBANDING_CAN_TXRQn_t TXRQ1_Bit;
      BITBANDING_CAN_TXRQn_t TXRQ_LOW_Bit;
    };
    union
    {
      volatile uint32_t TXRQ2 [32UL];
      volatile uint32_t TXRQ_HIGH [32UL];
      BITBANDING_CAN_TXRQn_t TXRQ2_Bit;
      BITBANDING_CAN_TXRQn_t TXRQ_HIGH_Bit;
    };
    ...
    union
    {
      ...
      BITBANDING_CAN_NWDAn_t NWDA1_Bit;
      BITBANDING_CAN_NWDAn_t NWDA_LOW_Bit;
    };
    union
    {
      volatile const uint32_t NWDA2 [32UL];
      volatile const uint32_t NWDA_HIGH [32UL];
      BITBANDING_CAN_NWDAn_t NWDA2_Bit;
      BITBANDING_CAN_NWDAn_t NWDA_HIGH_Bit;
    };
    ...
    union
    {
      ...
      BITBANDING_CAN_MSGn_INT_t MSG1_INT_Bit;
      BITBANDING_CAN_MSGn_INT_t MSG_INT_LOW_Bit;
    };
    union
    {
      volatile uint32_t MSG2_INT [32UL];
      volatile uint32_t MSG_INT_HIGH [32UL];
      BITBANDING_CAN_MSGn_INT_t MSG2_INT_Bit;
      BITBANDING_CAN_MSGn_INT_t MSG_INT_HIGH_Bit;
    };
    ...
    union
    {
      ...
      BITBANDING_CAN_MSGn_VAL_t MSG1_VAL_Bit;
      BITBANDING_CAN_MSGn_VAL_t MSG_VAL_LOW_Bit;
    };
    union
    {
      volatile uint32_t MSG2_VAL [32UL];
      volatile uint32_t MSG_VAL_HIGH [32UL];
      BITBANDING_CAN_MSGn_VAL_t MSG2_VAL_Bit;
      BITBANDING_CAN_MSGn_VAL_t MSG_VAL_HIGH_Bit;
    };
...
typedef volatile struct
{
    union
    {
      ...
      BITBANDING_CAN_CTL_t CTL_Bit;
    };
    union
    {
      volatile uint32_t STS [32UL];
      BITBANDING_CAN_STS_t STS_Bit;
    };
    union
    {
      volatile const uint32_t ERR [32UL];
      BITBANDING_CAN_ERR_t ERR_Bit;
    };
    union
    {
      volatile uint32_t BIT [32UL];
      BITBANDING_CAN_BIT_t BIT_Bit;
    };
    union
    {
      volatile const uint32_t INT [32UL];
      BITBANDING_CAN_INT_t INT_Bit;
    };
    union
    {
      volatile uint32_t TST [32UL];
      BITBANDING_CAN_TST_t TST_Bit;
    };
    union
    {
      volatile uint32_t BRPE [32UL];
      BITBANDING_CAN_BRPE_t BRPE_Bit;
    };
    const uint32_t reserved [1UL * 32UL];

    BITBANDING_CAN_INTERFACE_t IF[2UL];
