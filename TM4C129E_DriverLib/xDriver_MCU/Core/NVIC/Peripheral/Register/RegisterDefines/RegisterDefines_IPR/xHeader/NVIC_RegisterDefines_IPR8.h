...
/*----------*/
#define NVIC_IPR8_R_NVIC_GPIOH_MASK    ((uint32_t) 0x000000E0UL)
#define NVIC_IPR8_R_NVIC_GPIOH_BIT    (5UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP0    ((uint32_t) 0x00000000UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP1    ((uint32_t) 0x00000020UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP2    ((uint32_t) 0x00000040UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP3    ((uint32_t) 0x00000060UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP4    ((uint32_t) 0x00000080UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP5    ((uint32_t) 0x000000A0UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP6    ((uint32_t) 0x000000C0UL)
#define NVIC_IPR8_R_NVIC_GPIOH_IP7    ((uint32_t) 0x000000E0UL)

#define NVIC_IPR8_NVIC_GPIOH_MASK    ((uint32_t) 0x00000007UL)
#define NVIC_IPR8_NVIC_GPIOH_IP0    ((uint32_t) 0x00000000UL)
#define NVIC_IPR8_NVIC_GPIOH_IP1    ((uint32_t) 0x00000001UL)
#define NVIC_IPR8_NVIC_GPIOH_IP2    ((uint32_t) 0x00000002UL)
#define NVIC_IPR8_NVIC_GPIOH_IP3    ((uint32_t) 0x00000003UL)
#define NVIC_IPR8_NVIC_GPIOH_IP4    ((uint32_t) 0x00000004UL)
#define NVIC_IPR8_NVIC_GPIOH_IP5    ((uint32_t) 0x00000005UL)
#define NVIC_IPR8_NVIC_GPIOH_IP6    ((uint32_t) 0x00000006UL)
#define NVIC_IPR8_NVIC_GPIOH_IP7    ((uint32_t) 0x00000007UL)
/*----------*/
