...
void MPU__vInit(void)
{
    ...
    MPU_RASR_R_XN_DIS | MPU_RASR_R_AP_RORO | MPU_RASR_R_S_DIS | MPU_RASR_R_C_DIS | MPU_RASR_R_B_DIS | MPU_RASR_R_TEX_WB_WRA | MPU_RASR_R_ENABLE_ENA | u32AddressBit | MPU_RASR_R_SRD_ENA,
    ...
    u32AddressBit = 19UL - 1UL; /*2Â¹â�¹ = 512KB*/
    u32AddressBit <<= 1U;
    MCU__vWriteRegister(MPU_BASE, MPU_RASR_OFFSET,
    MPU_RASR_R_XN_ENA | MPU_RASR_R_AP_RWRW | MPU_RASR_R_S_DIS | MPU_RASR_R_C_DIS | MPU_RASR_R_B_DIS | MPU_RASR_R_TEX_WB_WRA | MPU_RASR_R_ENABLE_ENA | u32AddressBit | MPU_RASR_R_SRD_ENA,
    MPU_RASR_R_XN_MASK | MPU_RASR_R_AP_MASK | MPU_RASR_R_S_MASK | MPU_RASR_R_C_MASK | MPU_RASR_R_B_MASK | MPU_RASR_R_TEX_MASK | MPU_RASR_R_ENABLE_MASK | MPU_RASR_R_SIZE_MASK | MPU_RASR_R_SRD_MASK, 0UL);
    ...
    u32AddressBit <<= 1U;
    MCU__vWriteRegister(MPU_BASE, MPU_RASR_OFFSET,
    MPU_RASR_R_XN_DIS | MPU_RASR_R_AP_RWRW | MPU_RASR_R_S_DIS | MPU_RASR_R_C_DIS | MPU_RASR_R_B_DIS | MPU_RASR_R_TEX_WB_WRA | MPU_RASR_R_ENABLE_ENA | u32AddressBit | MPU_RASR_R_SRD0_DIS | MPU_RASR_R_SRD6_DIS | MPU_RASR_R_SRD7_DIS,
    MPU_RASR_R_XN_MASK | MPU_RASR_R_AP_MASK | MPU_RASR_R_S_MASK | MPU_RASR_R_C_MASK | MPU_RASR_R_B_MASK | MPU_RASR_R_TEX_MASK | MPU_RASR_R_ENABLE_MASK | MPU_RASR_R_SIZE_MASK | MPU_RASR_R_SRD_MASK, 0UL);
