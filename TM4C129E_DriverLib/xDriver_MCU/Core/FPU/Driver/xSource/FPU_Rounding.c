...
FPU_nERROR FPU__enGetRoundingModeDefault(FPU_nMODULE enModuleArg, FPU_nROUNDING* penRoundingArg)
{
    FPU_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penRoundingArg) ? FPU_enERROR_POINTER : FPU_enERROR_OK;
