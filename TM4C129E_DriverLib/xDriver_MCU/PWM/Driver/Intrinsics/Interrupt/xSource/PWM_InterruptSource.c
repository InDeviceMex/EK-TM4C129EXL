...
void PWM__vEnInterrupt(PWM_nMODULE enModule, PWM_nGENMASK enGenArg)
{
...
void PWM__vDisInterrupt(PWM_nMODULE enModule, PWM_nGENMASK enGenArg)
{
    uint32_t u32Module = 0UL;
    uint32_t u32GenReg = 0UL;
    u32Module = MCU__u32CheckParams((uint32_t) enModule, (uint32_t) PWM_enMODULE_MAX);
...
PWM_nGENMASK PWM__enStatusInterrupt(PWM_nMODULE enModule, PWM_nGENMASK enGenArg)
{
