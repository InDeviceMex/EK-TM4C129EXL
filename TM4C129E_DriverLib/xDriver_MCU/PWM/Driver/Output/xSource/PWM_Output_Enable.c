                                          ...
                                          PWM_nOUTPUT enOutputArg, PWM_nSTATE enStateArg)
{
    ...
    if(PWM_enERROR_OK == enErrorReg)
    {
        ...
        UBase_t uxShiftReg = PWM_OUTPUT_ENABLE_R_GEN1_OUTA_BIT - PWM_OUTPUT_ENABLE_R_GEN0_OUTA_BIT;
        ...
        stRegister.uptrAddress = PWM_OUTPUT_ENABLE_OFFSET;
                                        ...
                                        PWM_nOUTPUT enOutputArg, PWM_nSTATE enStateArg)
{
    ...
    if(PWM_enERROR_OK == enErrorReg)
    {
        ...
        while((0U != uxGenMaskReg) && (PWM_enERROR_OK == enErrorReg))
        {
            ...
            {
                enErrorReg = PWM_Output__enSetStateByNumber(enModuleArg, (PWM_nGENERATOR) uxGeneratorReg, enOutputArg, enStateArg);
            }
            uxGeneratorReg++;
            uxGenMaskReg >>= 1U;
        }
