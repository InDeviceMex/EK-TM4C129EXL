                                                        ...
                                                        PWM_nFAULT_INPUTMASK enInputMaskArg, PWM_nSTATE enStateArg)
{
    ...
    if(PWM_enERROR_OK == enErrorReg)
    {
        UBase_t uxValueReg = (PWM_enSTATE_DIS == enStateArg) ? 0U : (UBase_t) enInputMaskArg;
...
{
    PWM_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penInputMaskGetArg) ? PWM_enERROR_POINTER : PWM_enERROR_OK;
    if(PWM_enERROR_OK == enErrorReg)
    {
        enErrorReg = (PWM_nERROR) MCU__enCheckParams((UBase_t) enGeneratorArg, (UBase_t) PWM_enGEN_MAX);
    }
    ...
    if(PWM_enERROR_OK == enErrorReg)
    {
        ...
        while((0UL != uxGenMaskReg) && (PWM_enERROR_OK == enErrorReg))
        {
            if(0UL != (1UL & uxGenMaskReg))
            {
                ...
                if((PWM_enERROR_OK == enErrorReg) && (0UL != uxTempReg))
                {
                                                        ...
                                                        PWM_nFAULT_INPUTMASK enInputMaskArg, PWM_nLEVEL enLevelArg)
{
    ...
    if(PWM_enERROR_OK == enErrorReg)
    {
        UBase_t uxValueReg = (PWM_enLEVEL_LOW == enLevelArg) ? 0U : (UBase_t) enInputMaskArg;
...
{
    PWM_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penLevelArg) ? PWM_enERROR_POINTER : PWM_enERROR_OK;
    if(PWM_enERROR_OK == enErrorReg)
    {
        enErrorReg = (PWM_nERROR) MCU__enCheckParams((UBase_t) enGeneratorArg, (UBase_t) PWM_enGEN_MAX);
    }
...
{
    PWM_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penStatusArg) ? PWM_enERROR_POINTER : PWM_enERROR_OK;
    if(PWM_enERROR_OK == enErrorReg)
    {
        enErrorReg = (PWM_nERROR) MCU__enCheckParams((UBase_t) enGeneratorArg, (UBase_t) PWM_enGEN_MAX);
    }
