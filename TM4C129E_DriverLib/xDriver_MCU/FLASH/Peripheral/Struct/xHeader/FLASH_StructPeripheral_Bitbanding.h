...
typedef volatile struct
{
    ...
    const UBase_t reserved [2UL * 32UL];
    union
    {
    ...
    union
    {
        volatile UBase_t WBVAL [32UL];
        FLASH_BITBANDING_WBVAL_t WBVAL_Bit;
    };
    const UBase_t reserved2 [2UL * 32UL];
    union
    {
        volatile UBase_t PEKEY [32UL];
        FLASH_BITBANDING_PEKEY_t PEKEY_Bit;
    };
    const UBase_t reserved3 [48UL * 32UL];
    union
    {
        volatile UBase_t WBn [32UL][32UL];
        FLASH_BITBANDING_WB_t WBn_Bit [32UL];
    };


    const UBase_t reserved4 [912UL * 32UL];
    union
    {
    ...
    union
    {
        volatile const UBase_t SRAMSIZE [32UL];
        SRAM_BITBANDING_SIZE_t SRAMSIZE_Bit;
    };
    union
    {
        volatile const UBase_t CONF [32UL];
        FLASH_BITBANDING_CONF_t CONF_Bit;
    };
    union
    {
        volatile const UBase_t ROMSWMAP [32UL];
        ROM_BITBANDING_SWMAP_t ROMSWMAP_Bit;
    };
    union
    {
        volatile const UBase_t DMASZ [32UL];
        FLASH_BITBANDING_DMASZ_t DMASZ_Bit;
    };
    union
    {
        volatile const UBase_t DMAST [32UL];
