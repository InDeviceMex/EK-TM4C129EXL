...
************************************ 9 FLPEKEY *********************************************
******************************************************************************************/
#define FLASH_BITBANDING_FLPEKEY    ((BITBANDING_FLPEKEY_TypeDef*) (FLASH_BITBANDING_BASE + ((FLASH_OFFSET + FLASH_FLPEKEY_OFFSET) * 32UL)))
...
************************************ 41 FLASHPP *********************************************
******************************************************************************************/
#define FLASH_BITBANDING_FLASHPP    ((BITBANDING_FLASHPP_TypeDef*) (FLASH_BITBANDING_BASE + ((FLASH_OFFSET + FLASH_FLASHPP_OFFSET) * 32UL)))
...
************************************ 43 FLASHCONF *********************************************
******************************************************************************************/
#define FLASH_BITBANDING_FLASHCONF    ((BITBANDING_FLASHCONF_TypeDef*) (FLASH_BITBANDING_BASE + ((FLASH_OFFSET + FLASH_FLASHCONF_OFFSET) * 32UL)))
...
************************************ 43 FLASHDMASZ *********************************************
******************************************************************************************/
#define FLASH_BITBANDING_FLASHDMASZ    ((BITBANDING_FLASHDMASZ_TypeDef*) (FLASH_BITBANDING_BASE + ((FLASH_OFFSET + FLASH_FLASHDMASZ_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 43 FLASHDMAST *********************************************
******************************************************************************************/
#define FLASH_BITBANDING_FLASHDMAST    ((BITBANDING_FLASHDMAST_TypeDef*) (FLASH_BITBANDING_BASE + ((FLASH_OFFSET + FLASH_FLASHDMAST_OFFSET) * 32UL)))
