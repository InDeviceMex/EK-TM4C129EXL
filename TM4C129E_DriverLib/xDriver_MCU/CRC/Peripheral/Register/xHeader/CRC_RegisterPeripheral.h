...
************************************ 1 CTRL *********************************************
******************************************************************************************/
#define CRC_CTRL    ((CRCCTRL_t*) (CRC_BASE + CRC_CTRL_OFFSET))
#define CRC_CTRL_R    (*((volatile uint32_t*) (CRC_BASE + CRC_CTRL_OFFSET)))

/******************************************************************************************
************************************ 2 SEED *********************************************
******************************************************************************************/
#define CRC_SEED    ((CRCSEED_t*) (CRC_BASE + CRC_SEED_OFFSET))
#define CRC_SEED_R    (*((volatile uint32_t*) (CRC_BASE + CRC_SEED_OFFSET)))

/******************************************************************************************
************************************ 3 DIN *********************************************
******************************************************************************************/
#define CRC_DIN    ((CRCDIN_t*) (CRC_BASE + CRC_DIN_OFFSET))
#define CRC_DIN_R    (*((volatile uint32_t*) (CRC_BASE + CRC_DIN_OFFSET)))

/******************************************************************************************
************************************ 4 RSLTPP *********************************************
******************************************************************************************/
#define CRC_RSLTPP    ((CRCRSLTPP_t*) (CRC_BASE + CRC_RSLTPP_OFFSET))
#define CRC_RSLTPP_R    (*((volatile uint32_t*) (CRC_BASE + CRC_RSLTPP_OFFSET)))
