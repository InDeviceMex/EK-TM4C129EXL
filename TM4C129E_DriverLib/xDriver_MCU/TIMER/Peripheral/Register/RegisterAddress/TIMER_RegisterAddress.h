...
#define GPTM6_BASE    ((uint32_t) 0x400E0000UL)
#define GPTM7_BASE    ((uint32_t) 0x400E1000UL)
...
#define GPTM6_OFFSET    ((uint32_t) 0x000E0000UL)
#define GPTM7_OFFSET    ((uint32_t) 0x000E1000UL)
