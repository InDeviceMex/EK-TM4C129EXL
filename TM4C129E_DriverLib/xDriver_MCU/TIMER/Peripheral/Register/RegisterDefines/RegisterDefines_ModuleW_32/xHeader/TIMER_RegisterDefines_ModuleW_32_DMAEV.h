...
#define GPTM_TW_TnDMAEV_R_RTCDMAEN_INACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_TW_TnDMAEV_R_RTCDMAEN_ACTIVE    ((uint32_t) 0x00000008UL)

#define GPTM_TW_TnDMAEV_RTCDMAEN_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_TW_TnDMAEV_RTCDMAEN_INACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_TW_TnDMAEV_RTCDMAEN_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/
