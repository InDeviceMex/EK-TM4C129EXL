...
/*----------*/
#define GPTM_TW_TnRIS_R_DMAnRIS_MASK    ((uint32_t) 0x00000020UL)
#define GPTM_TW_TnRIS_R_DMAnRIS_BIT    (5UL)
#define GPTM_TW_TnRIS_R_DMAnRIS_NOACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_TW_TnRIS_R_DMAnRIS_ACTIVE    ((uint32_t) 0x00000020UL)

#define GPTM_TW_TnRIS_DMAnRIS_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_TW_TnRIS_DMAnRIS_NOACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_TW_TnRIS_DMAnRIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/
