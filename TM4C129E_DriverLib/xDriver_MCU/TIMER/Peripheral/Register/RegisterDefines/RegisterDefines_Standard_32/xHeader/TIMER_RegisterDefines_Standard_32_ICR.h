...
/*----------*/
#define GPTM_ICR_R_DMAAINT_MASK    ((uint32_t) 0x00000020UL)
#define GPTM_ICR_R_DMAAINT_BIT    (5UL)
#define GPTM_ICR_R_DMAAINT_CLEAR    ((uint32_t) 0x00000020UL)

#define GPTM_ICR_DMAAINT_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_ICR_DMAAINT_CLEAR    ((uint32_t) 0x00000001UL)
/*----------*/
...
/*----------*/
#define GPTM_ICR_R_DMABINTT_MASK    ((uint32_t) 0x00002000UL)
#define GPTM_ICR_R_DMABINTT_BIT    (13UL)
#define GPTM_ICR_R_DMABINTT_CLEAR    ((uint32_t) 0x00002000UL)

#define GPTM_ICR_DMABINTT_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_ICR_DMABINTT_CLEAR    ((uint32_t) 0x00000001UL)
/*----------*/
