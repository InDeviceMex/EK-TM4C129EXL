...
#define GPTM_MIS_R_DMAAMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_MIS_R_DMAAMIS_OCCUR    ((uint32_t) 0x00000010UL)

#define GPTM_MIS_DMAAMIS_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_MIS_DMAAMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_MIS_DMAAMIS_OCCUR    ((uint32_t) 0x00000001UL)
/*----------*/
...
#define GPTM_MIS_R_DMABMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_MIS_R_DMABMIS_OCCUR    ((uint32_t) 0x00002000UL)

#define GPTM_MIS_DMABMIS_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_MIS_DMABMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_MIS_DMABMIS_OCCUR    ((uint32_t) 0x00000001UL)
/*----------*/
