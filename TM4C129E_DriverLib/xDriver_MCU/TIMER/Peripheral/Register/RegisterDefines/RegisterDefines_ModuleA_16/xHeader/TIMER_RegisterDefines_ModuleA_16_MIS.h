...
#define GPTM_TA_TnMIS_R_DMAnMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnMIS_R_DMAnMIS_OCCUR    ((uint32_t) 0x00000020UL)

#define GPTM_TA_TnMIS_DMAnMIS_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_TA_TnMIS_DMAnMIS_NOOCCUR    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnMIS_DMAnMIS_OCCUR    ((uint32_t) 0x00000001UL)
/*----------*/
