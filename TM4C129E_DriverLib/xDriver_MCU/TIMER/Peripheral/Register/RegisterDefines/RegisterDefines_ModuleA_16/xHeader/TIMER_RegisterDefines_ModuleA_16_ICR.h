...
/*----------*/
#define GPTM_TA_TnICR_R_DMAnINT_MASK    ((uint32_t) 0x00000020UL)
#define GPTM_TA_TnICR_R_DMAnINT_BIT    (5UL)
#define GPTM_TA_TnICR_R_DMAnINT_CLEAR    ((uint32_t) 0x00000020UL)

#define GPTM_TA_TnICR_DMAnINT_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_TA_TnICR_DMAnINT_CLEAR    ((uint32_t) 0x00000001UL)
/*----------*/
