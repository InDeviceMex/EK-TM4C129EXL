...
/*----------*/
#define GPTM_TA_TnMR_R_TCnCT_MASK    ((uint32_t) 0x0000E000UL)
#define GPTM_TA_TnMR_R_TCnCT_BIT    (13UL)
#define GPTM_TA_TnMR_R_TCnCT_DIS    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnMR_R_TCnCT_TOOGLE_TO    ((uint32_t) 0x00002000UL)
#define GPTM_TA_TnMR_R_TCnCT_CLEAR_TO    ((uint32_t) 0x00004000UL)
#define GPTM_TA_TnMR_R_TCnCT_SET_TO    ((uint32_t) 0x00006000UL)
#define GPTM_TA_TnMR_R_TCnCT_SET_INM_TOOGLE_TO    ((uint32_t) 0x00008000UL)
#define GPTM_TA_TnMR_R_TCnCT_CLEAR_INM_TOOGLE_TO    ((uint32_t) 0x0000A000UL)
#define GPTM_TA_TnMR_R_TCnCT_SET_INM_CLEAR_TO    ((uint32_t) 0x0000C000UL)
#define GPTM_TA_TnMR_R_TCnCT_CLEAR_INM_SET_TO    ((uint32_t) 0x0000E000UL)

#define GPTM_TA_TnMR_TCnCT_MASK    ((uint32_t) 0x00000007UL)
#define GPTM_TA_TnMR_TCnCT_DIS    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnMR_TCnCT_TOOGLE_TO    ((uint32_t) 0x00000001UL)
#define GPTM_TA_TnMR_TCnCT_CLEAR_TO    ((uint32_t) 0x00000002UL)
#define GPTM_TA_TnMR_TCnCT_SET_TO    ((uint32_t) 0x00000003UL)
#define GPTM_TA_TnMR_TCnCT_SET_INM_TOOGLE_TO    ((uint32_t) 0x00000004UL)
#define GPTM_TA_TnMR_TCnCT_CLEAR_INM_TOOGLE_TO    ((uint32_t) 0x00000005UL)
#define GPTM_TA_TnMR_TCnCT_SET_INM_CLEAR_TO    ((uint32_t) 0x00000006UL)
#define GPTM_TA_TnMR_TCnCT_CLEAR_INM_SET_TO    ((uint32_t) 0x00000007UL)
/*----------*/
