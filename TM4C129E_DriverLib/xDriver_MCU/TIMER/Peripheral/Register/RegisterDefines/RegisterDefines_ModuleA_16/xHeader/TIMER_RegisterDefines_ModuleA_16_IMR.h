...
/*----------*/
#define GPTM_TA_TnIMR_R_DMAnIM_MASK    ((uint32_t) 0x00000020UL)
#define GPTM_TA_TnIMR_R_DMAnIM_BIT    (5UL)
#define GPTM_TA_TnIMR_R_DMAnIM_DIS    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnIMR_R_DMAnIM_ENA    ((uint32_t) 0x00000020UL)

#define GPTM_TA_TnIMR_DMAnIM_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_TA_TnIMR_DMAnIM_DIS    ((uint32_t) 0x00000000UL)
#define GPTM_TA_TnIMR_DMAnIM_ENA    ((uint32_t) 0x00000001UL)
/*----------*/
