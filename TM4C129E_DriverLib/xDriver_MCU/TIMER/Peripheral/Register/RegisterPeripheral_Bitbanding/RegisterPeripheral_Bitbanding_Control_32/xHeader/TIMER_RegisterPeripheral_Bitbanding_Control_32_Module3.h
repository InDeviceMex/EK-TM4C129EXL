...
*********************************** * 5 SYNC *********************************************
******************************************************************************************/
#define GPTM3_CTL_BITBANDING_SYNC    ((BITBANDING_GPTMSYNC_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM3_OFFSET + GPTM_CTL_SYNC_OFFSET) * 32UL)))
...
*********************************** * 27 CC *********************************************
******************************************************************************************/
#define GPTM3_CTL_BITBANDING_CC    ((BITBANDING_GPTMCC_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM3_OFFSET + GPTM_CTL_CC_OFFSET) * 32UL)))
