...
#define GPTM2_CTL_BITBANDING_PP_CHAIN    (*((volatile const UBase_t*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_CTL_PP_OFFSET) * 32UL) + (GPTM_CTL_PP_R_CHAIN_BIT * 4UL))))
#define GPTM2_CTL_BITBANDING_PP_SYNCCNT    (*((volatile const UBase_t*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_CTL_PP_OFFSET) * 32UL) + (GPTM_CTL_PP_R_SYNCCNT_BIT * 4UL))))
#define GPTM2_CTL_BITBANDING_PP_ALTCLK    (*((volatile const UBase_t*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_CTL_PP_OFFSET) * 32UL) + (GPTM_CTL_PP_R_ALTCLK_BIT * 4UL))))
...
#define GPTM2_CTL_BITBANDING_CC_ALTCLK    (*((volatile UBase_t*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_CTL_CC_OFFSET) * 32UL) + (GPTM_CTL_CC_R_ALTCLK_BIT * 4UL))))
