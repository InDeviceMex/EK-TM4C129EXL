...
GPTM_TypeDef_BITBANDING* GPTM_BLOCK_BITBANDING[(uint32_t) TIMER_enMODULE_NUM_MAX] =
{
 GPTM0_BITBANDING, GPTM1_BITBANDING, GPTM2_BITBANDING, GPTM3_BITBANDING,
 GPTM4_BITBANDING, GPTM5_BITBANDING, GPTM6_BITBANDING, GPTM7_BITBANDING
};
