...
*********************************** * 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM5_TB_BITBANDING_TnDMAEV    ((BITBANDING_TB_GPTMDMAEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM5_OFFSET + GPTM_TB_TnDMAEV_OFFSET) * 32UL)))
...
*********************************** * 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM5_TB_BITBANDING_TnADCEV    ((BITBANDING_TB_GPTMADCEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM5_OFFSET + GPTM_TB_TnADCEV_OFFSET) * 32UL)))
