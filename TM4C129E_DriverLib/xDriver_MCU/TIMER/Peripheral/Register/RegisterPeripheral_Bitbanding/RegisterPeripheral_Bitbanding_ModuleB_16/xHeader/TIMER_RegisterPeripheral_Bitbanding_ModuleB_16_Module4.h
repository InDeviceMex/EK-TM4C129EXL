...
#define GPTM4_TB_BITBANDING    ((GPTM_TB_BITBANDING_TypeDef*) (GPTM_BASE_BITBANDING + (GPTM4_OFFSET * 32UL)))

/******************************************************************************************
*********************************** * 3 TBMR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnMR    ((BITBANDING_TB_GPTMMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnMR_OFFSET) * 32UL)))
...
*********************************** * 4 CTL *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnCTL    ((BITBANDING_TB_GPTMCTL_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnCTL_OFFSET) * 32UL)))
...
*********************************** * 6 IMR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnIMR    ((BITBANDING_TB_GPTMIMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnIMR_OFFSET) * 32UL)))
...
*********************************** * 7 RIS *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnRIS    ((BITBANDING_TB_GPTMRIS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnRIS_OFFSET) * 32UL)))
...
*********************************** * 8 MIS *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnMIS    ((BITBANDING_TB_GPTMMIS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnMIS_OFFSET) * 32UL)))
...
*********************************** * 9 ICR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnICR    ((BITBANDING_TB_GPTMICR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnICR_OFFSET) * 32UL)))
...
*********************************** * 11 TBILR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnILR    ((BITBANDING_TB_GPTMILR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnILR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 13 TBMATCHR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnMATCHR    ((BITBANDING_TB_GPTMMATCHR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnMATCHR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 15 TBPR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnPR    ((BITBANDING_TB_GPTMPR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnPR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 17 TBPMR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnPMR    ((BITBANDING_TB_GPTMPMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnPMR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 19 TBR *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnR    ((BITBANDING_TB_GPTMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 21 TBV *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnV    ((BITBANDING_TB_GPTMV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnV_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 24 TBPS *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnPS    ((BITBANDING_TB_GPTMPS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnPS_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnDMAEV    ((BITBANDING_TB_GPTMDMAEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnDMAEV_OFFSET) * 32UL)))
...
*********************************** * 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM4_TB_BITBANDING_TnADCEV    ((BITBANDING_TB_GPTMADCEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TB_TnADCEV_OFFSET) * 32UL)))
