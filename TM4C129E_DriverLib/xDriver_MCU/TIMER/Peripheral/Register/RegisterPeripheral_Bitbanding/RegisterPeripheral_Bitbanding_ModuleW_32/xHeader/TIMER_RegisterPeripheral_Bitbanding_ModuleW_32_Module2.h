...
*********************************** * 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM2_TW_BITBANDING_TnDMAEV    ((BITBANDING_TW_GPTMDMAEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_TW_TnDMAEV_OFFSET) * 32UL)))
...
*********************************** * 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM2_TW_BITBANDING_TnADCEV    ((BITBANDING_TW_GPTMADCEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM2_OFFSET + GPTM_TW_TnADCEV_OFFSET) * 32UL)))
