...
#define GPTM4_TA_BITBANDING    ((GPTM_TA_BITBANDING_TypeDef*) (GPTM_BASE_BITBANDING + (GPTM4_OFFSET * 32UL)))

/******************************************************************************************
*********************************** * 2 TAMR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnMR    ((BITBANDING_TA_GPTMMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnMR_OFFSET) * 32UL)))
...
*********************************** * 4 CTL *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnCTL    ((BITBANDING_TA_GPTMCTL_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnCTL_OFFSET) * 32UL)))
...
*********************************** * 6 IMR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnIMR    ((BITBANDING_TA_GPTMIMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnIMR_OFFSET) * 32UL)))
...
*********************************** * 7 RIS *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnRIS    ((BITBANDING_TA_GPTMRIS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnRIS_OFFSET) * 32UL)))
...
*********************************** * 8 MIS *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnMIS    ((BITBANDING_TA_GPTMMIS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnMIS_OFFSET) * 32UL)))
...
*********************************** * 9 ICR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnICR    ((BITBANDING_TA_GPTMICR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnICR_OFFSET) * 32UL)))
...
*********************************** * 10 TAILR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnILR    ((BITBANDING_TA_GPTMILR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnILR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 12 TAMATCHR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnMATCHR    ((BITBANDING_TA_GPTMMATCHR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnMATCHR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 14 TAPR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnPR    ((BITBANDING_TA_GPTMPR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnPR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 16 TAPMR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnPMR    ((BITBANDING_TA_GPTMPMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnPMR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 18 TAR *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnR    ((BITBANDING_TA_GPTMR_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnR_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 20 TAV *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnV    ((BITBANDING_TA_GPTMV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnV_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 23 TAPS *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnPS    ((BITBANDING_TA_GPTMPS_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnPS_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnDMAEV    ((BITBANDING_TA_GPTMDMAEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnDMAEV_OFFSET) * 32UL)))
...
*********************************** * 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM4_TA_BITBANDING_TnADCEV    ((BITBANDING_TA_GPTMADCEV_TypeDef*) (GPTM_BASE_BITBANDING + ((GPTM4_OFFSET + GPTM_TA_TnADCEV_OFFSET) * 32UL)))
