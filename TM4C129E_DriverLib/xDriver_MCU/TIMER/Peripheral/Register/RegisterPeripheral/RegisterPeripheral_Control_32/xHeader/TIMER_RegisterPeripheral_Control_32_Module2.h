...
************************************ 1 CFG *********************************************
******************************************************************************************/
#define GPTM2_CTL_CFG    ((GPTMCFG_TypeDef*) (GPTM2_BASE + GPTM_CTL_CFG_OFFSET))
...
#define GPTM2_CTL_SYNC    ((GPTMSYNC_TypeDef*) (GPTM2_BASE + GPTM_CTL_SYNC_OFFSET))
...
#define GPTM2_CTL_PP    ((GPTMPP_TypeDef*) (GPTM2_BASE + GPTM_CTL_PP_OFFSET))
...
#define GPTM2_CTL_CC    ((GPTMCC_TypeDef*) (GPTM2_BASE + GPTM_CTL_CC_OFFSET))
