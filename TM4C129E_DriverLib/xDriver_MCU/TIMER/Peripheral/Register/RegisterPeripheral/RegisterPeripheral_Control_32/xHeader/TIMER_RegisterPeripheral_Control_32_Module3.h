...
#define GPTM3_CTL_CFG_R    (*((volatile UBase_t*) (GPTM3_BASE + GPTM_CTL_CFG_OFFSET)))
...
#define GPTM3_CTL_SYNC_R    (*((volatile UBase_t*) (GPTM3_BASE + GPTM_CTL_SYNC_OFFSET)))
...
#define GPTM3_CTL_PP_R    (*((volatile UBase_t*) (GPTM3_BASE + GPTM_CTL_PP_OFFSET)))
...
#define GPTM3_CTL_CC_R    (*((volatile UBase_t*) (GPTM3_BASE + GPTM_CTL_CC_OFFSET)))
