...
#define GPTM6_CTL    (((GPTM_CTL_TypeDef*) (GPTM6_BASE)))

/******************************************************************************************
************************************ 1 CFG *********************************************
******************************************************************************************/
#define GPTM6_CTL_CFG    ((GPTMCFG_TypeDef*) (GPTM6_BASE + GPTM_CTL_CFG_OFFSET))
...
#define GPTM6_CTL_SYNC    ((GPTMSYNC_TypeDef*) (GPTM6_BASE + GPTM_CTL_SYNC_OFFSET))
...
#define GPTM6_CTL_PP    ((GPTMPP_TypeDef*) (GPTM6_BASE + GPTM_CTL_PP_OFFSET))
...
#define GPTM6_CTL_CC    ((GPTMCC_TypeDef*) (GPTM6_BASE + GPTM_CTL_CC_OFFSET))
