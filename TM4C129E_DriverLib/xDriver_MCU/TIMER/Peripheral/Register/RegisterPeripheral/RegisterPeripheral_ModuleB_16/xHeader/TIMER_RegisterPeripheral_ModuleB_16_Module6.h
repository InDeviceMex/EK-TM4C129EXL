...
************************************ 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM6_TB_TnDMAEV    ((TB_GPTMDMAEV_TypeDef*) (GPTM6_BASE + GPTM_TB_TnDMAEV_OFFSET))
#define GPTM6_TB_TnDMAEV_R    (*((volatile uint32_t*) (GPTM6_BASE + GPTM_TB_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM6_TB_TnADCEV    ((TB_GPTMADCEV_TypeDef*) (GPTM6_BASE + GPTM_TB_TnADCEV_OFFSET))
#define GPTM6_TB_TnADCEV_R    (*((volatile uint32_t*) (GPTM6_BASE + GPTM_TB_TnADCEV_OFFSET)))
