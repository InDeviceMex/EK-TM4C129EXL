...
************************************ 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM2_TB_DMAEV    ((TB_GPTMDMAEV_TypeDef*) (GPTM2_BASE + GPTM_TB_DMAEV_OFFSET))
#define GPTM2_TB_DMAEV_R    (*((volatile uint32_t*) (GPTM2_BASE + GPTM_TB_DMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM2_TB_ADCEV    ((TB_GPTMADCEV_TypeDef*) (GPTM2_BASE + GPTM_TB_ADCEV_OFFSET))
#define GPTM2_TB_ADCEV_R    (*((volatile uint32_t*) (GPTM2_BASE + GPTM_TB_ADCEV_OFFSET)))
