...
#define GPTM4_TW_TnDMAEV_R    (*((volatile uint32_t*) (GPTM4_BASE + GPTM_TW_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM4_TW_TnADCEV    ((TW_GPTMADCEV_t*) (GPTM4_BASE + GPTM_TW_TnADCEV_OFFSET))
#define GPTM4_TW_TnADCEV_R    (*((volatile uint32_t*) (GPTM4_BASE + GPTM_TW_TnADCEV_OFFSET)))
