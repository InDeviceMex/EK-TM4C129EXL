...
************************************ 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM0_TW_TnDMAEV    ((TW_GPTMDMAEV_TypeDef*) (GPTM0_BASE + GPTM_TW_TnDMAEV_OFFSET))
#define GPTM0_TW_TnDMAEV_R    (*((volatile uint32_t*) (GPTM0_BASE + GPTM_TW_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM0_TW_TnADCEV    ((TW_GPTMADCEV_TypeDef*) (GPTM0_BASE + GPTM_TW_TnADCEV_OFFSET))
