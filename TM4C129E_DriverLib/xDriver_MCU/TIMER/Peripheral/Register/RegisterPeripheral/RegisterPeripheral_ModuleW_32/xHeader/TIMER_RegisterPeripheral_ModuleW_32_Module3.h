...
************************************ 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM3_TW_TnDMAEV    ((TW_GPTMDMAEV_TypeDef*) (GPTM3_BASE + GPTM_TW_TnDMAEV_OFFSET))
#define GPTM3_TW_TnDMAEV_R    (*((volatile uint32_t*) (GPTM3_BASE + GPTM_TW_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM3_TW_TnADCEV    ((TW_GPTMADCEV_TypeDef*) (GPTM3_BASE + GPTM_TW_TnADCEV_OFFSET))
#define GPTM3_TW_TnADCEV_R    (*((volatile uint32_t*) (GPTM3_BASE + GPTM_TW_TnADCEV_OFFSET)))
