...
#define GPTM1_SYNC_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_SYNC_OFFSET)))
...
#define GPTM1_DMAEV_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_DMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM1_ADCEV    ((GPTMADCEV_t*) (GPTM1_BASE + GPTM_ADCEV_OFFSET))
#define GPTM1_ADCEV_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_ADCEV_OFFSET)))
...
#define GPTM1_CC_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_CC_OFFSET)))
