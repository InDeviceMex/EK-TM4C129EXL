...
#define GPTM7_TA_TnDMAEV_R    (*((volatile uint32_t*) (GPTM7_BASE + GPTM_TA_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM7_TA_TnADCEV    ((TA_GPTMADCEV_t*) (GPTM7_BASE + GPTM_TA_TnADCEV_OFFSET))
#define GPTM7_TA_TnADCEV_R    (*((volatile uint32_t*) (GPTM7_BASE + GPTM_TA_TnADCEV_OFFSET)))
