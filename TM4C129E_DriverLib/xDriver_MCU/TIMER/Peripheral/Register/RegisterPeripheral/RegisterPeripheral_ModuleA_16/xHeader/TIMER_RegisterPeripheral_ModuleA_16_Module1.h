...
************************************ 25 DMAEV *********************************************
******************************************************************************************/
#define GPTM1_TA_TnDMAEV    ((TA_GPTMDMAEV_TypeDef*) (GPTM1_BASE + GPTM_TA_TnDMAEV_OFFSET))
#define GPTM1_TA_TnDMAEV_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_TA_TnDMAEV_OFFSET)))

/******************************************************************************************
************************************ 26 ADCEV *********************************************
******************************************************************************************/
#define GPTM1_TA_TnADCEV    ((TA_GPTMADCEV_TypeDef*) (GPTM1_BASE + GPTM_TA_TnADCEV_OFFSET))
#define GPTM1_TA_TnADCEV_R    (*((volatile uint32_t*) (GPTM1_BASE + GPTM_TA_TnADCEV_OFFSET)))
