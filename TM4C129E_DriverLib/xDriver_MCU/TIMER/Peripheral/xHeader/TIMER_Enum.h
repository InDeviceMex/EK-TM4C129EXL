...
typedef enum
{
    ...
    TIMER_enINT_STATUS_UNDEF = 0x7FFFFFFFUL,
}TIMER_nINT_STATUS;
...
typedef enum
{
    ...
    TIMER_enSTATUS_UNDEF = 0x7FFFFFFFUL,
}TIMER_nSTATUS;
...
typedef enum
{
    ...
    TIMER_enMODULE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nMODULE;
...
typedef enum
{
    ...
    TIMER_enCONFIG_UNDEF = 0x7FFFFFFFUL,
}TIMER_nCONFIG;
...
typedef enum
{
    ...
    TIMER_enSUB_MODE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nSUB_MODE;
...
typedef enum
{
    ...
    TIMER_enEDGE_MODE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nEDGE_MODE;
...
typedef enum
{
    ...
    TIMER_enALT_MODE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nALT_MODE;
...
typedef enum
{
    ...
    TIMER_enCOUNT_DIR_UNDEF = 0x7FFFFFFFUL,
}TIMER_nCOUNT_DIR;
...
typedef enum
{
    ...
    TIMER_enWAIT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nWAIT;
...
typedef enum
{
    ...
    TIMER_enSNAPSHOT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nSNAPSHOT;
...
typedef enum
{
    ...
    TIMER_enPWM_INT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nPWM_INT;
...
typedef enum
{
    ...
    TIMER_enEVENT_INT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nEVENT_INT;
...
typedef enum
{
    ...
    TIMER_enUPDATE_INTERVAL_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    TIMER_enTIMEOUT_INT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nTIMEOUT_INT;
...
typedef enum
{
    ...
    TIMER_enMATCH_EVENT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nMATCH_EVENT;
...
typedef enum
{
    ...
    TIMER_enUPDATE_MATCH_UNDEF = 0x7FFFFFFFUL,
}TIMER_nUPDATE_MATCH;
...
typedef enum
{
    ...
    TIMER_enPWM_OUT_INIT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nPWM_OUT_INIT;
...
typedef enum
{
    ...
    TIMER_enENABLE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nENABLE;
...
typedef enum
{
    ...
    TIMER_enSTALL_UNDEF = 0x7FFFFFFFUL,
}TIMER_nSTALL;
...
typedef enum
{
    ...
    TIMER_enRTC_STALL_UNDEF = 0x7FFFFFFFUL,
}TIMER_nRTC_STALL;
...
typedef enum
{
    ...
    TIMER_enADC_TRIGGER_UNDEF = 0x7FFFFFFFUL,
}TIMER_nADC_TRIGGER;
...
typedef enum
{
    ...
    TIMER_enPWM_OUTPUT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nPWM_OUTPUT;
...
typedef enum
{
    ...
    TIMER_enEDGE_EVENT_UNDEF = 0x7FFFFFFFUL,
}TIMER_nEDGE_EVENT;
...
typedef enum
{
    ...
    TIMER_enCLOCK_UNDEF = 0x7FFFFFFFUL,
}TIMER_nCLOCK;
...
typedef enum
{
    ...
    TIMER_enMODE_UNDEF = 0x7FFFFFFFUL,
}TIMER_nMODE;
...
typedef enum
{
    ...
    TIMER_enPRESCALER_UNDEF = 0x7FFFFFFFUL,
}TIMER_nPRESCALER;
