...
void GPTM5B__vIRQVectorHandler(void)
{
    ...
    if((uint32_t) TIMER_enINT_TB_TIMEOUT & u32Reg)
    {
        ...
        pfvCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B, TIMER_enMODULE_NUM_5, TIMER_enINTERRUPT_TIMEOUT);
        pfvCallback();
    }
    if((uint32_t) TIMER_enINT_TB_CAPTURE_MATCH & u32Reg)
    {
        GPTM5_TB_TnICR_R = (uint32_t) TIMER_enINT_TB_CAPTURE_MATCH;
        pfvCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B, TIMER_enMODULE_NUM_5, TIMER_enINTERRUPT_CAPTURE_MATCH);
        pfvCallback();
    }
    if((uint32_t) TIMER_enINT_TB_CAPTURE_EVENT & u32Reg)
    {
        GPTM5_TB_TnICR_R = (uint32_t) TIMER_enINT_TB_CAPTURE_EVENT;
        pfvCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B, TIMER_enMODULE_NUM_5, TIMER_enINTERRUPT_CAPTURE_EVENT);
        pfvCallback();
    }
    if((uint32_t) TIMER_enINT_TB_MATCH & u32Reg)
    {
        GPTM5_TB_TnICR_R = (uint32_t) TIMER_enINT_TB_MATCH;
        pfvCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B, TIMER_enMODULE_NUM_5, TIMER_enINTERRUPT_MATCH);
        pfvCallback();
    }
    if((uint32_t) TIMER_enINT_TB_DMA & u32Reg)
    {
        GPTM5_TB_TnICR_R = (uint32_t) TIMER_enINT_TB_DMA;
        pfvCallback = TIMER__pvfGetIRQSourceHandler(TIMER_enSUBMODULE_B, TIMER_enMODULE_NUM_5, TIMER_enINTERRUPT_DMA);
        pfvCallback();
    }
}
