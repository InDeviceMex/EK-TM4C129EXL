...
typedef enum
{
    ...
    QEI_enSTATUS_UNDEF = 0x7FFFFFFFUL,
}QEI_nSTATUS;
...
typedef enum
{
    ...
    QEI_enPRI7 = 7UL,
    QEI_enPRIMAX = 7UL,
    QEI_enDEFAULT = 0x7FFFFFFFUL,
}QEI_nPRIORITY;

typedef enum
{
    QEI_enINTERRUPT_SW = 0UL,
    QEI_enINTERRUPT_INDEX = 1UL,
    QEI_enINTERRUPT_TIMER = 2UL,
    QEI_enINTERRUPT_DIRECTION = 3UL,
    QEI_enINTERRUPT_ERROR = 4UL,
    QEI_enINTERRUPT_MAX = 5UL,
    QEI_enINTERRUPT_UNDEF = 0x7FFFFFFFUL,
}QEI_nINTERRUPT;
...
typedef enum
{
    ...
    QEI_enINT_SOURCE_UNDEF = 0x7FFFFFFFUL,
}QEI_nINT_SOURCE;

typedef enum
{
    QEI_enINT_STATUS_INACTIVE = 0UL,
    QEI_enINT_STATUS_ACTIVE = 1UL,
    QEI_enINT_STATUS_UNDEF = 0x7FFFFFFFUL,
} QEI_nINT_STATUS;
...
typedef enum
{
    ...
    QEI_enDIRECTION_UNDEF = 0x7FFFFFFFUL,
} QEI_nDIRECTION;
...
typedef enum
{
    ...
    QEI_enENABLE_UNDEF = 0x7FFFFFFFUL,
}QEI_nENABLE;
...
typedef enum
{
    ...
    QEI_enCAPTURE_UNDEF = 0x7FFFFFFFUL,
}QEI_nCAPTURE;
...
typedef enum
{
    ...
    QEI_enRESET_UNDEF = 0x7FFFFFFFUL,
}QEI_nRESET;
...
typedef enum
{
    ...
    QEI_enVELOCITY_UNDEF = 0x7FFFFFFFUL,
}QEI_nVELOCITY;
...
typedef enum
{
    ...
    QEI_enVELOCITY_PREDIV_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    QEI_enSTALL_UNDEF = 0x7FFFFFFFUL,
}QEI_nSTALL;
...
typedef enum
{
    ...
    QEI_enINPUT_FILTER_UNDEF = 0x7FFFFFFFUL,
}QEI_nINPUT_FILTER;
...
typedef enum
{
    ...
    QEI_enINPUT_FILTER_COUNT_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    QEI_enSIGNAL_UNDEF = 0x7FFFFFFFUL,
}QEI_nSIGNAL;
...
typedef enum
{
    ...
    QEI_enSIGNAL_SELECT_UNDEF = 0x7FFFFFFFUL,
}QEI_nSIGNAL_SELECT;
...
typedef enum
{
    ...
    QEI_enINVERT_UNDEF = 0x7FFFFFFFUL,
}QEI_nINVERT;
