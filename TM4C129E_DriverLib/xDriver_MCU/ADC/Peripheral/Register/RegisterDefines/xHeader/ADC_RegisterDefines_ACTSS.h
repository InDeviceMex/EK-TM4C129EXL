...
/*--------*/
#define ADC_ACTSS_R_ADEN_MASK    ((uint32_t) 0x00000F00UL)
#define ADC_ACTSS_R_ADEN_BIT    ((uint32_t) 8UL)
#define ADC_ACTSS_R_ADEN_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_R_ADEN_ENA    ((uint32_t) 0x00000F00UL)

#define ADC_ACTSS_ADEN_MASK    ((uint32_t) 0x0000000FUL)
#define ADC_ACTSS_ADEN_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_ADEN_ENA    ((uint32_t) 0x0000000FUL)
/*--------*/

/*--------*/
#define ADC_ACTSS_R_ADEN0_MASK    ((uint32_t) 0x00000100UL)
#define ADC_ACTSS_R_ADEN0_BIT    ((uint32_t) 8UL)
#define ADC_ACTSS_R_ADEN0_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_R_ADEN0_ENA    ((uint32_t) 0x00000100UL)

#define ADC_ACTSS_ADEN0_MASK    ((uint32_t) 0x00000001UL)
#define ADC_ACTSS_ADEN0_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_ADEN0_ENA    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define ADC_ACTSS_R_ADEN1_MASK    ((uint32_t) 0x00000200UL)
#define ADC_ACTSS_R_ADEN1_BIT    ((uint32_t) 9UL)
#define ADC_ACTSS_R_ADEN1_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_R_ADEN1_ENA    ((uint32_t) 0x00000200UL)

#define ADC_ACTSS_ADEN1_MASK    ((uint32_t) 0x00000001UL)
#define ADC_ACTSS_ADEN1_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_ADEN1_ENA    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define ADC_ACTSS_R_ADEN2_MASK    ((uint32_t) 0x00000400UL)
#define ADC_ACTSS_R_ADEN2_BIT    ((uint32_t) 10UL)
#define ADC_ACTSS_R_ADEN2_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_R_ADEN2_ENA    ((uint32_t) 0x00000400UL)

#define ADC_ACTSS_ADEN2_MASK    ((uint32_t) 0x00000001UL)
#define ADC_ACTSS_ADEN2_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_ADEN2_ENA    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define ADC_ACTSS_R_ADEN3_MASK    ((uint32_t) 0x00000800UL)
#define ADC_ACTSS_R_ADEN3_BIT    ((uint32_t) 11UL)
#define ADC_ACTSS_R_ADEN3_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_R_ADEN3_ENA    ((uint32_t) 0x00000800UL)

#define ADC_ACTSS_ADEN3_MASK    ((uint32_t) 0x00000001UL)
#define ADC_ACTSS_ADEN3_DIS    ((uint32_t) 0x00000000UL)
#define ADC_ACTSS_ADEN3_ENA    ((uint32_t) 0x00000001UL)
/*--------*/
