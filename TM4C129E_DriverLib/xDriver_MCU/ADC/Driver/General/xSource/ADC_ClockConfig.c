...
{
    ADC_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penClockSourceArg) ? ADC_enERROR_POINTER : ADC_enERROR_OK;
...
{
    ADC_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) puxVCODivisorArg) ? ADC_enERROR_POINTER : ADC_enERROR_OK;
