...
#ifndef XDRIVER_MCU_ADC_DRIVER_INTRINSICS_INTERRUPT_ADC_INTERRUPT_H_
#define XDRIVER_MCU_ADC_DRIVER_INTRINSICS_INTERRUPT_ADC_INTERRUPT_H_
...
#endif /* XDRIVER_MCU_ADC_DRIVER_INTRINSICS_INTERRUPT_ADC_INTERRUPT_H_ */
