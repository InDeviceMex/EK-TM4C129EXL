...
{
    ADC__vSetSequencerGenericBit((uint32_t) enModule, ADC_EMUX_OFFSET, (uint32_t) enSequence, (uint32_t) enSeqTrigger, ADC_EMUX_EM0_MASK, (ADC_EMUX_R_EM1_BIT - ADC_EMUX_R_EM0_BIT), ADC_EMUX_R_EM0_BIT);
}
