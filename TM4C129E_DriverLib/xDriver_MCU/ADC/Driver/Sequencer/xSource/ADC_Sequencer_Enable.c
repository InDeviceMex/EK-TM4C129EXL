...
void ADC__vSetSequencerEnable(ADC_nMODULE enModule, ADC_nSEQMASK enSequence,
                              ADC_nSEQ_ENABLE enSeqEnable)
{
    ADC__vSetSequencerGeneric((uint32_t) enModule, ADC_ACTSS_OFFSET, (uint32_t) enSequence,
...
ADC_nSEQ_ENABLE ADC__enGetSequencerEnable(ADC_nMODULE enModule, ADC_nSEQMASK enSequence)
{
    ...
    enSeqEnableReg =(ADC_nSEQ_ENABLE) (ADC__u32GetSequencerGeneric((uint32_t) enModule,
                                           ADC_ACTSS_OFFSET, (uint32_t) enSequence, 0UL));
    return (enSeqEnableReg);
}

void ADC__vSetDMAEnable(ADC_nMODULE enModule, ADC_nSEQMASK enSequence,
                        ADC_nDMA_ENABLE enSeqDMAEnable)
{
    ADC__vSetSequencerGeneric((uint32_t) enModule, ADC_ACTSS_OFFSET,
...
ADC_nDMA_ENABLE ADC__enGetDMAEnable(ADC_nMODULE enModule, ADC_nSEQMASK enSequence)
{
    ...
    enDmaEnableReg = (ADC_nDMA_ENABLE) (ADC__u32GetSequencerGeneric((uint32_t) enModule,
