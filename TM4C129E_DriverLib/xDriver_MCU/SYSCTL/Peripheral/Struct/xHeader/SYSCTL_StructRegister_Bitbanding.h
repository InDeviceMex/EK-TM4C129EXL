...
typedef volatile struct
{
    ...
    const uint32_t reserved3 [6];
}BITBANDING_MEMTIM0_TypeDef;

typedef volatile struct
{
    volatile uint32_t ALTCLK [4];
    const uint32_t reserved [28];
}BITBANDING_ALTCLKCFG_TypeDef;
...
}BITBANDING_DSLPPWRCFG_TypeDef;

typedef volatile struct
{
    volatile const uint32_t FWB;
    const uint32_t reserved [31];
}BITBANDING_NVMSTAT_TypeDef;
...
}BITBANDING_RESBEHAVCTL_TypeDef;

typedef volatile struct
{
    volatile uint32_t CDOFF [24];
    volatile uint32_t KEY [8];
}BITBANDING_HSSR_TypeDef;
...
typedef volatile struct
{
    ...
    volatile const uint32_t MEMSTAT [2];
    const uint32_t reserved [28];
}BITBANDING_EMACPDS_TypeDef;

typedef volatile struct
{
    volatile uint32_t PWRCTL [2];
    const uint32_t reserved [30];
}BITBANDING_EMACMPC_TypeDef;
...
typedef volatile struct
{
    ...
    volatile const uint32_t MEMSTAT [2];
    const uint32_t reserved [28];
}BITBANDING_CAN0PDS_TypeDef;

typedef volatile struct
{
    volatile uint32_t PWRCTL [2];
    const uint32_t reserved [30];
}BITBANDING_CAN0MPC_TypeDef;
...
typedef volatile struct
{
    ...
    volatile const uint32_t MEMSTAT [2];
    const uint32_t reserved [28];
}BITBANDING_CAN1PDS_TypeDef;

typedef volatile struct
{
    volatile uint32_t PWRCTL [2];
    const uint32_t reserved [30];
}BITBANDING_CAN1MPC_TypeDef;
...
typedef volatile struct
{
    ...
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_EPI_TypeDef;
...
typedef volatile struct
{
    ...
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_EPHY_TypeDef;
...
typedef volatile struct
{
    ...
    const uint32_t reserved:31;
}BITBANDING_PERIPHERAL_LPC_TypeDef;

typedef volatile struct
{
    volatile uint32_t PECI_;
    const uint32_t reserved:31;
}BITBANDING_PERIPHERAL_PECI_TypeDef;

typedef volatile struct
{
    volatile uint32_t FAN_;
    const uint32_t reserved:31;
}BITBANDING_PERIPHERAL_FAN_TypeDef;
...
typedef volatile struct
{
    ...
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_RTS_TypeDef;

typedef volatile struct
{
    volatile uint32_t CCM_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_CCM_TypeDef;

typedef volatile struct
{
    volatile uint32_t LCD_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_LCD_TypeDef;

typedef volatile struct
{
    volatile uint32_t OWIRE_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_OWIRE_TypeDef;

typedef volatile struct
{
    volatile uint32_t EMAC_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_EMAC_TypeDef;

typedef volatile struct
{
    volatile uint32_t PRB_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_PRB_TypeDef;

typedef volatile struct
{
    volatile uint32_t HIM_;
    const uint32_t reserved [31];
}BITBANDING_PERIPHERAL_HIM_TypeDef;

typedef volatile struct
{
    volatile const uint32_t ID [32];
}BITBANDING_UNIQUEID_TypeDef;/*0x00000008*/
