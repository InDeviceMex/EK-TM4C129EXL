...
************************************ 3 PTBOCTL *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PTBOCTL    ((BITBANDING_PTBOCTL_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PTBOCTL_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PTBOCTL_VDDA_UBOR_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PTBOCTL_OFFSET) * 32UL) + ((SYSCTL_PTBOCTL_R_VDDA_UBOR_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_PTBOCTL_VDDA_UBOR_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PTBOCTL_OFFSET) * 32UL) + ((SYSCTL_PTBOCTL_R_VDDA_UBOR_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_PTBOCTL_VDD_UBOR_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PTBOCTL_OFFSET) * 32UL) + ((SYSCTL_PTBOCTL_R_VDD_UBOR_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_PTBOCTL_VDD_UBOR_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PTBOCTL_OFFSET) * 32UL) + ((SYSCTL_PTBOCTL_R_VDD_UBOR_BIT + 1UL) * 4UL))))
...
#define SYSCTL_BITBANDING_RIS_BORRIS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RIS_OFFSET) * 32UL) + (SYSCTL_RIS_R_BORRIS_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_IMC_BORIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_IMC_OFFSET) * 32UL) + (SYSCTL_IMC_R_BORIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_MISC_BORMIS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MISC_OFFSET) * 32UL) + (SYSCTL_MISC_R_BORMIS_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_RESC_HSSR    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESC_OFFSET) * 32UL) + (SYSCTL_RESC_R_HSSR_BIT * 4UL))))
...
************************************ 8 PWRTC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PWRTC    ((BITBANDING_PWRTC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PWRTC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PWRTC_VDD_UBOR    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PWRTC_OFFSET) * 32UL) + (SYSCTL_PWRTC_R_VDD_UBOR_BIT * 4UL))))
#define SYSCTL_BITBANDING_PWRTC_VDDA_UBOR    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PWRTC_OFFSET) * 32UL) + (SYSCTL_PWRTC_R_VDDA_UBOR_BIT * 4UL))))

/******************************************************************************************
************************************ 9 NMIC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_NMIC    ((BITBANDING_NMIC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_NMIC_EXTERNAL    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_EXTERNAL_BIT * 4UL))))
#define SYSCTL_BITBANDING_NMIC_POWER    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_POWER_BIT * 4UL))))
#define SYSCTL_BITBANDING_NMIC_WDT0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_WDT0_BIT * 4UL))))
#define SYSCTL_BITBANDING_NMIC_WDT1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_WDT1_BIT * 4UL))))
#define SYSCTL_BITBANDING_NMIC_TAMPER    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_TAMPER_BIT * 4UL))))
#define SYSCTL_BITBANDING_NMIC_MOSCFAIL    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_NMIC_OFFSET) * 32UL) + (SYSCTL_NMIC_R_MOSCFAIL_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_MOSCCTL_PWRDN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MOSCCTL_OFFSET) * 32UL) + (SYSCTL_MOSCCTL_R_PWRDN_BIT * 4UL))))
#define SYSCTL_BITBANDING_MOSCCTL_OSCRNG    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MOSCCTL_OFFSET) * 32UL) + (SYSCTL_MOSCCTL_R_OSCRNG_BIT * 4UL))))

/******************************************************************************************
************************************11 RSCLKCFG *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RSCLKCFG    ((BITBANDING_RSCLKCFG_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RSCLKCFG_OSCSRC_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_OSCSRC_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_OSCSRC_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_OSCSRC_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_OSCSRC_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_OSCSRC_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_OSCSRC_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_OSCSRC_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_PLLSRC_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_PLLSRC_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_PLLSRC_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_PLLSRC_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_PLLSRC_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_PLLSRC_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_PLLSRC_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_RSCLKCFG_R_PLLSRC_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_USEPLL    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + (SYSCTL_RSCLKCFG_R_USEPLL_BIT * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_ACG    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + (SYSCTL_RSCLKCFG_R_ACG_BIT * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_NEWFREQ    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + (SYSCTL_RSCLKCFG_R_NEWFREQ_BIT * 4UL))))
#define SYSCTL_BITBANDING_RSCLKCFG_MEMTIMU    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RSCLKCFG_OFFSET) * 32UL) + (SYSCTL_RSCLKCFG_R_MEMTIMU_BIT * 4UL))))

/******************************************************************************************
************************************12 MEMTIM0 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_MEMTIM0    ((BITBANDING_MEMTIM0_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_MEMTIM0_FWS_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FWS_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FWS_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FWS_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FWS_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FWS_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FWS_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FWS_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FBCE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + (SYSCTL_MEMTIM0_R_FBCE_BIT * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FBCHT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FBCHT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FBCHT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FBCHT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FBCHT_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FBCHT_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_FBCHT_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_FBCHT_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EWS_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EWS_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EWS_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EWS_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EWS_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EWS_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EWS_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EWS_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EBCE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + (SYSCTL_MEMTIM0_R_EBCE_BIT * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EBCHT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EBCHT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EBCHT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EBCHT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EBCHT_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EBCHT_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_MEMTIM0_EBCHT_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_MEMTIM0_OFFSET) * 32UL) + ((SYSCTL_MEMTIM0_R_EBCHT_BIT + 3UL) * 4UL))))

/******************************************************************************************
************************************13 ALTCLKCFG *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_ALTCLKCFG    ((BITBANDING_ALTCLKCFG_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_ALTCLKCFG_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_ALTCLKCFG_ALTCLK_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_ALTCLKCFG_OFFSET) * 32UL) + ((SYSCTL_ALTCLKCFG_R_ALTCLK_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_ALTCLKCFG_ALTCLK_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_ALTCLKCFG_OFFSET) * 32UL) + ((SYSCTL_ALTCLKCFG_R_ALTCLK_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_ALTCLKCFG_ALTCLK_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_ALTCLKCFG_OFFSET) * 32UL) + ((SYSCTL_ALTCLKCFG_R_ALTCLK_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_ALTCLKCFG_ALTCLK_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_ALTCLKCFG_OFFSET) * 32UL) + ((SYSCTL_ALTCLKCFG_R_ALTCLK_BIT + 3UL) * 4UL))))

/******************************************************************************************
************************************14 DSCLKCFG *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DSCLKCFG    ((BITBANDING_DSCLKCFG_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DSCLKCFG_DSOSCSRC_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_DSCLKCFG_R_DSOSCSRC_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_DSCLKCFG_DSOSCSRC_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_DSCLKCFG_R_DSOSCSRC_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_DSCLKCFG_DSOSCSRC_2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_DSCLKCFG_R_DSOSCSRC_BIT + 2UL) * 4UL))))
#define SYSCTL_BITBANDING_DSCLKCFG_DSOSCSRC_3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + ((SYSCTL_DSCLKCFG_R_DSOSCSRC_BIT + 3UL) * 4UL))))
#define SYSCTL_BITBANDING_DSCLKCFG_MOSCDPD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + (SYSCTL_DSCLKCFG_R_MOSCDPD_BIT * 4UL))))
#define SYSCTL_BITBANDING_DSCLKCFG_PIOSCPD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSCLKCFG_OFFSET) * 32UL) + (SYSCTL_DSCLKCFG_R_PIOSCPD_BIT * 4UL))))

/******************************************************************************************
************************************15 DIVSCLK *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DIVSCLK    ((BITBANDING_DIVSCLK_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DIVSCLK_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DIVSCLK_SRC_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DIVSCLK_OFFSET) * 32UL) + ((SYSCTL_DIVSCLK_R_SRC_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_DIVSCLK_SRC_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DIVSCLK_OFFSET) * 32UL) + ((SYSCTL_DIVSCLK_R_SRC_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_DIVSCLK_EN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DIVSCLK_OFFSET) * 32UL) + (SYSCTL_DIVSCLK_R_EN_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SYSPROP_LDOSEQ    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SYSPROP_OFFSET) * 32UL) + (SYSCTL_SYSPROP_R_LDOSEQ_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SYSPROP_TSPDE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SYSPROP_OFFSET) * 32UL) + (SYSCTL_SYSPROP_R_TSPDE_BIT * 4UL))))
#define SYSCTL_BITBANDING_SYSPROP_LDOSME    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SYSPROP_OFFSET) * 32UL) + (SYSCTL_SYSPROP_R_LDOSME_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_PIOSCSTAT_RESULT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PIOSCSTAT_OFFSET) * 32UL) + ((SYSCTL_PIOSCSTAT_R_RESULT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_PIOSCSTAT_RESULT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PIOSCSTAT_OFFSET) * 32UL) + ((SYSCTL_PIOSCSTAT_R_RESULT_BIT + 1UL) * 4UL))))
...
#define SYSCTL_BITBANDING_PLLFREQ0_PLLPWR    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PLLFREQ0_OFFSET) * 32UL) + (SYSCTL_PLLFREQ0_R_PLLPWR_BIT * 4UL))))
...
************************************22 SLPPWRCFG *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SLPPWRCFG    ((BITBANDING_SLPPWRCFG_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SLPPWRCFG_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SLPPWRCFG_SRAMPM_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_SLPPWRCFG_R_SRAMPM_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_SLPPWRCFG_SRAMPM_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_SLPPWRCFG_R_SRAMPM_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_SLPPWRCFG_FLASHPM_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_SLPPWRCFG_R_FLASHPM_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_SLPPWRCFG_FLASHPM_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_SLPPWRCFG_R_FLASHPM_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************23 DSLPPWRCFG *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DSLPPWRCFG    ((BITBANDING_DSLPPWRCFG_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DSLPPWRCFG_SRAMPM_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_DSLPPWRCFG_R_SRAMPM_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_DSLPPWRCFG_SRAMPM_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_DSLPPWRCFG_R_SRAMPM_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_DSLPPWRCFG_FLASHPM_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_DSLPPWRCFG_R_FLASHPM_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_DSLPPWRCFG_FLASHPM_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + ((SYSCTL_DSLPPWRCFG_R_FLASHPM_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_DSLPPWRCFG_TSPD    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + (SYSCTL_DSLPPWRCFG_R_TSPD_BIT * 4UL))))
#define SYSCTL_BITBANDING_DSLPPWRCFG_LDOSM    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DSLPPWRCFG_OFFSET) * 32UL) + (SYSCTL_DSLPPWRCFG_R_LDOSM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SDPMST_PPDERR    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SDPMST_OFFSET) * 32UL) + (SYSCTL_SDPMST_R_PPDERR_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SDPMST_PPDW    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SDPMST_OFFSET) * 32UL) + (SYSCTL_SDPMST_R_PPDW_BIT * 4UL))))
...
************************************30 RESBEHAVCTL *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RESBEHAVCTL    ((BITBANDING_RESBEHAVCTL_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RESBEHAVCTL_EXTRES_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_EXTRES_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_EXTRES_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_EXTRES_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_BOR_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_BOR_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_BOR_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_BOR_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_WDOG0_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_WDOG0_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_WDOG0_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_WDOG0_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_WDOG1_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_WDOG1_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_RESBEHAVCTL_WDOG1_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RESBEHAVCTL_OFFSET) * 32UL) + ((SYSCTL_RESBEHAVCTL_R_WDOG1_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************31 HSSR *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_HSSR    ((BITBANDING_HSSR_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_HSSR_OFFSET) * 32UL)))

/******************************************************************************************
************************************32 USBPDS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_USBPDS    ((BITBANDING_USBPDS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBPDS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_USBPDS_PWRSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBPDS_OFFSET) * 32UL) + ((SYSCTL_USBPDS_R_PWRSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_USBPDS_PWRSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBPDS_OFFSET) * 32UL) + ((SYSCTL_USBPDS_R_PWRSTAT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_USBPDS_MEMSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBPDS_OFFSET) * 32UL) + ((SYSCTL_USBPDS_R_MEMSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_USBPDS_MEMSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBPDS_OFFSET) * 32UL) + ((SYSCTL_USBPDS_R_MEMSTAT_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************33 USBMPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_USBMPC    ((BITBANDING_USBMPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBMPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_USBMPC_PWRCTL_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBMPC_OFFSET) * 32UL) + ((SYSCTL_USBMPC_R_PWRCTL_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_USBMPC_PWRCTL_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_USBMPC_OFFSET) * 32UL) + ((SYSCTL_USBMPC_R_PWRCTL_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************34 EMACPDS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_EMACPDS    ((BITBANDING_EMACPDS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACPDS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_EMACPDS_PWRSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACPDS_OFFSET) * 32UL) + ((SYSCTL_EMACPDS_R_PWRSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_EMACPDS_PWRSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACPDS_OFFSET) * 32UL) + ((SYSCTL_EMACPDS_R_PWRSTAT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_EMACPDS_MEMSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACPDS_OFFSET) * 32UL) + ((SYSCTL_EMACPDS_R_MEMSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_EMACPDS_MEMSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACPDS_OFFSET) * 32UL) + ((SYSCTL_EMACPDS_R_MEMSTAT_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************35 EMACMPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_EMACMPC    ((BITBANDING_EMACMPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACMPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_EMACMPC_PWRCTL_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACMPC_OFFSET) * 32UL) + ((SYSCTL_EMACMPC_R_PWRCTL_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_EMACMPC_PWRCTL_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_EMACMPC_OFFSET) * 32UL) + ((SYSCTL_EMACMPC_R_PWRCTL_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************36 CAN0PDS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_CAN0PDS    ((BITBANDING_CAN0PDS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0PDS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_CAN0PDS_PWRSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0PDS_OFFSET) * 32UL) + ((SYSCTL_CAN0PDS_R_PWRSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN0PDS_PWRSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0PDS_OFFSET) * 32UL) + ((SYSCTL_CAN0PDS_R_PWRSTAT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN0PDS_MEMSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0PDS_OFFSET) * 32UL) + ((SYSCTL_CAN0PDS_R_MEMSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN0PDS_MEMSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0PDS_OFFSET) * 32UL) + ((SYSCTL_CAN0PDS_R_MEMSTAT_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************37 CAN0MPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_CAN0MPC    ((BITBANDING_CAN0MPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0MPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_CAN0MPC_PWRCTL_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0MPC_OFFSET) * 32UL) + ((SYSCTL_CAN0MPC_R_PWRCTL_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN0MPC_PWRCTL_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN0MPC_OFFSET) * 32UL) + ((SYSCTL_CAN0MPC_R_PWRCTL_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************38 CAN1PDS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_CAN1PDS    ((BITBANDING_CAN1PDS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1PDS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_CAN1PDS_PWRSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1PDS_OFFSET) * 32UL) + ((SYSCTL_CAN1PDS_R_PWRSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN1PDS_PWRSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1PDS_OFFSET) * 32UL) + ((SYSCTL_CAN1PDS_R_PWRSTAT_BIT + 1UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN1PDS_MEMSTAT_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1PDS_OFFSET) * 32UL) + ((SYSCTL_CAN1PDS_R_MEMSTAT_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN1PDS_MEMSTAT_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1PDS_OFFSET) * 32UL) + ((SYSCTL_CAN1PDS_R_MEMSTAT_BIT + 1UL) * 4UL))))

/******************************************************************************************
************************************39 CAN1MPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_CAN1MPC    ((BITBANDING_CAN1MPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1MPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_CAN1MPC_PWRCTL_0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1MPC_OFFSET) * 32UL) + ((SYSCTL_CAN1MPC_R_PWRCTL_BIT + 0UL) * 4UL))))
#define SYSCTL_BITBANDING_CAN1MPC_PWRCTL_1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_CAN1MPC_OFFSET) * 32UL) + ((SYSCTL_CAN1MPC_R_PWRCTL_BIT + 1UL) * 4UL))))
...
#define SYSCTL_BITBANDING_PPTIMER_TIMER6    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPTIMER_OFFSET) * 32UL) + (SYSCTL_PPTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PPTIMER_TIMER7    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPTIMER_OFFSET) * 32UL) + (SYSCTL_PPTIMER_R_TIMER7_BIT * 4UL))))
...
************************************44 PPEPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPEPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPEPI_EPI0    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEPI_OFFSET) * 32UL) + (SYSCTL_PPEPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_PPI2C_I2C6    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPI2C_OFFSET) * 32UL) + (SYSCTL_PPI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PPI2C_I2C7    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPI2C_OFFSET) * 32UL) + (SYSCTL_PPI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_PPI2C_I2C8    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPI2C_OFFSET) * 32UL) + (SYSCTL_PPI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_PPI2C_I2C9    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPI2C_OFFSET) * 32UL) + (SYSCTL_PPI2C_R_I2C9_BIT * 4UL))))
...
************************************50 PPEPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPEPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPEPHY_EPHY    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEPHY_OFFSET) * 32UL) + (SYSCTL_PPEPHY_R_EPHY_BIT * 4UL))))
...
************************************56 PPLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPLPC_LPC    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPLPC_OFFSET) * 32UL) + (SYSCTL_PPLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************57 PPPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPPECI_PECI    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPPECI_OFFSET) * 32UL) + (SYSCTL_PPPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************58 PPFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPFAN_FAN    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPFAN_OFFSET) * 32UL) + (SYSCTL_PPFAN_R_FAN_BIT * 4UL))))
...
************************************61 PPRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPRTS_RTS    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPRTS_OFFSET) * 32UL) + (SYSCTL_PPRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************62 PPCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPCCM_CCM    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPCCM_OFFSET) * 32UL) + (SYSCTL_PPCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************63 PPLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPLCD_LCD    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPLCD_OFFSET) * 32UL) + (SYSCTL_PPLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************64 PPOWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPOWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPOWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPOWIRE_OWIRE    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPOWIRE_OFFSET) * 32UL) + (SYSCTL_PPOWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************65 PPEMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPEMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPEMAC_EMAC    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPEMAC_OFFSET) * 32UL) + (SYSCTL_PPEMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************66 PPPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPPRB_PRB    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPPRB_OFFSET) * 32UL) + (SYSCTL_PPPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************67 PPHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PPHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PPHIM_HIM    (*((volatile const uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PPHIM_OFFSET) * 32UL) + (SYSCTL_PPHIM_R_HIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SRTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRTIMER_OFFSET) * 32UL) + (SYSCTL_SRTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_SRTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRTIMER_OFFSET) * 32UL) + (SYSCTL_SRTIMER_R_TIMER7_BIT * 4UL))))
...
************************************72 SREPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SREPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SREPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREPI_OFFSET) * 32UL) + (SYSCTL_SREPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SRI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRI2C_OFFSET) * 32UL) + (SYSCTL_SRI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_SRI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRI2C_OFFSET) * 32UL) + (SYSCTL_SRI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_SRI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRI2C_OFFSET) * 32UL) + (SYSCTL_SRI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_SRI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRI2C_OFFSET) * 32UL) + (SYSCTL_SRI2C_R_I2C9_BIT * 4UL))))
...
************************************78 SREPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SREPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SREPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREPHY_OFFSET) * 32UL) + (SYSCTL_SREPHY_R_EPHY_BIT * 4UL))))
...
************************************84 SRLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRLPC_OFFSET) * 32UL) + (SYSCTL_SRLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************85 SRPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRPECI_OFFSET) * 32UL) + (SYSCTL_SRPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************86 SRFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRFAN_OFFSET) * 32UL) + (SYSCTL_SRFAN_R_FAN_BIT * 4UL))))
...
************************************89 SRRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRRTS_OFFSET) * 32UL) + (SYSCTL_SRRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************90 SRCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRCCM_OFFSET) * 32UL) + (SYSCTL_SRCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************91 SRLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRLCD_OFFSET) * 32UL) + (SYSCTL_SRLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************92 SROWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SROWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SROWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SROWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SROWIRE_OFFSET) * 32UL) + (SYSCTL_SROWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************93 SREMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SREMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SREMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SREMAC_OFFSET) * 32UL) + (SYSCTL_SREMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************94 SRPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRPRB_OFFSET) * 32UL) + (SYSCTL_SRPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************95 SRHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SRHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SRHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SRHIM_OFFSET) * 32UL) + (SYSCTL_SRHIM_R_HIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_RCGCTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCTIMER_OFFSET) * 32UL) + (SYSCTL_RCGCTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_RCGCTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCTIMER_OFFSET) * 32UL) + (SYSCTL_RCGCTIMER_R_TIMER7_BIT * 4UL))))
...
************************************100 RCGCEPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCEPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCEPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEPI_OFFSET) * 32UL) + (SYSCTL_RCGCEPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_RCGCI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCI2C_OFFSET) * 32UL) + (SYSCTL_RCGCI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_RCGCI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCI2C_OFFSET) * 32UL) + (SYSCTL_RCGCI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_RCGCI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCI2C_OFFSET) * 32UL) + (SYSCTL_RCGCI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_RCGCI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCI2C_OFFSET) * 32UL) + (SYSCTL_RCGCI2C_R_I2C9_BIT * 4UL))))
...
************************************106 RCGCEPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCEPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCEPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEPHY_OFFSET) * 32UL) + (SYSCTL_RCGCEPHY_R_EPHY_BIT * 4UL))))
...
************************************112 RCGCLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCLPC_OFFSET) * 32UL) + (SYSCTL_RCGCLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************113 RCGCPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCPECI_OFFSET) * 32UL) + (SYSCTL_RCGCPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************114 RCGCFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCFAN_OFFSET) * 32UL) + (SYSCTL_RCGCFAN_R_FAN_BIT * 4UL))))
...
************************************117 RCGCRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCRTS_OFFSET) * 32UL) + (SYSCTL_RCGCRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************118 RCGCCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCCCM_OFFSET) * 32UL) + (SYSCTL_RCGCCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************119 RCGCLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCLCD_OFFSET) * 32UL) + (SYSCTL_RCGCLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************120 RCGCOWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCOWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCOWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCOWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCOWIRE_OFFSET) * 32UL) + (SYSCTL_RCGCOWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************121 RCGCEMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCEMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCEMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCEMAC_OFFSET) * 32UL) + (SYSCTL_RCGCEMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************122 RCGCPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCPRB_OFFSET) * 32UL) + (SYSCTL_RCGCPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************123 RCGCHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RCGCHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_RCGCHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RCGCHIM_OFFSET) * 32UL) + (SYSCTL_RCGCHIM_R_HIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SCGCTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCTIMER_OFFSET) * 32UL) + (SYSCTL_SCGCTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_SCGCTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCTIMER_OFFSET) * 32UL) + (SYSCTL_SCGCTIMER_R_TIMER7_BIT * 4UL))))
...
************************************128 SCGCEPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCEPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCEPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEPI_OFFSET) * 32UL) + (SYSCTL_SCGCEPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_SCGCI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCI2C_OFFSET) * 32UL) + (SYSCTL_SCGCI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_SCGCI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCI2C_OFFSET) * 32UL) + (SYSCTL_SCGCI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_SCGCI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCI2C_OFFSET) * 32UL) + (SYSCTL_SCGCI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_SCGCI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCI2C_OFFSET) * 32UL) + (SYSCTL_SCGCI2C_R_I2C9_BIT * 4UL))))
...
************************************134 SCGCEPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCEPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCEPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEPHY_OFFSET) * 32UL) + (SYSCTL_SCGCEPHY_R_EPHY_BIT * 4UL))))
...
************************************140 SCGCLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCLPC_OFFSET) * 32UL) + (SYSCTL_SCGCLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************141 SCGCPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCPECI_OFFSET) * 32UL) + (SYSCTL_SCGCPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************142 SCGCFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCFAN_OFFSET) * 32UL) + (SYSCTL_SCGCFAN_R_FAN_BIT * 4UL))))
...
************************************145 SCGCRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCRTS_OFFSET) * 32UL) + (SYSCTL_SCGCRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************146 SCGCCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCCCM_OFFSET) * 32UL) + (SYSCTL_SCGCCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************147 SCGCLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCLCD_OFFSET) * 32UL) + (SYSCTL_SCGCLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************148 SCGCOWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCOWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCOWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCOWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCOWIRE_OFFSET) * 32UL) + (SYSCTL_SCGCOWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************149 SCGCEMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCEMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCEMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCEMAC_OFFSET) * 32UL) + (SYSCTL_SCGCEMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************150 SCGCPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCPRB_OFFSET) * 32UL) + (SYSCTL_SCGCPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************151 SCGCHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_SCGCHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_SCGCHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_SCGCHIM_OFFSET) * 32UL) + (SYSCTL_SCGCHIM_R_HIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_DCGCTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCTIMER_OFFSET) * 32UL) + (SYSCTL_DCGCTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_DCGCTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCTIMER_OFFSET) * 32UL) + (SYSCTL_DCGCTIMER_R_TIMER7_BIT * 4UL))))
...
************************************156 DCGCEPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCEPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCEPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEPI_OFFSET) * 32UL) + (SYSCTL_DCGCEPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_DCGCI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCI2C_OFFSET) * 32UL) + (SYSCTL_DCGCI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_DCGCI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCI2C_OFFSET) * 32UL) + (SYSCTL_DCGCI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_DCGCI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCI2C_OFFSET) * 32UL) + (SYSCTL_DCGCI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_DCGCI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCI2C_OFFSET) * 32UL) + (SYSCTL_DCGCI2C_R_I2C9_BIT * 4UL))))
...
************************************162 DCGCEPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCEPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCEPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEPHY_OFFSET) * 32UL) + (SYSCTL_DCGCEPHY_R_EPHY_BIT * 4UL))))
...
************************************168 DCGCLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCLPC_OFFSET) * 32UL) + (SYSCTL_DCGCLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************169 DCGCPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCPECI_OFFSET) * 32UL) + (SYSCTL_DCGCPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************170 DCGCFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCFAN_OFFSET) * 32UL) + (SYSCTL_DCGCFAN_R_FAN_BIT * 4UL))))
...
************************************173 DCGCRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCRTS_OFFSET) * 32UL) + (SYSCTL_DCGCRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************174 DCGCCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCCCM_OFFSET) * 32UL) + (SYSCTL_DCGCCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************175 DCGCLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCLCD_OFFSET) * 32UL) + (SYSCTL_DCGCLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************176 DCGCOWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCOWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCOWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCOWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCOWIRE_OFFSET) * 32UL) + (SYSCTL_DCGCOWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************177 DCGCEMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCEMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCEMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCEMAC_OFFSET) * 32UL) + (SYSCTL_DCGCEMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************178 DCGCPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCPRB_OFFSET) * 32UL) + (SYSCTL_DCGCPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************179 DCGCHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_DCGCHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_DCGCHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_DCGCHIM_OFFSET) * 32UL) + (SYSCTL_DCGCHIM_R_HIM_BIT * 4UL))))

/******************************************************************************************
************************************180 PCWD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCWD    ((BITBANDING_PERIPHERAL_WD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCWD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCWD_WDT0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCWD_OFFSET) * 32UL) + (SYSCTL_PCWD_R_WDT0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCWD_WDT1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCWD_OFFSET) * 32UL) + (SYSCTL_PCWD_R_WDT1_BIT * 4UL))))

/******************************************************************************************
************************************181 PCTIMER *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCTIMER    ((BITBANDING_PERIPHERAL_TIMER_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCTIMER_TIMER0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER1_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER2_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER3_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER4    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER4_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER5    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER5_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCTIMER_OFFSET) * 32UL) + (SYSCTL_PCTIMER_R_TIMER7_BIT * 4UL))))

/******************************************************************************************
************************************182 PCGPIO *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCGPIO    ((BITBANDING_PERIPHERAL_GPIO_BITBANDING_TypeDef*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOA    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOA_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOB    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOB_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOC    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOC_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOD    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOD_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOE    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOE_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOF    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOF_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOG    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOG_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOH    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOH_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOJ    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOJ_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOK    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOK_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOL    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOL_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOM    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOM_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPION    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPION_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOP    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOP_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCGPIO_BITBANDING_GPIOQ    (*((volatile uint32_t*) (SYSCTL_BASE  + (SYSCTL_OFFSET + SYSCTL_PCGPIO_OFFSET) * 32UL) + (SYSCTL_PCGPIO_R_GPIOQ_BIT * 4UL))))

/******************************************************************************************
************************************183 PCDMA *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCDMA    ((BITBANDING_PERIPHERAL_DMA_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCDMA_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCDMA_UDMA    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCDMA_OFFSET) * 32UL) + (SYSCTL_PCDMA_R_UDMA_BIT * 4UL))))

/******************************************************************************************
************************************184 PCEPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCEPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCEPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEPI_OFFSET) * 32UL) + (SYSCTL_PCEPI_R_EPI0_BIT * 4UL))))

/******************************************************************************************
************************************185 PCHIB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCHIB    ((BITBANDING_PERIPHERAL_HIB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCHIB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCHIB_HIB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCHIB_OFFSET) * 32UL) + (SYSCTL_PCHIB_R_HIB_BIT * 4UL))))

/******************************************************************************************
************************************186 PCUART *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCUART    ((BITBANDING_PERIPHERAL_UART_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCUART_UART0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART1_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART2_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART3_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART4    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART4_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART5    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART5_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCUART_UART7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUART_OFFSET) * 32UL) + (SYSCTL_PCUART_R_UART7_BIT * 4UL))))

/******************************************************************************************
************************************187 PCSSI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCSSI    ((BITBANDING_PERIPHERAL_SSI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCSSI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCSSI_SSI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCSSI_OFFSET) * 32UL) + (SYSCTL_PCSSI_R_SSI0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCSSI_SSI1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCSSI_OFFSET) * 32UL) + (SYSCTL_PCSSI_R_SSI1_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCSSI_SSI2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCSSI_OFFSET) * 32UL) + (SYSCTL_PCSSI_R_SSI2_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCSSI_SSI3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCSSI_OFFSET) * 32UL) + (SYSCTL_PCSSI_R_SSI3_BIT * 4UL))))

/******************************************************************************************
************************************188 PCI2C *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCI2C    ((BITBANDING_PERIPHERAL_I2C_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCI2C_I2C0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C1_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C2    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C2_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C3    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C3_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C4    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C4_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C5    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C5_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCI2C_OFFSET) * 32UL) + (SYSCTL_PCI2C_R_I2C9_BIT * 4UL))))

/******************************************************************************************
************************************189 PCUSB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCUSB    ((BITBANDING_PERIPHERAL_USB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUSB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCUSB_USB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCUSB_OFFSET) * 32UL) + (SYSCTL_PCUSB_R_USB_BIT * 4UL))))

/******************************************************************************************
************************************190 PCEPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCEPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCEPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEPHY_OFFSET) * 32UL) + (SYSCTL_PCEPHY_R_EPHY_BIT * 4UL))))

/******************************************************************************************
************************************191 PCCAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCCAN    ((BITBANDING_PERIPHERAL_CAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCCAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCCAN_CAN0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCCAN_OFFSET) * 32UL) + (SYSCTL_PCCAN_R_CAN0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCCAN_CAN1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCCAN_OFFSET) * 32UL) + (SYSCTL_PCCAN_R_CAN1_BIT * 4UL))))

/******************************************************************************************
************************************192 PCADC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCADC    ((BITBANDING_PERIPHERAL_ADC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCADC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCADC_ADC0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCADC_OFFSET) * 32UL) + (SYSCTL_PCADC_R_ADC0_BIT * 4UL))))
#define SYSCTL_BITBANDING_PCADC_ADC1    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCADC_OFFSET) * 32UL) + (SYSCTL_PCADC_R_ADC1_BIT * 4UL))))

/******************************************************************************************
************************************193 PCACMP *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCACMP    ((BITBANDING_PERIPHERAL_ACMP_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCACMP_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCACMP_ACMP    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCACMP_OFFSET) * 32UL) + (SYSCTL_PCACMP_R_ACMP_BIT * 4UL))))

/****************************************************************************************
************************************194 PCPWM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCPWM    ((BITBANDING_PERIPHERAL_PWM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPWM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCPWM_PWM0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPWM_OFFSET) * 32UL) + (SYSCTL_PCPWM_R_PWM0_BIT * 4UL))))

/******************************************************************************************
************************************195 PCQEI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCQEI    ((BITBANDING_PERIPHERAL_QEI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCQEI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCQEI_QEI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCQEI_OFFSET) * 32UL) + (SYSCTL_PCQEI_R_QEI0_BIT * 4UL))))

/******************************************************************************************
************************************196 PCLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCLPC_OFFSET) * 32UL) + (SYSCTL_PCLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************197 PCPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPECI_OFFSET) * 32UL) + (SYSCTL_PCPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************198 PCFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCFAN_OFFSET) * 32UL) + (SYSCTL_PCFAN_R_FAN_BIT * 4UL))))

/******************************************************************************************
************************************199 PCEEPROM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCEEPROM    ((BITBANDING_PERIPHERAL_EEPROM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEEPROM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCEEPROM_EEPROM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEEPROM_OFFSET) * 32UL) + (SYSCTL_PCEEPROM_R_EEPROM_BIT * 4UL))))

/**********************************************************************************
************************************200 PCWTIMER *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCWTIMER    ((BITBANDING_PERIPHERAL_WTIMER_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCWTIMER_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCWTIMER_WTIMER0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCWTIMER_OFFSET) * 32UL) + (SYSCTL_PCWTIMER_R_WTIMER0_BIT * 4UL))))

/**********************************************************************************
************************************201 PCRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCRTS_OFFSET) * 32UL) + (SYSCTL_PCRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************202 PCCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCCCM_OFFSET) * 32UL) + (SYSCTL_PCCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************203 PCLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCLCD_OFFSET) * 32UL) + (SYSCTL_PCLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************204 PCOWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCOWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCOWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCOWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCOWIRE_OFFSET) * 32UL) + (SYSCTL_PCOWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************205 PCEMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCEMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCEMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCEMAC_OFFSET) * 32UL) + (SYSCTL_PCEMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************206 PCPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCPRB_OFFSET) * 32UL) + (SYSCTL_PCPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************207 PCHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PCHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PCHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PCHIM_OFFSET) * 32UL) + (SYSCTL_PCHIM_R_HIM_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_PRTIMER_TIMER6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRTIMER_OFFSET) * 32UL) + (SYSCTL_PRTIMER_R_TIMER6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PRTIMER_TIMER7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRTIMER_OFFSET) * 32UL) + (SYSCTL_PRTIMER_R_TIMER7_BIT * 4UL))))
...
************************************212 PREPI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PREPI    ((BITBANDING_PERIPHERAL_EPI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREPI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PREPI_EPI0    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREPI_OFFSET) * 32UL) + (SYSCTL_PREPI_R_EPI0_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_PRI2C_I2C6    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRI2C_OFFSET) * 32UL) + (SYSCTL_PRI2C_R_I2C6_BIT * 4UL))))
#define SYSCTL_BITBANDING_PRI2C_I2C7    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRI2C_OFFSET) * 32UL) + (SYSCTL_PRI2C_R_I2C7_BIT * 4UL))))
#define SYSCTL_BITBANDING_PRI2C_I2C8    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRI2C_OFFSET) * 32UL) + (SYSCTL_PRI2C_R_I2C8_BIT * 4UL))))
#define SYSCTL_BITBANDING_PRI2C_I2C9    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRI2C_OFFSET) * 32UL) + (SYSCTL_PRI2C_R_I2C9_BIT * 4UL))))
...
************************************218 PREPHY *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PREPHY    ((BITBANDING_PERIPHERAL_EPHY_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREPHY_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PREPHY_EPHY    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREPHY_OFFSET) * 32UL) + (SYSCTL_PREPHY_R_EPHY_BIT * 4UL))))
...
************************************224 PRLPC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRLPC    ((BITBANDING_PERIPHERAL_LPC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRLPC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRLPC_LPC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRLPC_OFFSET) * 32UL) + (SYSCTL_PRLPC_R_LPC_BIT * 4UL))))

/******************************************************************************************
************************************225 PRPECI *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRPECI    ((BITBANDING_PERIPHERAL_PECI_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRPECI_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRPECI_PECI    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRPECI_OFFSET) * 32UL) + (SYSCTL_PRPECI_R_PECI_BIT * 4UL))))

/******************************************************************************************
************************************226 PRFAN *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRFAN    ((BITBANDING_PERIPHERAL_FAN_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRFAN_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRFAN_FAN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRFAN_OFFSET) * 32UL) + (SYSCTL_PRFAN_R_FAN_BIT * 4UL))))
...
************************************229 PRRTS *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRRTS    ((BITBANDING_PERIPHERAL_RTS_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRRTS_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRRTS_RTS    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRRTS_OFFSET) * 32UL) + (SYSCTL_PRRTS_R_RTS_BIT * 4UL))))

/**********************************************************************************
************************************230 PRCCM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRCCM    ((BITBANDING_PERIPHERAL_CCM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRCCM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRCCM_CCM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRCCM_OFFSET) * 32UL) + (SYSCTL_PRCCM_R_CCM_BIT * 4UL))))

/**********************************************************************************
************************************231 PRLCD *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRLCD    ((BITBANDING_PERIPHERAL_LCD_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRLCD_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRLCD_LCD    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRLCD_OFFSET) * 32UL) + (SYSCTL_PRLCD_R_LCD_BIT * 4UL))))

/**********************************************************************************
************************************232 PROWIRE *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PROWIRE    ((BITBANDING_PERIPHERAL_OWIRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PROWIRE_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PROWIRE_OWIRE    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PROWIRE_OFFSET) * 32UL) + (SYSCTL_PROWIRE_R_OWIRE_BIT * 4UL))))

/**********************************************************************************
************************************233 PREMAC *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PREMAC    ((BITBANDING_PERIPHERAL_EMAC_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREMAC_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PREMAC_EMAC    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PREMAC_OFFSET) * 32UL) + (SYSCTL_PREMAC_R_EMAC_BIT * 4UL))))

/**********************************************************************************
************************************234 PRPRB *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRPRB    ((BITBANDING_PERIPHERAL_PRB_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRPRB_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRPRB_PRB    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRPRB_OFFSET) * 32UL) + (SYSCTL_PRPRB_R_PRB_BIT * 4UL))))

/**********************************************************************************
************************************235 PRHIM *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_PRHIM    ((BITBANDING_PERIPHERAL_HIM_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRHIM_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_PRHIM_HIM    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_PRHIM_OFFSET) * 32UL) + (SYSCTL_PRHIM_R_HIM_BIT * 4UL))))

/**********************************************************************************
************************************236 UNIQUEID0 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_UNIQUEID0    ((BITBANDING_UNIQUEID_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_UNIQUEID0_OFFSET) * 32UL)))

/**********************************************************************************
************************************237 UNIQUEID1 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_UNIQUEID1    ((BITBANDING_UNIQUEID_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_UNIQUEID1_OFFSET) * 32UL)))

/**********************************************************************************
************************************238 UNIQUEID2 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_UNIQUEID2    ((BITBANDING_UNIQUEID_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_UNIQUEID2_OFFSET) * 32UL)))

/**********************************************************************************
************************************239 UNIQUEID3 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_UNIQUEID3    ((BITBANDING_UNIQUEID_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_UNIQUEID3_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 240-Flash RVP *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_RVP    ((BITBANDING_RVP_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_RVP_OFFSET) * 32UL)))
...
************************************ 245-Flash FMPRE4 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE4    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE4_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 246-Flash FMPRE5 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE5    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE5_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 247-Flash FMPRE6 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE6    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE6_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 248-Flash FMPRE7 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE7    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE7_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 249-Flash FMPRE8 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE8    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE8_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 250-Flash FMPRE9 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE9    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE9_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 251-Flash FMPRE10 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE10    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE10_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 252-Flash FMPRE11 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE11    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE11_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 253-Flash FMPRE12 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE12    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE12_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 254-Flash FMPRE13 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE13    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE13_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 255-Flash FMPRE14 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE14    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE14_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 256-Flash FMPRE15 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPRE15    ((BITBANDING_FMPRE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPRE15_OFFSET) * 32UL)))
...
************************************ 261-Flash FMPPE4 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE4    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE4_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 262-Flash FMPPE5 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE5    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE5_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 263-Flash FMPPE6 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE6    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE6_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 264-Flash FMPPE7 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE7    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE7_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 265-Flash FMPPE8 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE8    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE8_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 266-Flash FMPPE9 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE9    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE9_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 267-Flash FMPPE10 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE10    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE10_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 268-Flash FMPPE11 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE11    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE11_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 269-Flash FMPPE12 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE12    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE12_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 270-Flash FMPPE13 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE13    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE13_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 271-Flash FMPPE14 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE14    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE14_OFFSET) * 32UL)))

/******************************************************************************************
************************************ 272-Flash FMPPE15 *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_FMPPE15    ((BITBANDING_FMPPE_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_FMPPE15_OFFSET) * 32UL)))
