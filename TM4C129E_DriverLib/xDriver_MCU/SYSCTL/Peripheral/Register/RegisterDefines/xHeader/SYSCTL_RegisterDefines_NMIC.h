...
/*--------*/
#define SYSCTL_NMIC_R_MOSC_FAILURE_MASK    ((UBase_t) 0x00010000UL)
#define SYSCTL_NMIC_R_MOSC_FAILURE_BIT    (16UL)
#define SYSCTL_NMIC_R_MOSC_FAILURE_INACTIVE    ((UBase_t) 0x00000000UL)
#define SYSCTL_NMIC_R_MOSC_FAILURE_ACTIVE    ((UBase_t) 0x00010000UL)

#define SYSCTL_NMIC_MOSC_FAILURE_MASK    ((UBase_t) 0x00000001UL)
#define SYSCTL_NMIC_MOSC_FAILURE_INACTIVE    ((UBase_t) 0x00000000UL)
#define SYSCTL_NMIC_MOSC_FAILURE_ACTIVE    ((UBase_t) 0x00000001UL)
/*--------*/
