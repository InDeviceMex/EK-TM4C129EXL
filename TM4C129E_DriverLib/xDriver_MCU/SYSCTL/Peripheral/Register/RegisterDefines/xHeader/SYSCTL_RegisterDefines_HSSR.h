...
******************************************************************************************/
/*--------*/
#define SYSCTL_HSSR_R_CDOFF_MASK    ((uint32_t) 0x00FFFFFFUL)
#define SYSCTL_HSSR_R_CDOFF_BIT    (0UL)

#define SYSCTL_HSSR_CDOFF_MASK    ((uint32_t) 0x00FFFFFFUL)
/*--------*/

/*--------*/
#define SYSCTL_HSSR_R_KEY_MASK    ((uint32_t) 0xFF000000UL)
#define SYSCTL_HSSR_R_KEY_BIT    (24UL)
#define SYSCTL_HSSR_R_KEY_INIT    ((uint32_t) 0xCA000000UL)

#define SYSCTL_HSSR_KEY_MASK    ((uint32_t) 0x000000FFUL)
#define SYSCTL_HSSR_KEY_INIT    ((uint32_t) 0x000000CAUL)
/*--------*/
