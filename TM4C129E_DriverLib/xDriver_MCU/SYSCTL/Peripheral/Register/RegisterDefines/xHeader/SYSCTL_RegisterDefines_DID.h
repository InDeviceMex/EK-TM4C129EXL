...
#define SYSCTL_DID0_R_CLASS_TIVAS    ((uint32_t) 0x000A0000UL)

#define SYSCTL_DID0_CLASS_MASK    ((uint32_t) 0x000000FFUL)
#define SYSCTL_DID0_CLASS_TIVAC    ((uint32_t) 0x00000005UL)
#define SYSCTL_DID0_CLASS_TIVAS    ((uint32_t) 0x0000000AUL)
/*--------*/
...
#define SYSCTL_DID1_R_PINCOUNT_212    ((uint32_t) 0x0000D000UL)
...
#define SYSCTL_DID1_PINCOUNT_212    ((uint32_t) 0x00000007UL)
/*--------*/

/*--------*/
#define SYSCTL_DID1_R_PARTNO_MASK    ((uint32_t) 0x00FF0000UL)
#define SYSCTL_DID1_R_PARTNO_BIT    (16UL)
#define SYSCTL_DID1_R_PARTNO_TM4C123G    ((uint32_t) 0x00A10000UL)
#define SYSCTL_DID1_R_PARTNO_TM4C129E    ((uint32_t) 0x002D0000UL)

#define SYSCTL_DID1_PARTNO_MASK    ((uint32_t) 0x000000FFUL)
#define SYSCTL_DID1_PARTNO_TM4C123G    ((uint32_t) 0x000000A1UL)
#define SYSCTL_DID1_PARTNO_TM4C123E    ((uint32_t) 0x0000002DUL)
/*--------*/
