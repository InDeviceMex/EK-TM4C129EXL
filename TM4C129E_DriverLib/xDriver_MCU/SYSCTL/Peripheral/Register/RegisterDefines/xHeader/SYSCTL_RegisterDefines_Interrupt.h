...
#define SYSCTL_MISC_R_BOR1MIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_R_BOR1MIS_ACTIVE    ((uint32_t) 0x00000002UL)

#define SYSCTL_MISC_BOR1MIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSCTL_MISC_BOR1MIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_BOR1MIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*--------*/
...
#define SYSCTL_MISC_R_USBPLLLMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_R_USBPLLLMIS_ACTIVE    ((uint32_t) 0x00000080UL)

#define SYSCTL_MISC_USBPLLLMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSCTL_MISC_USBPLLLMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_USBPLLLMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*--------*/
...
#define SYSCTL_MISC_R_VDDAMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_R_VDDAMIS_ACTIVE    ((uint32_t) 0x00000400UL)

#define SYSCTL_MISC_VDDAMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSCTL_MISC_VDDAMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_VDDAMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define SYSCTL_MISC_R_BOR0MIS_MASK    ((uint32_t) 0x00000800UL)
#define SYSCTL_MISC_R_BOR0MIS_BIT    (11UL)
#define SYSCTL_MISC_R_BOR0MIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_R_BOR0MIS_ACTIVE    ((uint32_t) 0x00000800UL)

#define SYSCTL_MISC_BOR0MIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSCTL_MISC_BOR0MIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSCTL_MISC_BOR0MIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*--------*/
