...
typedef enum
{
    ...
    SYSCTL_enPRI6 = 6UL,
    SYSCTL_enPRI7 = 7UL,
    SYSCTL_enDEFAULT = 0xFFFFFFFFUL,
}SYSCTL_nPRIORITY;

typedef enum
{
    SYSCTL_enINTERRUPT_BOR = 0UL,
    SYSCTL_enINTERRUPT_MOF = 1UL,
    SYSCTL_enINTERRUPT_PLLL = 2UL,
    SYSCTL_enINTERRUPT_MOSCPUP = 3UL,
    SYSCTL_enINTERRUPT_MAX = 4UL,
}SYSCTL_nINTERRUPT;
