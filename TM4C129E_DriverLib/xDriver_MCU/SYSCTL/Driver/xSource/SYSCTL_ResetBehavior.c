...
{
    MCU__vWriteRegister(SYSCTL_BASE, SYSCTL_RESBEHAVCTL_OFFSET, (UBase_t) enBehavior,
...
SYSCTL_nRESET_BEHAVIOR SYSCTL__enGetResetBehavior_External(void)
{
    ...
    enResetReg = (SYSCTL_nRESET_BEHAVIOR) MCU__uxReadRegister(SYSCTL_BASE,
             SYSCTL_RESBEHAVCTL_OFFSET, SYSCTL_RESBEHAVCTL_EXTRES_MASK,
             SYSCTL_RESBEHAVCTL_R_EXTRES_BIT);
    return (enResetReg);
}
...
SYSCTL_nRESET_BEHAVIOR SYSCTL__enGetResetBehavior_BOR(void)
{
    SYSCTL_nRESET_BEHAVIOR enResetReg = SYSCTL_enRESET_BEHAVIOR_SYSRESET;
    enResetReg = (SYSCTL_nRESET_BEHAVIOR) MCU__uxReadRegister(SYSCTL_BASE,
                   SYSCTL_RESBEHAVCTL_OFFSET, SYSCTL_RESBEHAVCTL_BOR_MASK,
                   SYSCTL_RESBEHAVCTL_R_BOR_BIT);
    return (enResetReg);
}
...
SYSCTL_nRESET_BEHAVIOR SYSCTL__enGetResetBehavior_Watchdog0(void)
{
    SYSCTL_nRESET_BEHAVIOR enResetReg = SYSCTL_enRESET_BEHAVIOR_SYSRESET;
    enResetReg = (SYSCTL_nRESET_BEHAVIOR) MCU__uxReadRegister(SYSCTL_BASE,
               SYSCTL_RESBEHAVCTL_OFFSET, SYSCTL_RESBEHAVCTL_WDOG0_MASK,
               SYSCTL_RESBEHAVCTL_R_WDOG0_BIT);
    return (enResetReg);
}
...
SYSCTL_nRESET_BEHAVIOR SYSCTL__enGetResetBehavior_Watchdog1(void)
{
    SYSCTL_nRESET_BEHAVIOR enResetReg = SYSCTL_enRESET_BEHAVIOR_SYSRESET;
    enResetReg = (SYSCTL_nRESET_BEHAVIOR) MCU__uxReadRegister(SYSCTL_BASE,
                   SYSCTL_RESBEHAVCTL_OFFSET, SYSCTL_RESBEHAVCTL_WDOG1_MASK,
                   SYSCTL_RESBEHAVCTL_R_WDOG1_BIT);
    return (enResetReg);
}
