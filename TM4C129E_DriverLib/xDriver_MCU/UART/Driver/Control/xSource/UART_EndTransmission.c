...
{
    UART__vWriteRegister(enModule, UART_CTL_OFFSET, (UBase_t) enEndTransmissionArg,
...
UART_nEOT UART__enGetEndTransmission(UART_nMODULE enModule)
{
    ...
    enEndTransmissionReg = (UART_nEOT) UART__uxReadRegister(enModule, UART_CTL_OFFSET,
                                            UART_CTL_EOT_MASK, UART_CTL_R_EOT_BIT);
