...
UART_nERROR UART__enGetParityErrorStatus(UART_nMODULE enModuleArg, UART_nSTATUS* penStatusArg)
{
    ...
    {
        stRegister.uxShift = UART_RSR_R_PE_BIT;
        stRegister.uxMask = UART_RSR_PE_MASK;
