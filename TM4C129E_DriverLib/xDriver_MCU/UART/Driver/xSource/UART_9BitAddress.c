...
{
    UART_n9BIT enReg = UART_en9BIT_DIS;
    enReg = (UART_n9BIT) UART__u32ReadRegister(enModule, UART_9BITADDR_OFFSET,
                                           UART_9BITADDR_BIT9EN_MASK, UART_9BITADDR_R_BIT9EN_BIT);
    return (enReg);
}
...
{
    UART__vWriteRegister(enModule, UART_9BITADDR_OFFSET, u32AddressArg, UART_9BITADDR_ADDR_MASK, UART_9BITADDR_R_ADDR_BIT);
}

uint32_t UART__u32GetSelfAddress(UART_nMODULE enModule)
{
    uint32_t u32AddressReg = 0UL;
    u32AddressReg = UART__u32ReadRegister(enModule, UART_9BITADDR_OFFSET, UART_9BITADDR_ADDR_MASK, UART_9BITADDR_R_ADDR_BIT);
    return (u32AddressReg);
}

void UART__vSetSelfAddressMask(UART_nMODULE enModule, uint32_t u32AddressMaskArg)
{
    UART__vWriteRegister(enModule, UART_9BITAMASK_OFFSET, u32AddressMaskArg, UART_9BITAMASK_MASK_MASK, UART_9BITAMASK_R_MASK_BIT);
}

uint32_t UART__u32GetSelfAddressMask(UART_nMODULE enModule)
{
    uint32_t u32AddressMaskReg = 0UL;
    u32AddressMaskReg = UART__u32ReadRegister(enModule, UART_9BITAMASK_OFFSET, UART_9BITAMASK_MASK_MASK, UART_9BITAMASK_R_MASK_BIT);
