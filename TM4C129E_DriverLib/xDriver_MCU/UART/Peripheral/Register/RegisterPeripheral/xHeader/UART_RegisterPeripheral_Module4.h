...
#define UART4_PCellID0_R    (*((volatile const uint32_t*) (UART4_BASE + UART_PCellID0_OFFSET)))
...
#define UART4_PCellID1_R    (*((volatile const uint32_t*) (UART4_BASE + UART_PCellID1_OFFSET)))
...
#define UART4_PCellID2_R    (*((volatile const uint32_t*) (UART4_BASE + UART_PCellID2_OFFSET)))
...
#define UART4_PCellID3_R    (*((volatile const uint32_t*) (UART4_BASE + UART_PCellID3_OFFSET)))
