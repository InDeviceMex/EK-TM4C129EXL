...
#define UART6_PCellID0_R    (*((volatile const uint32_t*) (UART6_BASE + UART_PCellID0_OFFSET)))
...
#define UART6_PCellID1_R    (*((volatile const uint32_t*) (UART6_BASE + UART_PCellID1_OFFSET)))
...
#define UART6_PCellID2_R    (*((volatile const uint32_t*) (UART6_BASE + UART_PCellID2_OFFSET)))
...
#define UART6_PCellID3_R    (*((volatile const uint32_t*) (UART6_BASE + UART_PCellID3_OFFSET)))
