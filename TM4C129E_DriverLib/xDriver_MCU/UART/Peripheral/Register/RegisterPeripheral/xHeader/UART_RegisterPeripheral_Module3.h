...
************************************ 1 DR *********************************************
******************************************************************************************/
#define UART3_DR    ((UARTDR_t*) (UART3_BASE + UART_DR_OFFSET ))
...
************************************ 15 9BITADDR *********************************************
******************************************************************************************/
#define UART3_9BITADDR    ((UART9BITADDR8_t*) (UART3_BASE + UART_9BITADDR_OFFSET ))
#define UART3_9BITADDR_R    (*((volatile uint32_t*) (UART3_BASE + UART_9BITADDR_OFFSET)))

/******************************************************************************************
************************************ 16 9BITAMASK *********************************************
******************************************************************************************/
#define UART3_9BITAMASK    ((UART9BITAMASK8_t*) (UART3_BASE + UART_9BITAMASK_OFFSET ))
#define UART3_9BITAMASK_R    (*((volatile uint32_t*) (UART3_BASE + UART_9BITAMASK_OFFSET)))

/******************************************************************************************
************************************ 17 PP *********************************************
******************************************************************************************/
#define UART3_PP    ((UARTPP_t*) (UART3_BASE + UART_PP_OFFSET ))
#define UART3_PP_R    (*((volatile const uint32_t*) (UART3_BASE + UART_PP_OFFSET)))

/******************************************************************************************
************************************ 18 CC *********************************************
******************************************************************************************/
#define UART3_CC    ((UARTCC_t*) (UART3_BASE + UART_CC_OFFSET ))
 ...
 ******************************************************************************************/
/* UART3 PID4*/
#define UART3_PeriphID4    ((UARTPeriphID4_t*) (UART3_BASE + UART_PeriphID4_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID5*/
#define UART3_PeriphID5    ((UARTPeriphID5_t*) (UART3_BASE + UART_PeriphID5_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID6*/
#define UART3_PeriphID6    ((UARTPeriphID6_t*) (UART3_BASE + UART_PeriphID6_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID7*/
#define UART3_PeriphID7    ((UARTPeriphID7_t*) (UART3_BASE + UART_PeriphID7_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID0*/
#define UART3_PeriphID0    ((UARTPeriphID0_t*) (UART3_BASE + UART_PeriphID0_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID1*/
#define UART3_PeriphID1    ((UARTPeriphID1_t*) (UART3_BASE + UART_PeriphID1_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID2*/
#define UART3_PeriphID2    ((UARTPeriphID2_t*) (UART3_BASE + UART_PeriphID2_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 PID3*/
#define UART3_PeriphID3    ((UARTPeriphID3_t*) (UART3_BASE + UART_PeriphID3_OFFSET))
 ...
 ******************************************************************************************/
/* UART3 CID0*/
#define UART3_PCellID0    ((UARTCellID0_t*) (UART3_BASE + UART_PCellID0_OFFSET))
#define UART3_PCellID0_R    (*((volatile const uint32_t*) (UART3_BASE + UART_PCellID0_OFFSET)))

/******************************************************************************************
 ************************************ 28 CellID1 *********************************************
 ******************************************************************************************/
/* UART3 CID1*/
#define UART3_PCellID1    ((UARTCellID1_t*) (UART3_BASE + UART_PCellID1_OFFSET))
#define UART3_PCellID1_R    (*((volatile const uint32_t*) (UART3_BASE + UART_PCellID1_OFFSET)))

/******************************************************************************************
 ************************************ 29 CellID2 *********************************************
 ******************************************************************************************/
/* UART3 CID2*/
#define UART3_PCellID2    ((UARTCellID2_t*) (UART3_BASE + UART_PCellID2_OFFSET))
#define UART3_PCellID2_R    (*((volatile const uint32_t*) (UART3_BASE + UART_PCellID2_OFFSET)))

/******************************************************************************************
 ************************************ 30 CellID3 *********************************************
 ******************************************************************************************/
/* UART3 CID3*/
#define UART3_PCellID3    ((UARTCellID3_t*) (UART3_BASE + UART_PCellID3_OFFSET))
#define UART3_PCellID3_R    (*((volatile const uint32_t*) (UART3_BASE + UART_PCellID3_OFFSET)))
