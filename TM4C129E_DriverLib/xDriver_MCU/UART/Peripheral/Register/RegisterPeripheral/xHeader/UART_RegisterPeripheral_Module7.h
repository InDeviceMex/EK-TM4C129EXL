...
************************************ 1 DR *********************************************
******************************************************************************************/
#define UART7_DR    ((UARTDR_t*) (UART7_BASE + UART_DR_OFFSET ))
...
************************************ 15 9BITADDR *********************************************
******************************************************************************************/
#define UART7_9BITADDR    ((UART9BITADDR8_t*) (UART7_BASE + UART_9BITADDR_OFFSET ))
#define UART7_9BITADDR_R    (*((volatile uint32_t*) (UART7_BASE + UART_9BITADDR_OFFSET)))

/******************************************************************************************
************************************ 16 9BITAMASK *********************************************
******************************************************************************************/
#define UART7_9BITAMASK    ((UART9BITAMASK8_t*) (UART7_BASE + UART_9BITAMASK_OFFSET ))
#define UART7_9BITAMASK_R    (*((volatile uint32_t*) (UART7_BASE + UART_9BITAMASK_OFFSET)))

/******************************************************************************************
************************************ 17 PP *********************************************
******************************************************************************************/
#define UART7_PP    ((UARTPP_t*) (UART7_BASE + UART_PP_OFFSET ))
#define UART7_PP_R    (*((volatile const uint32_t*) (UART7_BASE + UART_PP_OFFSET)))

/******************************************************************************************
************************************ 18 CC *********************************************
******************************************************************************************/
#define UART7_CC    ((UARTCC_t*) (UART7_BASE + UART_CC_OFFSET ))
 ...
 ******************************************************************************************/
/* UART7 PID4*/
#define UART7_PeriphID4    ((UARTPeriphID4_t*) (UART7_BASE + UART_PeriphID4_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID5*/
#define UART7_PeriphID5    ((UARTPeriphID5_t*) (UART7_BASE + UART_PeriphID5_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID6*/
#define UART7_PeriphID6    ((UARTPeriphID6_t*) (UART7_BASE + UART_PeriphID6_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID7*/
#define UART7_PeriphID7    ((UARTPeriphID7_t*) (UART7_BASE + UART_PeriphID7_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID0*/
#define UART7_PeriphID0    ((UARTPeriphID0_t*) (UART7_BASE + UART_PeriphID0_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID1*/
#define UART7_PeriphID1    ((UARTPeriphID1_t*) (UART7_BASE + UART_PeriphID1_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID2*/
#define UART7_PeriphID2    ((UARTPeriphID2_t*) (UART7_BASE + UART_PeriphID2_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 PID3*/
#define UART7_PeriphID3    ((UARTPeriphID3_t*) (UART7_BASE + UART_PeriphID3_OFFSET))
 ...
 ******************************************************************************************/
/* UART7 CID0*/
#define UART7_PCellID0    ((UARTCellID0_t*) (UART7_BASE + UART_PCellID0_OFFSET))
#define UART7_PCellID0_R    (*((volatile const uint32_t*) (UART7_BASE + UART_PCellID0_OFFSET)))

/******************************************************************************************
 ************************************ 28 CellID1 *********************************************
 ******************************************************************************************/
/* UART7 CID1*/
#define UART7_PCellID1    ((UARTCellID1_t*) (UART7_BASE + UART_PCellID1_OFFSET))
#define UART7_PCellID1_R    (*((volatile const uint32_t*) (UART7_BASE + UART_PCellID1_OFFSET)))

/******************************************************************************************
 ************************************ 29 CellID2 *********************************************
 ******************************************************************************************/
/* UART7 CID2*/
#define UART7_PCellID2    ((UARTCellID2_t*) (UART7_BASE + UART_PCellID2_OFFSET))
#define UART7_PCellID2_R    (*((volatile const uint32_t*) (UART7_BASE + UART_PCellID2_OFFSET)))

/******************************************************************************************
 ************************************ 30 CellID3 *********************************************
 ******************************************************************************************/
/* UART7 CID3*/
#define UART7_PCellID3    ((UARTCellID3_t*) (UART7_BASE + UART_PCellID3_OFFSET))
#define UART7_PCellID3_R    (*((volatile const uint32_t*) (UART7_BASE + UART_PCellID3_OFFSET)))
