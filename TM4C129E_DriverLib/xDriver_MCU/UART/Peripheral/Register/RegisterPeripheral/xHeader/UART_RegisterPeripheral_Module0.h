...
************************************ 1 DR *********************************************
******************************************************************************************/
#define UART0_DR    ((UARTDR_t*) (UART0_BASE + UART_DR_OFFSET ))
...
************************************ 15 9BITADDR *********************************************
******************************************************************************************/
#define UART0_9BITADDR    ((UART9BITADDR8_t*) (UART0_BASE + UART_9BITADDR_OFFSET ))
#define UART0_9BITADDR_R    (*((volatile uint32_t*) (UART0_BASE + UART_9BITADDR_OFFSET)))

/******************************************************************************************
************************************ 16 9BITAMASK *********************************************
******************************************************************************************/
#define UART0_9BITAMASK    ((UART9BITAMASK8_t*) (UART0_BASE + UART_9BITAMASK_OFFSET ))
#define UART0_9BITAMASK_R    (*((volatile uint32_t*) (UART0_BASE + UART_9BITAMASK_OFFSET)))

/******************************************************************************************
************************************ 17 PP *********************************************
******************************************************************************************/
#define UART0_PP    ((UARTPP_t*) (UART0_BASE + UART_PP_OFFSET ))
#define UART0_PP_R    (*((volatile const uint32_t*) (UART0_BASE + UART_PP_OFFSET)))

/******************************************************************************************
************************************ 18 CC *********************************************
******************************************************************************************/
#define UART0_CC    ((UARTCC_t*) (UART0_BASE + UART_CC_OFFSET ))
 ...
 ******************************************************************************************/
/* UART0 PID4*/
#define UART0_PeriphID4    ((UARTPeriphID4_t*) (UART0_BASE + UART_PeriphID4_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID5*/
#define UART0_PeriphID5    ((UARTPeriphID5_t*) (UART0_BASE + UART_PeriphID5_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID6*/
#define UART0_PeriphID6    ((UARTPeriphID6_t*) (UART0_BASE + UART_PeriphID6_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID7*/
#define UART0_PeriphID7    ((UARTPeriphID7_t*) (UART0_BASE + UART_PeriphID7_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID0*/
#define UART0_PeriphID0    ((UARTPeriphID0_t*) (UART0_BASE + UART_PeriphID0_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID1*/
#define UART0_PeriphID1    ((UARTPeriphID1_t*) (UART0_BASE + UART_PeriphID1_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID2*/
#define UART0_PeriphID2    ((UARTPeriphID2_t*) (UART0_BASE + UART_PeriphID2_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 PID3*/
#define UART0_PeriphID3    ((UARTPeriphID3_t*) (UART0_BASE + UART_PeriphID3_OFFSET))
 ...
 ******************************************************************************************/
/* UART0 CID0*/
#define UART0_PCellID0    ((UARTCellID0_t*) (UART0_BASE + UART_PCellID0_OFFSET))
#define UART0_PCellID0_R    (*((volatile const uint32_t*) (UART0_BASE + UART_PCellID0_OFFSET)))

/******************************************************************************************
 ************************************ 28 CellID1 *********************************************
 ******************************************************************************************/
/* UART0 CID1*/
#define UART0_PCellID1    ((UARTCellID1_t*) (UART0_BASE + UART_PCellID1_OFFSET))
#define UART0_PCellID1_R    (*((volatile const uint32_t*) (UART0_BASE + UART_PCellID1_OFFSET)))

/******************************************************************************************
 ************************************ 29 CellID2 *********************************************
 ******************************************************************************************/
/* UART0 CID2*/
#define UART0_PCellID2    ((UARTCellID2_t*) (UART0_BASE + UART_PCellID2_OFFSET))
#define UART0_PCellID2_R    (*((volatile const uint32_t*) (UART0_BASE + UART_PCellID2_OFFSET)))

/******************************************************************************************
 ************************************ 30 CellID3 *********************************************
 ******************************************************************************************/
/* UART0 CID3*/
#define UART0_PCellID3    ((UARTCellID3_t*) (UART0_BASE + UART_PCellID3_OFFSET))
#define UART0_PCellID3_R    (*((volatile const uint32_t*) (UART0_BASE + UART_PCellID3_OFFSET)))
