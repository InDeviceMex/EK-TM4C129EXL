 ...
 ******************************************************************************************/
/* UART6 CID0*/
#define UART6_BITBANDING_CellID0    ((BITBANDING_UARTCellID0_t*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID0_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 28 CellID1 *********************************************
 ******************************************************************************************/
/* UART6 CID1*/
#define UART6_BITBANDING_CellID1    ((BITBANDING_UARTCellID1_t*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID1_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 29 CellID2 *********************************************
 ******************************************************************************************/
/* UART6 CID2*/
#define UART6_BITBANDING_CellID2    ((BITBANDING_UARTCellID2_t*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID2_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 30 CellID3 *********************************************
 ******************************************************************************************/
/* UART6 CID3*/
#define UART6_BITBANDING_CellID3    ((BITBANDING_UARTCellID3_t*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID3_OFFSET) * 32U)))
