...
************************************ UART6 *********************************************
******************************************************************************************/
#define UART6_BITBANDING    ((UART_BITBANDING_TypeDef*) (UART_BITBANDING_BASE + (UART6_OFFSET * 32U)))

/******************************************************************************************
*********************************** * 1 DR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_DR    ((BITBANDING_UARTDR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_DR_OFFSET) * 32U)))
...
*********************************** * 2 RSR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_RSR    ((BITBANDING_UARTRSR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_RSR_OFFSET) * 32U)))
#define UART6_BITBANDING_ECR    ((BITBANDING_UARTECR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_ECR_OFFSET) * 32U)))
...
*********************************** * 3 FR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_FR    ((BITBANDING_UARTFR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_FR_OFFSET) * 32U)))
...
*********************************** * 4 ILPR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_ILPR    ((BITBANDING_UARTILPR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_ILPR_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 5 IBRD *********************************************
******************************************************************************************/
#define UART6_BITBANDING_IBRD    ((BITBANDING_UARTIBRD_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_IBRD_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 6 FBRD *********************************************
******************************************************************************************/
#define UART6_BITBANDING_FBRD    ((BITBANDING_UARTFBRD_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_FBRD_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 7 LCRH *********************************************
******************************************************************************************/
#define UART6_BITBANDING_LCRH    ((BITBANDING_UARTLCRH_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_LCRH_OFFSET) * 32U)))
...
*********************************** * 9 IFLS *********************************************
******************************************************************************************/
#define UART6_BITBANDING_IFLS    ((BITBANDING_UARTIFLS_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_IFLS_OFFSET) * 32U)))
...
*********************************** * 10 IM *********************************************
******************************************************************************************/
#define UART6_BITBANDING_IM    ((BITBANDING_UARTIM_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_IM_OFFSET) * 32U)))
...
*********************************** * 11 RIS *********************************************
******************************************************************************************/
#define UART6_BITBANDING_RIS    ((BITBANDING_UARTRIS_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_RIS_OFFSET) * 32U)))
...
*********************************** * 12 MIS *********************************************
******************************************************************************************/
#define UART6_BITBANDING_MIS    ((BITBANDING_UARTMIS_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_MIS_OFFSET) * 32U)))
...
*********************************** * 13 ICR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_ICR    ((BITBANDING_UARTICR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_ICR_OFFSET) * 32U)))
...
*********************************** * 14 DMACTL *********************************************
******************************************************************************************/
#define UART6_BITBANDING_DMACTL    ((BITBANDING_UARTDMACTL_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_DMACTL_OFFSET) * 32U)))
...
*********************************** * 15 9BITADDR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_9BITADDR    ((BITBANDING_9BITADDR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_9BITADDR_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 16 9BITAMASK *********************************************
******************************************************************************************/
#define UART6_BITBANDING_9BITAMASK    ((BITBANDING_9BITAMASK_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_9BITAMASK_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 17 PP *********************************************
******************************************************************************************/
#define UART6_BITBANDING_PP    ((BITBANDING_UARTPP_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PP_OFFSET) * 32U)))
...
*********************************** * 18 CC *********************************************
******************************************************************************************/
#define UART6_BITBANDING_CC    ((BITBANDING_UARTCC_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CC_OFFSET) * 32U)))
 ...
 ******************************************************************************************/
/* UART6 PID4*/
#define UART6_BITBANDING_PeriphID4    ((BITBANDING_UARTPeriphID4_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID4_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 20 PeriphID5 *********************************************
 ******************************************************************************************/
/* UART6 PID5*/
#define UART6_BITBANDING_PeriphID5    ((BITBANDING_UARTPeriphID5_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID5_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 21 PeriphID6 *********************************************
 ******************************************************************************************/
/* UART6 PID6*/
#define UART6_BITBANDING_PeriphID6    ((BITBANDING_UARTPeriphID6_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID6_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 22 PeriphID7 *********************************************
 ******************************************************************************************/
/* UART6 PID7*/
#define UART6_BITBANDING_PeriphID7    ((BITBANDING_UARTPeriphID7_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID7_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 23 PeriphID0 *********************************************
 ******************************************************************************************/
/* UART6 PID0*/
#define UART6_BITBANDING_PeriphID0    ((BITBANDING_UARTPeriphID0_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID0_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 24 PeriphID1 *********************************************
 ******************************************************************************************/
/* UART6 PID1*/
#define UART6_BITBANDING_PeriphID1    ((BITBANDING_UARTPeriphID1_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID1_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 25 PeriphID2 *********************************************
 ******************************************************************************************/
/* UART6 PID2*/
#define UART6_BITBANDING_PeriphID2    ((BITBANDING_UARTPeriphID2_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID2_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 26 PeriphID3 *********************************************
 ******************************************************************************************/
/* UART6 PID3*/
#define UART6_BITBANDING_PeriphID3    ((BITBANDING_UARTPeriphID3_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_PeriphID3_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 27 CellID0 *********************************************
 ******************************************************************************************/
/* UART6 CID0*/
#define UART6_BITBANDING_CellID0    ((BITBANDING_UARTCellID0_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID0_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 28 CellID1 *********************************************
 ******************************************************************************************/
/* UART6 CID1*/
#define UART6_BITBANDING_CellID1    ((BITBANDING_UARTCellID1_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID1_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 29 CellID2 *********************************************
 ******************************************************************************************/
/* UART6 CID2*/
#define UART6_BITBANDING_CellID2    ((BITBANDING_UARTCellID2_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID2_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 30 CellID3 *********************************************
 ******************************************************************************************/
/* UART6 CID3*/
#define UART6_BITBANDING_CellID3    ((BITBANDING_UARTCellID3_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_CellID3_OFFSET) * 32U)))
