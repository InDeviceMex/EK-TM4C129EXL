...
typedef enum
{
    UART_enINTERRUPT_RING_INDICATOR = 0UL,
    UART_enINTERRUPT_CLEAR_TO_SEND = 1UL,
    UART_enINTERRUPT_DATA_CARRIER_DETECT = 2UL,
    UART_enINTERRUPT_DATA_SET_READY = 3UL,
    UART_enINTERRUPT_RECEIVE = 4UL,
    UART_enINTERRUPT_TRANSMIT = 5UL,
    UART_enINTERRUPT_RECEIVE_TIMEOUT = 6UL,
    UART_enINTERRUPT_FRAME_ERROR = 7UL,
    UART_enINTERRUPT_PARITY_ERROR = 8UL,
    UART_enINTERRUPT_BREAK_ERROR = 9UL,
    UART_enINTERRUPT_OVERRUN_ERROR = 10UL,
    UART_enINTERRUPT_END_OF_TRANSMISSION = 11UL,
    UART_enINTERRUPT_BIT9_MODE = 12UL,
    UART_enINTERRUPT_DMA_RECEIVE = 13UL,
    UART_enINTERRUPT_DMA_TRANSMIT = 14UL,
    UART_enINTERRUPT_MAX = 15UL,
}UART_nINTERRUPT;
