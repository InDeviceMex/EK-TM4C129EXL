...
typedef enum
{
    ...
    UART_enSTATUS_UNDEF = 0x7FFFFFFFUL,
}UART_nSTATUS;
...
typedef enum
{
    ...
    UART_enPRI6 = 6UL,
    UART_enPRI7 = 7UL,
    UART_enDEFAULT = 0x7FFFFFFFUL,
}UART_nPRIORITY;

typedef enum
{
    UART_enINTERRUPT_SW = 0UL,
    UART_enINTERRUPT_RING_INDICATOR = 1UL,
    UART_enINTERRUPT_CLEAR_TO_SEND = 2UL,
    UART_enINTERRUPT_DATA_CARRIER_DETECT = 3UL,
    UART_enINTERRUPT_DATA_SET_READY = 4UL,
    UART_enINTERRUPT_RECEIVE = 5UL,
    UART_enINTERRUPT_TRANSMIT = 6UL,
    UART_enINTERRUPT_RECEIVE_TIMEOUT = 7UL,
    UART_enINTERRUPT_FRAME_ERROR = 8UL,
    UART_enINTERRUPT_PARITY_ERROR = 9UL,
    UART_enINTERRUPT_BREAK_ERROR = 10UL,
    UART_enINTERRUPT_OVERRUN_ERROR = 11UL,
    UART_enINTERRUPT_END_OF_TRANSMISSION = 12UL,
    UART_enINTERRUPT_BIT9_MODE = 13UL,
    UART_enINTERRUPT_DMA_RECEIVE = 14UL,
    UART_enINTERRUPT_DMA_TRANSMIT = 15UL,
    UART_enINTERRUPT_MAX = 16UL,
}UART_nINTERRUPT;

typedef enum
{
    UART_enINT_SOURCE_NONE = 0x0UL,
    UART_enINT_SOURCE_RING_INDICATOR = 0x1UL,
    UART_enINT_SOURCE_CLEAR_TO_SEND = 0x2UL,
    UART_enINT_SOURCE_DATA_CARRIER_DETECT = 0x4UL,
    UART_enINT_SOURCE_DATA_SET_READY = 0x8UL,
    ...
    UART_enINT_SOURCE_END_OF_TRANSMISSION = 0x800UL,
    UART_enINT_SOURCE_BIT9_MODE = 0x1000UL,
    UART_enINT_SOURCE_DMA_RECEIVE = 0x10000UL,
    UART_enINT_SOURCE_DMA_TRANSMIT = 0x20000UL,
    UART_enINT_SOURCE_ALL = 0x31FFFUL,
}UART_nINT_SOURCE;

typedef enum
{
    UART_enINT_STATUS_INACTIVE = 0UL,
    UART_enINT_STATUS_ACTIVE = 1UL,
    UART_enINT_STATUS_UNDEF = 0x7FFFFFFFUL,
} UART_nINT_STATUS;

typedef enum
{
    UART_enERROR_INACTIVE = 0UL,
    UART_enERROR_ACTIVE = 1UL,
    UART_enERROR_UNDEF = 0x7FFFFFFFUL,
}UART_nERROR;
...
typedef enum
{
    ...
    UART_enBUSY_UNDEF = 0x7FFFFFFFUL,
}UART_nBUSY;
...
typedef enum
{
    UART_enFIFO_DIS = 0UL,
    UART_enFIFO_ENA = 1UL,
    UART_enFIFO_UNDEF = 0x7FFFFFFFUL,
}UART_nFIFO;
...
typedef enum
{
    ...
    UART_enFIFO_EMPTY_UNDEF = 0x7FFFFFFFUL,
}UART_nFIFO_EMPTY;
...
typedef enum
{
    ...
    UART_enFIFO_FULL_UNDEF = 0x7FFFFFFFUL,
}UART_nFIFO_FULL;
...
typedef enum
{
    ...
    UART_enBREAK_UNDEF = 0x7FFFFFFFUL,
}UART_nBREAK;
...
typedef enum
{
    ...
    UART_enPARITY_UNDEF = 0x7FFFFFFFUL,
}UART_nPARITY;
...
typedef enum
{
    ...
    UART_enPARITY_STICK_UNDEF = 0x7FFFFFFFUL,
}UART_nPARITY_STICK;
...
typedef enum
{
    ...
    UART_enPARITY_TYPE_UNDEF = 0x7FFFFFFFUL,
}UART_nPARITY_TYPE;
...
typedef enum
{
    UART_enSTOP_ONE = 0UL,
    UART_enSTOP_TWO = 1UL,
    UART_enSTOP_UNDEF = 0x7FFFFFFFUL,
}UART_nSTOP;
...
typedef enum
{
    ...
    UART_enLENGTH_UNDEF = 0x7FFFFFFFUL,
}UART_nLENGTH;
...
typedef enum
{
    ...
    UART_enFIFO_LEVEL_UNDEF = 0x7FFFFFFFUL,
}UART_nFIFO_LEVEL;
...
typedef enum
{
    UART_en9BIT_DIS = 0UL,
    UART_en9BIT_ENA = 1UL,
    UART_en9BIT_UNDEF = 0x7FFFFFFFUL,
}UART_n9BIT;
...
typedef enum
{
    ...
    UART_enHIGH_SPEED_UNDEF = 0x7FFFFFFFUL,
}UART_nHIGH_SPEED;
...
typedef enum
{
    ...
    UART_enMODE_UNDEF = 0x7FFFFFFFUL,
}UART_nMODE;
...
typedef enum
{
    ...
    UART_enCLOCK_UNDEF = 0x7FFFFFFFUL,
}UART_nCLOCK;
...
typedef enum
{
    ...
    UART_enENABLE_UNDEF = 0x7FFFFFFFUL,
}UART_nENABLE;
...
typedef enum
{
    UART_enLINE_DIS = 0UL,
    UART_enLINE_ENA = 1UL,
    UART_enLINE_UNDEF = 0x7FFFFFFFUL,
}UART_nLINE;
...
typedef enum
{
    ...
    UART_enLOOPBACK_UNDEF = 0x7FFFFFFFUL,
}UART_nLOOPBACK;
...
typedef enum
{
    ...
    UART_enRTS_MODE_UNDEF = 0x7FFFFFFFUL,
}UART_nRTS_MODE;
...
typedef enum
{
    ...
    UART_enCTS_MODE_UNDEF = 0x7FFFFFFFUL,
}UART_nCTS_MODE;
...
typedef enum
{
    ...
    UART_enRTS_LEVEL_UNDEF = 0x7FFFFFFFUL,
}UART_nRTS_LEVEL;
...
typedef enum
{
    ...
    UART_enSMART_UNDEF = 0x7FFFFFFFUL,
}UART_nSMART;
...
typedef enum
{
    ...
    UART_enSIR_LP_UNDEF = 0x7FFFFFFFUL,
}UART_nSIR_LP;
...
typedef enum
{
    ...
    UART_enLINE_SELECT_UNDEF = 0x7FFFFFFFUL,
}UART_nLINE_SELECT;
