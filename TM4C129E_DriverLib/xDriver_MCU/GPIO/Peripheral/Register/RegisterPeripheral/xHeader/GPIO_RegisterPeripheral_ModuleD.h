...
#define GPIOD_PCellID0_R    (*((volatile uint32_t *) (GPIOD_BASE + GPIO_PCellID0_OFFSET)))
...
#define GPIOD_PCellID1_R    (*((volatile uint32_t *) (GPIOD_BASE + GPIO_PCellID1_OFFSET)))
...
#define GPIOD_PCellID2_R    (*((volatile uint32_t *) (GPIOD_BASE + GPIO_PCellID2_OFFSET)))
...
#define GPIOD_PCellID3_R    (*((volatile uint32_t *) (GPIOD_BASE + GPIO_PCellID3_OFFSET)))
