 ...
 ******************************************************************************************/
/* GPIOC DATA*/
#define GPIOC_DATA_MASK    ((GPIODATA_MASK_t*) (GPIOC_BASE + GPIO_DATA_MASK_OFFSET))
...
#define GPIOC_DATA    ((GPIODATA_t*) (GPIOC_BASE + GPIO_DATA_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DIR*/
#define GPIOC_DIR    ((GPIODIR_t*) (GPIOC_BASE + GPIO_DIR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC IS*/
#define GPIOC_IS    ((GPIOIS_t*) (GPIOC_BASE + GPIO_IS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC IBE*/
#define GPIOC_IBE    ((GPIOIBE_t*) (GPIOC_BASE + GPIO_IBE_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC IEV*/
#define GPIOC_IEV    ((GPIOIEV_t*) (GPIOC_BASE + GPIO_IEV_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC IME*/
#define GPIOC_IM    ((GPIOIM_t*) (GPIOC_BASE + GPIO_IM_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC RIS*/
#define GPIOC_RIS    ((GPIORIS_t*) (GPIOC_BASE + GPIO_RIS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC MIS*/
#define GPIOC_MIS    ((GPIOMIS_t*) (GPIOC_BASE + GPIO_MIS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC IC*/
#define GPIOC_ICR    ((GPIOICR_t*) (GPIOC_BASE + GPIO_ICR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DRV2*/
#define GPIOC_DRR    ((GPIODRR_ARRAY_t*) (GPIOC_BASE + GPIO_DR2R_OFFSET))

/******************************************************************************************
 ************************************ 11 DR2R *********************************************
 ******************************************************************************************/
/* GPIOC DRV2*/
#define GPIOC_DR2R    ((GPIODR2R_t*) (GPIOC_BASE + GPIO_DR2R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DRV4*/
#define GPIOC_DR4R    ((GPIODR4R_t*) (GPIOC_BASE + GPIO_DR4R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DRV8*/
#define GPIOC_DR8R    ((GPIODR8R_t*) (GPIOC_BASE + GPIO_DR8R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC ODE*/
#define GPIOC_ODR    ((GPIOODR_t*) (GPIOC_BASE + GPIO_ODR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PUE*/
#define GPIOC_PUR    ((GPIOPUR_t*) (GPIOC_BASE + GPIO_PUR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PDE*/
#define GPIOC_PDR    ((GPIOPDR_t*) (GPIOC_BASE + GPIO_PDR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC SLR*/
#define GPIOC_SLR    ((GPIOSLR_t*) (GPIOC_BASE + GPIO_SLR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DEN*/
#define GPIOC_DEN    ((GPIODEN_t*) (GPIOC_BASE + GPIO_DEN_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC LOCK*/
#define GPIOC_LOCK    ((GPIOLOCK_t*) (GPIOC_BASE + GPIO_LOCK_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC CR*/
#define GPIOC_CR    ((GPIOCR_t*) (GPIOC_BASE + GPIO_CR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PCTL*/
#define GPIOC_PCTL    ((GPIOPCTL_t*) (GPIOC_BASE + GPIO_PCTL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DMACTL*/
#define GPIOC_DMACTL    ((GPIODMACTL_t*) (GPIOC_BASE + GPIO_DMACTL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC SI*/
#define GPIOC_SI    ((GPIOSI_t*) (GPIOC_BASE + GPIO_SI_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC DR12R*/
#define GPIOC_DR12R    ((GPIODR12R_t*) (GPIOC_BASE + GPIO_DR12R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC WAKEPEN*/
#define GPIOC_WAKEPEN    ((GPIOWAKEPEN_t*) (GPIOC_BASE + GPIO_WAKEPEN_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC WAKELVL*/
#define GPIOC_WAKELVL    ((GPIOWAKELVL_t*) (GPIOC_BASE + GPIO_WAKELVL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC WAKESTAT*/
#define GPIOC_WAKESTAT    ((GPIOWAKESTAT_t*) (GPIOC_BASE + GPIO_WAKESTAT_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PP*/
#define GPIOC_PP    ((GPIOPP_t*) (GPIOC_BASE + GPIO_PP_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PC*/
#define GPIOC_PC    ((GPIOPC_t*) (GPIOC_BASE + GPIO_PC_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID4*/
#define GPIOC_PeriphID4    ((GPIOPeriphID4_t*) (GPIOC_BASE + GPIO_PeriphID4_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID5*/
#define GPIOC_PeriphID5    ((GPIOPeriphID5_t*) (GPIOC_BASE + GPIO_PeriphID5_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID6*/
#define GPIOC_PeriphID6    ((GPIOPeriphID6_t*) (GPIOC_BASE + GPIO_PeriphID6_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID7*/
#define GPIOC_PeriphID7    ((GPIOPeriphID7_t*) (GPIOC_BASE + GPIO_PeriphID7_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID0*/
#define GPIOC_PeriphID0    ((GPIOPeriphID0_t*) (GPIOC_BASE + GPIO_PeriphID0_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID1*/
#define GPIOC_PeriphID1    ((GPIOPeriphID1_t*) (GPIOC_BASE + GPIO_PeriphID1_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID2*/
#define GPIOC_PeriphID2    ((GPIOPeriphID2_t*) (GPIOC_BASE + GPIO_PeriphID2_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC PID3*/
#define GPIOC_PeriphID3    ((GPIOPeriphID3_t*) (GPIOC_BASE + GPIO_PeriphID3_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC CID0*/
#define GPIOC_CellID0    ((GPIOCellID0_t*) (GPIOC_BASE + GPIO_CellID0_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC CID1*/
#define GPIOC_CellID1    ((GPIOCellID1_t*) (GPIOC_BASE + GPIO_CellID1_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC CID2*/
#define GPIOC_CellID2    ((GPIOCellID2_t*) (GPIOC_BASE + GPIO_CellID2_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOC CID3*/
#define GPIOC_CellID3    ((GPIOCellID3_t*) (GPIOC_BASE + GPIO_CellID3_OFFSET))
