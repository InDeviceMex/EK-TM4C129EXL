 ...
 ******************************************************************************************/
/* GPIOG DATA*/
#define GPIOG_DATA_MASK    ((GPIOGATA_MASK_t*) (GPIOG_BASE + GPIO_DATA_MASK_OFFSET))
...
#define GPIOG_DATA    ((GPIOGATA_t*) (GPIOG_BASE + GPIO_DATA_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DIR*/
#define GPIOG_DIR    ((GPIOGIR_t*) (GPIOG_BASE + GPIO_DIR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG IS*/
#define GPIOG_IS    ((GPIOIS_t*) (GPIOG_BASE + GPIO_IS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG IBE*/
#define GPIOG_IBE    ((GPIOIBE_t*) (GPIOG_BASE + GPIO_IBE_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG IEV*/
#define GPIOG_IEV    ((GPIOIEV_t*) (GPIOG_BASE + GPIO_IEV_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG IME*/
#define GPIOG_IM    ((GPIOIM_t*) (GPIOG_BASE + GPIO_IM_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG RIS*/
#define GPIOG_RIS    ((GPIORIS_t*) (GPIOG_BASE + GPIO_RIS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG MIS*/
#define GPIOG_MIS    ((GPIOMIS_t*) (GPIOG_BASE + GPIO_MIS_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG IC*/
#define GPIOG_ICR    ((GPIOICR_t*) (GPIOG_BASE + GPIO_ICR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG AFSEL*/
#define GPIOG_AFSEL    ((GPIOGFSEL_t*) (GPIOG_BASE + GPIO_AFSEL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DRV2*/
#define GPIOG_DRR    ((GPIOGRR_ARRAY_t*) (GPIOG_BASE + GPIO_DR2R_OFFSET))

/******************************************************************************************
 ************************************ 11 DR2R *********************************************
 ******************************************************************************************/
/* GPIOG DRV2*/
#define GPIOG_DR2R    ((GPIOGR2R_t*) (GPIOG_BASE + GPIO_DR2R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DRV4*/
#define GPIOG_DR4R    ((GPIOGR4R_t*) (GPIOG_BASE + GPIO_DR4R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DRV8*/
#define GPIOG_DR8R    ((GPIOGR8R_t*) (GPIOG_BASE + GPIO_DR8R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG ODE*/
#define GPIOG_ODR    ((GPIOODR_t*) (GPIOG_BASE + GPIO_ODR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PUE*/
#define GPIOG_PUR    ((GPIOPUR_t*) (GPIOG_BASE + GPIO_PUR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PDE*/
#define GPIOG_PDR    ((GPIOPDR_t*) (GPIOG_BASE + GPIO_PDR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG SLR*/
#define GPIOG_SLR    ((GPIOSLR_t*) (GPIOG_BASE + GPIO_SLR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DEN*/
#define GPIOG_DEN    ((GPIOGEN_t*) (GPIOG_BASE + GPIO_DEN_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG LOCK*/
#define GPIOG_LOCK    ((GPIOLOCK_t*) (GPIOG_BASE + GPIO_LOCK_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG CR*/
#define GPIOG_CR    ((GPIOGR_t*) (GPIOG_BASE + GPIO_CR_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG AMSEL*/
#define GPIOG_AMSEL    ((GPIOGMSEL_t*) (GPIOG_BASE + GPIO_AMSEL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PCTL*/
#define GPIOG_PCTL    ((GPIOPCTL_t*) (GPIOG_BASE + GPIO_PCTL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG ADCCTL*/
#define GPIOG_ADCCTL    ((GPIOGDCCTL_t*) (GPIOG_BASE + GPIO_ADCCTL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DMACTL*/
#define GPIOG_DMACTL    ((GPIOGMACTL_t*) (GPIOG_BASE + GPIO_DMACTL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG SI*/
#define GPIOG_SI    ((GPIOSI_t*) (GPIOG_BASE + GPIO_SI_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG DR12R*/
#define GPIOG_DR12R    ((GPIOGR12R_t*) (GPIOG_BASE + GPIO_DR12R_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG WAKEPEN*/
#define GPIOG_WAKEPEN    ((GPIOWAKEPEN_t*) (GPIOG_BASE + GPIO_WAKEPEN_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG WAKELVL*/
#define GPIOG_WAKELVL    ((GPIOWAKELVL_t*) (GPIOG_BASE + GPIO_WAKELVL_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG WAKESTAT*/
#define GPIOG_WAKESTAT    ((GPIOWAKESTAT_t*) (GPIOG_BASE + GPIO_WAKESTAT_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PP*/
#define GPIOG_PP    ((GPIOPP_t*) (GPIOG_BASE + GPIO_PP_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PC*/
#define GPIOG_PC    ((GPIOPC_t*) (GPIOG_BASE + GPIO_PC_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID4*/
#define GPIOG_PeriphID4    ((GPIOPeriphID4_t*) (GPIOG_BASE + GPIO_PeriphID4_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID5*/
#define GPIOG_PeriphID5    ((GPIOPeriphID5_t*) (GPIOG_BASE + GPIO_PeriphID5_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID6*/
#define GPIOG_PeriphID6    ((GPIOPeriphID6_t*) (GPIOG_BASE + GPIO_PeriphID6_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID7*/
#define GPIOG_PeriphID7    ((GPIOPeriphID7_t*) (GPIOG_BASE + GPIO_PeriphID7_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID0*/
#define GPIOG_PeriphID0    ((GPIOPeriphID0_t*) (GPIOG_BASE + GPIO_PeriphID0_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID1*/
#define GPIOG_PeriphID1    ((GPIOPeriphID1_t*) (GPIOG_BASE + GPIO_PeriphID1_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID2*/
#define GPIOG_PeriphID2    ((GPIOPeriphID2_t*) (GPIOG_BASE + GPIO_PeriphID2_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG PID3*/
#define GPIOG_PeriphID3    ((GPIOPeriphID3_t*) (GPIOG_BASE + GPIO_PeriphID3_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG CID0*/
#define GPIOG_CellID0    ((GPIOGellID0_t*) (GPIOG_BASE + GPIO_CellID0_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG CID1*/
#define GPIOG_CellID1    ((GPIOGellID1_t*) (GPIOG_BASE + GPIO_CellID1_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG CID2*/
#define GPIOG_CellID2    ((GPIOGellID2_t*) (GPIOG_BASE + GPIO_CellID2_OFFSET))
 ...
 ******************************************************************************************/
/* GPIOG CID3*/
#define GPIOG_CellID3    ((GPIOGellID3_t*) (GPIOG_BASE + GPIO_CellID3_OFFSET))
