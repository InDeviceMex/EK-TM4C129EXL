/**
 *
 * @file GPIO_RegisterDefines_ICR.h
 * @copyright
...
#ifndef XDRIVER_MCU_DRIVER_HEADER_GPIO_GPIO_PERIPHERAL_GPIO_REGISTER_GPIO_REGISTERDEFINES_GPIO_REGISTERDEFINES_ICR_H_
#define XDRIVER_MCU_DRIVER_HEADER_GPIO_GPIO_PERIPHERAL_GPIO_REGISTER_GPIO_REGISTERDEFINES_GPIO_REGISTERDEFINES_ICR_H_
...
/*----------*/
#define GPIO_ICR_R_DMAIC_MASK    ((uint32_t) 0x00000100UL)
#define GPIO_ICR_R_DMAIC_BIT    (8UL)
#define GPIO_ICR_R_DMAIC_NOEFFECT    ((uint32_t) 0x00000000UL)
#define GPIO_ICR_R_DMAIC_CLEAR    ((uint32_t) 0x00000100UL)

#define GPIO_ICR_DMAIC_MASK    ((uint32_t) 0x00000001UL)
#define GPIO_ICR_DMAIC_NOEFFECT    ((uint32_t) 0x00000000UL)
#define GPIO_ICR_DMAIC_CLEAR    ((uint32_t) 0x00000001UL)
/*----------*/

#endif /* XDRIVER_MCU_DRIVER_HEADER_GPIO_GPIO_PERIPHERAL_GPIO_REGISTER_GPIO_REGISTERDEFINES_GPIO_REGISTERDEFINES_ICR_H_ */
