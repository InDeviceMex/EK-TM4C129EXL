...
#define GPIO_DATA_PINMASK0_OFFSET    ((uint32_t) 0x004UL)
#define GPIO_DATA_PINMASK1_OFFSET    ((uint32_t) 0x008UL)
#define GPIO_DATA_PINMASK2_OFFSET    ((uint32_t) 0x010UL)
#define GPIO_DATA_PINMASK3_OFFSET    ((uint32_t) 0x020UL)
#define GPIO_DATA_PINMASK4_OFFSET    ((uint32_t) 0x040UL)
#define GPIO_DATA_PINMASK5_OFFSET    ((uint32_t) 0x080UL)
#define GPIO_DATA_PINMASK6_OFFSET    ((uint32_t) 0x100UL)
#define GPIO_DATA_PINMASK7_OFFSET    ((uint32_t) 0x200UL)
