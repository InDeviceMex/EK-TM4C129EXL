...
typedef enum
{
    ...
    GPIO_enPINMASK_UNDEF = 0x7FFFFFFFUL,
} GPIO_nPINMASK;
...
typedef enum
{
    ...
    GPIO_enSENSE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nSENSE;
...
typedef enum
{
    ...
    GPIO_enINTTYPE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nINTTYPE;
...
typedef enum
{
    ...
    GPIO_enEDGE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nEDGE;
...
typedef enum
{
    ...
    GPIO_enLEVEL_UNDEF = 0x7FFFFFFFUL,
} GPIO_nLEVEL;
...
typedef enum
{
    ...
    GPIO_enWAKE_STATUS_UNDEF = 0x7FFFFFFFUL,
} GPIO_nWAKE_STATUS;
...
typedef enum
{
    ...
    GPIO_enNORMAL_DRIVE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nNORMAL_DRIVE;
...
typedef enum
{
    ...
    GPIO_enDRIVE_MODE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nDRIVE_MODE;
...
{                         /*ModeDriver(2bit)            SlewRate(1bit)                  ExtendedDrive(1bit)                NormalDrive(3bits)*/
    ...
    GPIO_enDRIVE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nDRIVE;
...
typedef enum
{
    ...
    GPIO_enFUNCTION_UNDEF = 0x7FFFFFFFUL,
} GPIO_nFUNCTION;
...
typedef enum
{
    ...
    GPIO_enLOCK_UNDEF = 0x7FFFFFFFUL,
} GPIO_nLOCK;
...
typedef enum
{
    ...
    GPIO_enDRIVE_CAPABILITY_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    GPIO_enOUTMODE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nOUTMODE;
typedef enum
{
    ...
    GPIO_enRESMODE_UNDEF = 0x7FFFFFFFUL,
} GPIO_nRESMODE;
...
typedef enum
{
    ...
    GPIO_enGPIO_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    GPIO_enCONFIG_OUTPUT_12MA_SLR_OPENDRAIN_PULLDOWN = ((uint32_t) GPIO_enDRIVE_12mA_SLR << 16UL)
            ...
            | ((uint32_t) GPIO_enOUTMODE_OPENDRAIN << 4UL)
            | ((uint32_t) GPIO_enRESMODE_PULLDOWN << 0UL),
    GPIO_enCONFIG_UNDEF = 0x7FFFFFFFUL,
} GPIO_nCONFIG;
...
typedef enum
{
    ...
    GPIO_enINT_CONFIG_UNDEF = 0x7FFFFFFFUL,
} GPIO_nINT_CONFIG;
