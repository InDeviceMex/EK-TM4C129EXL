...
typedef volatile struct
{
        ...
        union
        {
                volatile UBase_t IBE;
                GPIO_IBE_t IBE_Bit;
        };
        union
        {
                volatile UBase_t IEV;
                GPIO_IEV_t IEV_Bit;
        };
        union
        {
        ...
        union
        {
                volatile UBase_t AFSEL;
                GPIO_AFSEL_t AFSEL_Bit;
        };
        const UBase_t reserved [55UL];
        union
        {
                volatile UBase_t DR2R;
                GPIO_DR2R_t DR2R_Bit;
        };
        union
        {
                volatile UBase_t DR4R;
                GPIO_DR4R_t DR4R_Bit;
        };
        union
        {
                volatile UBase_t DR8R;
                GPIO_DR8R_t DR8R_Bit;
        };
        union
        {
                volatile UBase_t ODR;
                GPIO_ODR_t ODR_Bit;
        };
        union
        {
                volatile UBase_t PUR;
                GPI0_PUR_t PUR_Bit;
        };
        union
        {
                volatile UBase_t PDR;
                GPIO_PDR_t PDR_Bit;
        };
        union
        {
                volatile UBase_t SLR;
                GPIO_SLR_t SLR_Bit;
        };
        union
        {
                volatile UBase_t DEN;
                GPIO_DEN_t DEN_Bit;
        };
        union
        {
        ...
        union
        {
                volatile UBase_t AMSEL;
                GPIO_AMSEL_t AMSEL_Bit;
        };
        union
        {
                volatile UBase_t PCTL;
                GPIO_PCTL_t PCTL_Bit;
        };
        union
        {
                volatile UBase_t ADCCTL;
        ...
        union
        {
                volatile UBase_t DR12R;
                GPIO_DR12R_t DR12R_Bit;
        };
        union
        {
                volatile UBase_t WAKEPEN;
                GPIO_WAKEPEN_t WAKEPEN_Bit;
        };
        union
        {
                volatile UBase_t WAKELVL;
                GPIO_WAKELVL_t WAKELVL_Bit;
        };
        union
        {
                volatile UBase_t WAKESTAT;
                GPIO_WAKESTAT_t WAKESTAT_Bit;
        };
        const UBase_t reserved1 [669UL];
        union
        {
                volatile UBase_t PP;
                GPIO_PP_t PP_Bit;
...
typedef volatile struct
{
        GPIO_t PORT [(UBase_t) GPIO_enPORT_MAX];
} GPIO_PORT_t;

typedef volatile struct
{
        GPIO_AUX_t PORT [(UBase_t) GPIO_enPORT_MAX];
} GPIO_PORT_AUX_t;
