...
GPIO_nERROR GPIO__enSetInterruptSourceStateByMask(GPIO_nPORT enPortArg, GPIO_nPINMASK enPinMaskArg, GPIO_nSTATE enStateArg)
{
    ...
    {
        UBase_t uxValueReg = (GPIO_enSTATE_DIS == enStateArg) ? 0U : (UBase_t) enPinMaskArg;
...
{
    GPIO_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penPinGetArg) ? GPIO_enERROR_POINTER : GPIO_enERROR_OK;
...
{
    GPIO_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penPinStatusArg) ? GPIO_enERROR_POINTER : GPIO_enERROR_OK;
...
{
    GPIO_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penStatusArg) ? GPIO_enERROR_POINTER : GPIO_enERROR_OK;
