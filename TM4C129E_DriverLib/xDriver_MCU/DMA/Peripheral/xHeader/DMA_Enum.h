...
typedef enum
{
    ...
    DMA_enSTATE_MACHINE_UNDEF = 0x7FFFFFFFUL,
}DMA_nSTATE_MACHINE;
...
typedef enum
{
    ...
    DMA_enCH_WAITREQ_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_WAITREQ;
...
typedef enum
{
    ...
    DMA_enCH_PERIPHERAL_UNDEF = 0x7FFFFFFFUL,
} DMA_nCH_PERIPHERAL;
...
typedef enum
{
    ...
    DMA_enCH_REQTYPE_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_REQTYPE;
...
typedef enum
{
    ...
    DMA_enCH_CONTROL_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_CONTROL;
...
typedef enum
{
    ...
    DMA_enCH_ACCESS_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_ACCESS;
...
typedef enum
{
    ...
    DMA_enCH_PRIORITY_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_PRIORITY;
...
typedef enum
{
    ...
    DMA_enCH_ENCODER_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_ENCODER;
...
typedef enum
{
    ...
    DMA_enCH_INCREMENT_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_INCREMENT;
...
typedef enum
{
    ...
    DMA_enCH_DATA_SIZE_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_DATA_SIZE;
...
typedef enum
{
    ...
    DMA_enCH_ARBITRATION_SIZE_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    DMA_enCH_MODE_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_MODE;
...
typedef enum
{
    ...
    DMA_enCH_TRIGGER_UNDEF = 0x7FFFFFFFUL,
}DMA_nCH_TRIGGER;
