                                          ...
                                          DMA_nCH_PRIORITY enPriorityArg)
{
    ...
    stRegister.uptrAddress = (DMA_enCH_PRIORITY_LOW == enPriorityArg) ? DMA_CH_PRIOCLR_OFFSET : DMA_CH_PRIOSET_OFFSET;
...
{
    DMA_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penPriorityArg) ? DMA_enERROR_POINTER : DMA_enERROR_OK;
