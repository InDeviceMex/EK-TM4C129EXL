...
{
    DMA_CH__vSetPrimaryControlGeneric(enChannel, (uint32_t) enChannelSourceIncrement,
                          DMACH_CHCTL_SRCINC_MASK, DMACH_CHCTL_R_SRCINC_BIT);
}

void DMA_CH__vSetAlternateSourceIncrement(DMA_nCH_MODULE enChannel,
                                          DMA_nCH_SRC_INC enChannelSourceIncrement)
{
    DMA_CH__vSetAlternateControlGeneric(enChannel, (uint32_t) enChannelSourceIncrement,
                        DMAALTCH_CHCTL_SRCINC_MASK, DMAALTCH_CHCTL_R_SRCINC_BIT);
}
                                 ...
                                 DMA_nCH_SRC_INC enChannelSourceIncrement)
{
    DMA_CH__vSetControlGeneric(enChannel, enChannelStructure,
                               (uint32_t) enChannelSourceIncrement,
                               DMACH_CHCTL_SRCINC_MASK, DMACH_CHCTL_R_SRCINC_BIT);
}
...
DMA_nCH_SRC_INC DMA_CH__enGetPrimarySourceIncrement(DMA_nCH_MODULE enChannel)
{
    ...
    enReg = (DMA_nCH_SRC_INC) DMA_CH__u32GetPrimaryControlGeneric(enChannel,
                          DMACH_CHCTL_SRCINC_MASK, DMACH_CHCTL_R_SRCINC_BIT);
    return (enReg);
}
...
{
    DMA_nCH_SRC_INC enReg = DMA_enCH_SRC_INC_BYTE;
    enReg = (DMA_nCH_SRC_INC) DMA_CH__u32GetAlternateControlGeneric(enChannel,
                            DMAALTCH_CHCTL_SRCINC_MASK, DMAALTCH_CHCTL_R_SRCINC_BIT);
    return (enReg);
}
...
{
    DMA_nCH_SRC_INC enReg = DMA_enCH_SRC_INC_BYTE;
    enReg = (DMA_nCH_SRC_INC) DMA_CH__u32GetControlGeneric(enChannel, enChannelStructure,
                                   DMACH_CHCTL_SRCINC_MASK, DMACH_CHCTL_R_SRCINC_BIT);
    return (enReg);
}
