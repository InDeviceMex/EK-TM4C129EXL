                                              ...
                                              DMA_nCH_CONTROL enControlArg, DMA_nCH_ACCESS enAccessArg)
{
    ...
    while((0U != uxChannelMaskReg) && (DMA_enERROR_OK == enErrorReg))
    {
        ...
        {
            enErrorReg = DMA_CH__enSetDestinationDataAccessByNumber(enModuleArg,  (DMA_nCH) uxChannelReg, enControlArg, enAccessArg);
        }
        uxChannelReg++;
        uxChannelMaskReg >>= 1U;
    }
                                                  ...
                                                  DMA_nCH_CONTROL enControlArg, DMA_nCH_ACCESS enAccessArg)
{
    ...
    stRegister.uxShift = DMA_CH_CTL_R_DSTPROT0_BIT;
    stRegister.uxMask = DMA_CH_CTL_DSTPROT0_MASK;
...
{
    DMA_nERROR enErrorReg;
    enErrorReg = (0UL == (uintptr_t) penAccessArg) ? DMA_enERROR_POINTER : DMA_enERROR_OK;
