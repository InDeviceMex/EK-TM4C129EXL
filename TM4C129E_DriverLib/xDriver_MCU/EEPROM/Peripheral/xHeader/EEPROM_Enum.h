...
typedef enum
{
    EEPROM_enINTERRUPT_SW = 0UL,
    EEPROM_enINTERRUPT_ERASE = 1UL,
    EEPROM_enINTERRUPT_COPY = 2UL,
    EEPROM_enINTERRUPT_NOPERMISSION = 3UL,
    EEPROM_enINTERRUPT_WRITE = 4UL,
    EEPROM_enINTERRUPT_MAX = 5UL,
}EEPROM_nINTERRUPT;
...
typedef enum
{
    EEPROM_enINT_STATUS_NOOCCUR = 0UL,
    EEPROM_enINT_STATUS_OCCUR = 1UL,
