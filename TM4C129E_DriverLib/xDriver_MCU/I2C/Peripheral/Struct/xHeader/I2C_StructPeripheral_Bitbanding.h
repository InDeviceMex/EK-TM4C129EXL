...
typedef volatile struct
{
    ...
    union
    {
        volatile const UBase_t PC [32UL];
        I2C_BITBANDING_PC_t PC_Bit;
    };
    const UBase_t reserved6 [14UL * 32UL];
} I2C_BITBANDING_t;
...
typedef volatile struct
{
    union
    {
        volatile UBase_t SA [32UL];
        I2C_MASTER_BITBANDING_SA_t SA_Bit;
    };
    union
    {
        volatile UBase_t STS [32UL];
        volatile UBase_t CTS [32UL];
    ...
    union
    {
        volatile const UBase_t TPR [32UL];
...
typedef volatile struct
{
    ...
    union
    {
        volatile UBase_t OAR2 [32UL];
        I2C_SLAVE_BITBANDING_OAR2_t OAR2_Bit;
    };
    union
    {
        volatile UBase_t ACKCTL [32UL];
...
typedef volatile struct
{
    ...
    union
    {
        volatile const UBase_t CTL [32UL];
        I2C_FIFO_BITBANDING_CTL_t CTL_Bit;
    };
    union
    {
        volatile const UBase_t STS [32UL];
...
typedef volatile struct
{
    union
    {
        I2C_BITBANDING_t MODULE0_3 [(UBase_t) 4UL];
        I2CS_UNION_BITBANDING_t MODULE_UNION0_3 [(UBase_t) 4UL];
    };
    I2C_BITBANDING_t reserved[148UL];
    union
    {
        I2C_BITBANDING_t MODULE8_9 [(UBase_t) 2UL];
        I2CS_UNION_BITBANDING_t MODULE_UNION8_9 [(UBase_t) 2UL];
    };
    I2C_BITBANDING_t reserved2[7UL];
    union
    {
        I2C_BITBANDING_t MODULE4_7 [(UBase_t) 4UL];
        I2CS_UNION_BITBANDING_t MODULE_UNION4_7 [(UBase_t) 4UL];
    };
} I2CS_BITBANDING_t;
