...
typedef volatile struct
{
    ...
    union
    {
        volatile uint32_t CLKOCNT;
        I2C_MASTER_CLKOCNT_t CLKOCNT_Bit;
    };
    const uint32_t reserved [1UL];
    union
    {
        volatile uint32_t BMON;
