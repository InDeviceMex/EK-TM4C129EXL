...
typedef enum
{
    ...
    I2C_enSTATUS_UNDEF = 0x7FFFFFFFUL,/*!< I2C_enSTATUS_UNDEF */
}I2C_nSTATUS;
...
typedef enum
{
    ...
    I2C_enDEFAULT = 0x7FFFFFFFUL,/*!< I2C_enDEFAULT */
}I2C_nPRIORITY;
...
typedef enum
{
    I2C_enINT_STATUS_INACTIVE = 0UL,              /*!< I2C_enINT_STATUS_INACTIVE */
    I2C_enINT_STATUS_ACTIVE = 1UL,                /*!< I2C_enINT_STATUS_ACTIVE */
    I2C_enINT_STATUS_UNDEF = 0x7FFFFFFFUL,/*!< I2C_enINT_STATUS_UNDEF */
} I2C_nINT_STATUS;
...
typedef enum
{
    ...
    I2C_enMASTER_BUSY_UNDEF = 0x7FFFFFFFUL,/*!< I2C_enMASTER_BUSY_UNDEF */
}I2C_nMASTER_BUSY;

typedef enum
{
    I2C_enMASTER_ERROR_NO = 0UL,
    I2C_enMASTER_ERROR_ACTIVE = 1UL,
    I2C_enMASTER_ERROR_UNDEF = 0x7FFFFFFFUL,
}I2C_nMASTER_ERROR;

typedef enum
{
    I2C_enMASTER_ACK_ADDR_NO = 0UL,
    I2C_enMASTER_ACK_ADDR_ACTIVE = 1UL,
    I2C_enMASTER_ACK_ADDR_UNDEF = 0x7FFFFFFFUL,
}I2C_nMASTER_ACK_ADDR;

typedef enum
{
    I2C_enMASTER_ACK_DATA_NO = 0UL,
    I2C_enMASTER_ACK_DATA_ACTIVE = 1UL,
    I2C_enMASTER_ACK_DATA_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enMASTER_ARB_UNDEF = 0x7FFFFFFFUL,
}I2C_nMASTER_ARB;
...
typedef enum
{
    ...
    I2C_enMASTER_IDLE_UNDEF = 0x7FFFFFFFUL,
}I2C_nMASTER_IDLE;
...
typedef enum
{
    ...
    I2C_enMASTER_BUS_BSY_UNDEF = 0x7FFFFFFFUL,
}I2C_nMASTER_BUS_BSY;

typedef enum
{
    I2C_enMASTER_CLOCK_TIMEOUT_NO = 0UL,
    I2C_enMASTER_CLOCK_TIMEOUT_ACTIVE = 1UL,
    I2C_enMASTER_CLOCK_TIMEOUT_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enMASTER_DMA_ACTIVE_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enMASTER_HIGHSPEED_CAPABLE_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enMASTER_HIGHSPEED_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enMASTER_GLITCH_CLOCK_UNDEF = 0x7FFFFFFFUL,
...
typedef enum
{
    ...
    I2C_enLINE_STATE_UNDEF = 0x7FFFFFFFUL,
} I2C_nLINE_STATE;
...
typedef enum
{
    ...
    I2C_enMULTIMASTER_UNDEF = 0x7FFFFFFFUL,
} I2C_nMULTIMASTER;
...
typedef enum
{
    ...
    I2C_enSTOPCONDITION_UNDEF = 0x7FFFFFFFUL,
} I2C_nSTOPCONDITION;
...
typedef enum
{
    ...
    I2C_enALT_ADDRESS_UNDEF = 0x7FFFFFFFUL,
} I2C_nALT_ADDRESS;
...
typedef enum
{
    ...
    I2C_enACK_ENABLE_UNDEF = 0x7FFFFFFFUL,
} I2C_nACK_ENABLE;
...
typedef enum
{
    ...
    I2C_enDMA_ENABLE_UNDEF = 0x7FFFFFFFUL,
} I2C_nDMA_ENABLE;
...
typedef enum
{
    ...
    I2C_enSLAVE_ENABLE_UNDEF = 0x7FFFFFFFUL,
} I2C_nSLAVE_ENABLE;
...
typedef enum
{
    ...
    I2C_enSLAVE_REQUEST_UNDEF = 0x7FFFFFFFUL,
} I2C_nSLAVE_REQUEST;
...
typedef enum
{
    ...
    I2C_enSLAVE_REQUEST_STATUS_UNDEF = 0x7FFFFFFFUL,
