...
#define SSI1_PCellID0_R    (*((volatile const uint32_t*) (SSI1_BASE + SSI_PCellID0_OFFSET)))
...
#define SSI1_PCellID1_R    (*((volatile const uint32_t*) (SSI1_BASE + SSI_PCellID1_OFFSET)))
...
#define SSI1_PCellID2_R    (*((volatile const uint32_t*) (SSI1_BASE + SSI_PCellID2_OFFSET)))
...
#define SSI1_PCellID3_R    (*((volatile const uint32_t*) (SSI1_BASE + SSI_PCellID3_OFFSET)))
