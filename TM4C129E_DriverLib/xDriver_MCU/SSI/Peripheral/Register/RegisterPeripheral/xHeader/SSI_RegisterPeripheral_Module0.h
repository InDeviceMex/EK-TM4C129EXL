...
#define SSI0_PCellID0_R    (*((volatile const uint32_t*) (SSI0_BASE + SSI_PCellID0_OFFSET)))
...
#define SSI0_PCellID1_R    (*((volatile const uint32_t*) (SSI0_BASE + SSI_PCellID1_OFFSET)))
...
#define SSI0_PCellID2_R    (*((volatile const uint32_t*) (SSI0_BASE + SSI_PCellID2_OFFSET)))
...
#define SSI0_PCellID3_R    (*((volatile const uint32_t*) (SSI0_BASE + SSI_PCellID3_OFFSET)))
