...
************************************ SSI1 *********************************************
******************************************************************************************/
#define SSI1_BITBANDING    ((SSI_BITBANDING_TypeDef*) (SSI_BITBANDING_BASE + (SSI1_OFFSET * 32U)))

/******************************************************************************************
*********************************** * 1 CR0 *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_CR0    ((BITBANDING_SSICR0_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CR0_OFFSET) * 32U)))
...
*********************************** * 2 CR1 *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_CR1    ((BITBANDING_SSICR1_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CR1_OFFSET) * 32U)))
...
*********************************** * 3 DR *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_DR    ((BITBANDING_SSIDR_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_DR_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 4 SR *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_SR    ((BITBANDING_SSISR_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_SR_OFFSET) * 32U)))
...
*********************************** * 5 CPSR *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_CPSR    ((BITBANDING_SSICPSR_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CPSR_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 6 IM *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_IM    ((BITBANDING_SSIIM_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_IM_OFFSET) * 32U)))
...
*********************************** * 7 RIS *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_RIS    ((BITBANDING_SSIRIS_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_RIS_OFFSET) * 32U)))
...
*********************************** * 8 MIS *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_MIS    ((BITBANDING_SSIMIS_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_MIS_OFFSET) * 32U)))
...
*********************************** * 9 ICR *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_ICR    ((BITBANDING_SSIICR_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_ICR_OFFSET) * 32U)))
...
*********************************** * 10 DMACTL *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_DMACTL    ((BITBANDING_SSIDMACTL_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_DMACTL_OFFSET) * 32U)))
...
*********************************** * 11 PP *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_PP    ((BITBANDING_SSIPP_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PP_OFFSET) * 32U)))
...
*********************************** * 11 CC *********************************************
******************************************************************************************/
#define SSI1_BITBANDING_CC    ((BITBANDING_SSICC_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CC_OFFSET) * 32U)))
 ...
 ******************************************************************************************/
/* SSI1 APB PID4*/
#define SSI1_BITBANDING_PeriphID4    ((BITBANDING_SSIPeriphID4_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID4_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 20 PeriphID5 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID5*/
#define SSI1_BITBANDING_PeriphID5    ((BITBANDING_SSIPeriphID5_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID5_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 21 PeriphID6 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID6*/
#define SSI1_BITBANDING_PeriphID6    ((BITBANDING_SSIPeriphID6_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID6_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 22 PeriphID7 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID7*/
#define SSI1_BITBANDING_PeriphID7    ((BITBANDING_SSIPeriphID7_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID7_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 23 PeriphID0 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID0*/
#define SSI1_BITBANDING_PeriphID0    ((BITBANDING_SSIPeriphID0_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID0_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 24 PeriphID1 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID1*/
#define SSI1_BITBANDING_PeriphID1    ((BITBANDING_SSIPeriphID1_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID1_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 25 PeriphID2 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID2*/
#define SSI1_BITBANDING_PeriphID2    ((BITBANDING_SSIPeriphID2_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID2_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 26 PeriphID3 *********************************************
 ******************************************************************************************/
/* SSI1 APB PID3*/
#define SSI1_BITBANDING_PeriphID3    ((BITBANDING_SSIPeriphID3_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_PeriphID3_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 27 CellID0 *********************************************
 ******************************************************************************************/
/* SSI1 APB CID0*/
#define SSI1_BITBANDING_CellID0    ((BITBANDING_SSICellID0_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CellID0_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 28 CellID1 *********************************************
 ******************************************************************************************/
/* SSI1 APB CID1*/
#define SSI1_BITBANDING_CellID1    ((BITBANDING_SSICellID1_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CellID1_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 29 CellID2 *********************************************
 ******************************************************************************************/
/* SSI1 APB CID2*/
#define SSI1_BITBANDING_CellID2    ((BITBANDING_SSICellID2_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CellID2_OFFSET) * 32U)))

/******************************************************************************************
 *********************************** * 30 CellID3 *********************************************
 ******************************************************************************************/
/* SSI1 APB CID3*/
#define SSI1_BITBANDING_CellID3    ((BITBANDING_SSICellID3_TypeDef*) (SSI_BITBANDING_BASE + ((SSI1_OFFSET + SSI_CellID3_OFFSET) * 32U)))
