...
SSI_nDMA SSI__enGetDMARx(SSI_nMODULE enModule)
{
    ...
    enDMAEnableReg = (SSI_nDMA) SSI__u32ReadRegister(enModule, SSI_DMACTL_OFFSET, SSI_DMACTL_RXDMAE_MASK, SSI_DMACTL_R_RXDMAE_BIT);
...
{
    SSI_nDMA enDMAEnableReg = SSI_enDMA_DIS;
    enDMAEnableReg = (SSI_nDMA) SSI__u32ReadRegister(enModule, SSI_DMACTL_OFFSET, SSI_DMACTL_TXDMAE_MASK, SSI_DMACTL_R_TXDMAE_BIT);
    return (enDMAEnableReg);
}
