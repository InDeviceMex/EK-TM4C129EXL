...
#define SYSEXC_MIS_R_FPIDCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPIDCMIS_ACTIVE    ((uint32_t) 0x00000001UL)

#define SYSEXC_MIS_FPIDCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPIDCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPIDCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/

/*----------*/
#define SYSEXC_MIS_R_FPDZCMIS_MASK    ((uint32_t) 0x00000002UL)
#define SYSEXC_MIS_R_FPDZCMIS_BIT    (1UL)
#define SYSEXC_MIS_R_FPDZCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPDZCMIS_ACTIVE    ((uint32_t) 0x00000002UL)

#define SYSEXC_MIS_FPDZCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPDZCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPDZCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/

/*----------*/
#define SYSEXC_MIS_R_FPIOCMIS_MASK    ((uint32_t) 0x00000004UL)
#define SYSEXC_MIS_R_FPIOCMIS_BIT    (2UL)
#define SYSEXC_MIS_R_FPIOCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPIOCMIS_ACTIVE    ((uint32_t) 0x00000004UL)

#define SYSEXC_MIS_FPIOCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPIOCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPIOCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/

/*----------*/
#define SYSEXC_MIS_R_FPUFCMIS_MASK    ((uint32_t) 0x00000008UL)
#define SYSEXC_MIS_R_FPUFCMIS_BIT    (3UL)
#define SYSEXC_MIS_R_FPUFCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPUFCMIS_ACTIVE    ((uint32_t) 0x00000008UL)

#define SYSEXC_MIS_FPUFCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPUFCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPUFCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/

/*----------*/
#define SYSEXC_MIS_R_FPOFCMIS_MASK    ((uint32_t) 0x00000010UL)
#define SYSEXC_MIS_R_FPOFCMIS_BIT    (4UL)
#define SYSEXC_MIS_R_FPOFCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPOFCMIS_ACTIVE    ((uint32_t) 0x00000010UL)

#define SYSEXC_MIS_FPOFCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPOFCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPOFCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/

/*----------*/
#define SYSEXC_MIS_R_FPIXCMIS_MASK    ((uint32_t) 0x00000020UL)
#define SYSEXC_MIS_R_FPIXCMIS_BIT    (5UL)
#define SYSEXC_MIS_R_FPIXCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_R_FPIXCMIS_ACTIVE    ((uint32_t) 0x00000010UL)

#define SYSEXC_MIS_FPIXCMIS_MASK    ((uint32_t) 0x00000001UL)
#define SYSEXC_MIS_FPIXCMIS_INACTIVE    ((uint32_t) 0x00000000UL)
#define SYSEXC_MIS_FPIXCMIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/
