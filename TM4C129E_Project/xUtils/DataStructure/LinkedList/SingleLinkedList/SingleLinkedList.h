 ...
 */
#ifndef XUTILS_DATASTRUCTURE_SINGLELINKEDLIST_SLINKEDLIST_H_
#define XUTILS_DATASTRUCTURE_SINGLELINKEDLIST_SLINKEDLIST_H_
...
#endif /* XUTILS_DATASTRUCTURE_SINGLELINKEDLIST_SLINKEDLIST_H_ */
