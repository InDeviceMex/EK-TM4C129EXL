 ...
 */
#ifndef XUTILS_DATASTRUCTURE_DOUBLELINKEDLIST_DLINKEDLIST_H_
#define XUTILS_DATASTRUCTURE_DOUBLELINKEDLIST_DLINKEDLIST_H_
...
#endif /* XUTILS_DATASTRUCTURE_DOUBLELINKEDLIST_DLINKEDLIST_H_ */
