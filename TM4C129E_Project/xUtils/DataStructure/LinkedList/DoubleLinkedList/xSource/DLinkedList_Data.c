...
void* DLinkedList__pvGetDataTail(const DLinkedList_TypeDef* pstList)
{
    DLinkedListItem_TypeDef* pstItem = (DLinkedListItem_TypeDef*) 0UL;
    void* pvItemData = (void*) 0UL;
    if((uint32_t) 0UL != (uint32_t) pstList)
    {
        pstItem = DLinkedList__pstGetTailItem(pstList);
        if((uint32_t) 0UL != (uint32_t) pstItem)
        {
            pvItemData = DLinkedList_Item__pvGetData(pstItem);
        }
...
void* DLinkedList__pvGetDataHead(const DLinkedList_TypeDef* pstList)
{
    DLinkedListItem_TypeDef* pstItem = (DLinkedListItem_TypeDef*) 0UL;
    void* pvItemData = (void*) 0UL;
    if((uint32_t) 0UL != (uint32_t) pstList)
    {
        pstItem = DLinkedList__pstGetHeadItem(pstList);
        if((uint32_t) 0UL != (uint32_t) pstItem)
        {
            pvItemData = DLinkedList_Item__pvGetData(pstItem);
        }
...
uint32_t DLinkedList__u32GetValueTail(const DLinkedList_TypeDef* pstList)
{
    DLinkedListItem_TypeDef* pstItem = (DLinkedListItem_TypeDef*) 0UL;
    uint32_t u32ItemValue = (uint32_t) 0UL;
    if((uint32_t) 0UL != (uint32_t) pstList)
...
uint32_t DLinkedList__u32GetValueHead(const DLinkedList_TypeDef* pstList)
{
    DLinkedListItem_TypeDef* pstItem = (DLinkedListItem_TypeDef*) 0UL;
    uint32_t u32ItemValue = (uint32_t) 0UL;
    if((uint32_t) 0UL != (uint32_t) pstList)
