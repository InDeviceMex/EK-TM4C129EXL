...
typedef struct
{
    ...
    OS_ListItem_TypeDef stGenericListItem;   /*< The list that the state list item of a task is reference from denotes the state of that task (Ready, Blocked, Suspended ). */
    OS_ListItem_TypeDef stEventListItem;     /*< Used to reference a task from an event list. */
