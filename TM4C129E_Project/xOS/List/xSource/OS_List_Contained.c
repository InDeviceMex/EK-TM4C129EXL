...
void* OS_List__pvItemContainer(const OS_ListItem_TypeDef* const pstListItemArg)
{
...
OS_Boolean_t OS_List__boIsContainedWithin(const OS_List_TypeDef* const pstListArg ,
                                          const OS_ListItem_TypeDef* const pstListItemArg)
{
