...
typedef void* OS_Queue_Handle_TypeDef;
typedef void* OS_Queue_SetHandle_TypeDef;
typedef void* OS_Queue_SetMemberHandle_TypeDef;
...
typedef struct OS_Queue_Definition
{
    ...
    OS_List_TypeDef stTasksWaitingToSend;     /*< List of tasks that are blocked waiting to post onto this queue.  Stored in priority order. */
    OS_List_TypeDef stTasksWaitingToReceive;  /*< List of tasks that are blocked waiting to read from this queue.  Stored in priority order. */
