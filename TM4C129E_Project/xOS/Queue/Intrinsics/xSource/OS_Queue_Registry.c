...
typedef struct QUEUE_REGISTRY_ITEM
{
    ...
    OS_Queue_Handle_TypeDef pvHandle;
}OS_Queue_RegistryItem_TypeDef;

static OS_Queue_RegistryItem_TypeDef OS_Queue_pstRegistry[OS_QUEUE_REGISTRY_SIZE];
...
{
    OS_UBase_t uxCountRegistry = 0UL;
    OS_Queue_Handle_TypeDef pvHandlePointer = (OS_Queue_Handle_TypeDef) 0UL;
