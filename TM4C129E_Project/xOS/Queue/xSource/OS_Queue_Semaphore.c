...
OS_Queue_Handle_TypeDef OS_Queue__pvCreateCountingSemaphore(const OS_UBase_t uxMaxCount,
                                                            const OS_UBase_t uxInitialCount)
{
    OS_Queue_Handle_TypeDef pvHandle = (OS_Queue_Handle_TypeDef) 0UL;
    OS_Queue_TypeDef* pstHandle = (OS_Queue_TypeDef*) 0UL;
    ...
    if(0UL != uxMaxCount)
    {
        if(uxInitialCount <= uxMaxCount)
        {
            ...
            {
                pstHandle = (OS_Queue_TypeDef*) pvHandle;
