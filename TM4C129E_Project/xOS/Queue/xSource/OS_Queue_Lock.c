...
void OS_Queue__vUnlock(OS_Queue_TypeDef * const pstQueue)
{
    ...
    OS_List_TypeDef* pstWaitingToReceiveList = (OS_List_TypeDef*) 0UL;
    OS_List_TypeDef* pstWaitingToSendList = (OS_List_TypeDef*) 0UL;
    ...
    OS_Task__vEnterCritical();
    {
        ...
        while(OS_QUEUE_LOCKED_UNMODIFIED < pstQueue->xTxLock)
        {
            ...
            if((uint32_t) 0UL != pstQueue->pstQueueSetContainer)
            {
