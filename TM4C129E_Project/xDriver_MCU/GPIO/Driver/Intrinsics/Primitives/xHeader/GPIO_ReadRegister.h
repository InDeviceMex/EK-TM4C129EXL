...
/*
GPIO_nSTATUS GPIO__enReadRegisterBus(GPIO_nPORT enPort, uint32_t u32OffsetRegister, uint32_t* pu32FeatureValue, uint32_t u32MaskFeature, uint32_t u32BitFeature);
