...
#ifndef XOS_QUEUE_INTRINSICS_XHEADER_OS_QUEUE_MUTEX_H_
#define XOS_QUEUE_INTRINSICS_XHEADER_OS_QUEUE_MUTEX_H_

#include <xOS/Queue/Intrinsics/xHeader/OS_Queue_Defines.h>

void* OS_Queue__pvGetMutexHolder(OS_Queue_Handle_t pvSemaphore);

#endif /* XOS_QUEUE_INTRINSICS_XHEADER_OS_QUEUE_MUTEX_H_ */
